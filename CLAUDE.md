...
│   ├── acquisition-diligence/     FINANCIAL DUE DILIGENCE for a client buying a business — the industry
│   │                              benchmark references a target is measured against; consulting, not assurance (Active)
...
| A client is **BUYING A BUSINESS** and wants the numbers reviewed — "is this laundromat/business worth what they're asking?", what a target's **profitability, margin and KPIs** should look like, how to test whether reported **revenue is real**, or what **multiple** the earnings deserve | [`projects/acquisition-diligence/`](./projects/acquisition-diligence/) — one benchmark reference per industry (coin laundry is the first, from the Aug 2026 five-location engagement). It carries the cost-structure bands, the KPI set grouped by the question each answers, the **three independent revenue tests** — water consumption, card/coin reconciliation, bank deposits — plus a **live water-method calculator**, county utility inputs and valuation multiples. Three things it exists to stop: 🛑 **never describe this work with assurance words** (it is consulting — no audit, no review, no opinion, and "verification" stays out of the service description); ⚠️ **geography is a cost input, not a label** — commercial water + sewer runs roughly **3× more in Miami-Dade than in unincorporated Manatee County**, so benchmarking a Tampa Bay–area store against South Florida costs manufactures a false finding in either direction; and 📊 **every figure is graded** Firm / Directional / Not obtained, because a benchmark is a **screen** and the metered bill, the processor settlement and the IRS transcript are the evidence |
