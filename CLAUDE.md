...
│   │   └── tax-form-guides-ru/    RUSSIAN-language reference (RU/EN) — every expense line on Sch C, 1065, 1120, 1120-S + 1125-A, explained (Draft)
...
| **A Russian-speaking preparer** needs to know what an **expense / deduction line** means — "что идёт в строку 20?", "what goes on Schedule C line 18?", which line an expense belongs on for a given form, or the Russian for a tax term | [`projects/sops/tax-form-guides-ru/`](./projects/sops/tax-form-guides-ru/tax-form-guides-ru.md) — a **reference, not a procedure**, and a **deliberately bilingual** reference folder (Julia, 2026-09-23): each line of **Schedule C, 1065, 1120, 1120-S** and **Form 1125-A** with its exact English wording + in Russian what it is, what the IRS says, what we usually see there, what does NOT go there, and the firm's QuickBooks accounts; the overview has **one table of where each expense lands on all four forms** and an EN→RU glossary. Tax year 2025. ⚠️ **It defers to the prior-year return and to the preparation SOPs** — when they disagree, ask. ⛔ Text typed INTO a return stays English |
