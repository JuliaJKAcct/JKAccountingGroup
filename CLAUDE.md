...
│       ├── organizer-review/          reviews ONE client's tax organizer before their return — vs. the prior year, the notes and the files; outputs the grouped question list for the client
