...
│       ├── organizer-review/          the PRE-RETURN REVIEW COMPANION (Lilian's "tax preparer") — reads all eight sources on a client before their return — vs. the prior year, the notes and the files; outputs the grouped question list for the client
