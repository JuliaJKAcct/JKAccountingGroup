...
| 6 | **Client Intelligence** system — design it | Lilian | Double (client notes as the store; the MASCIAVE "Reporting & Tax Basis" note is the first entry) → future project/skill | Draft the plan: which facts to capture, one standard format, where it lives, and how Claude pulls context from Ping Assistant / Double / QuickBooks | 2026-07-20 |
