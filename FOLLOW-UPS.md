...
| 2 | **Best Broker Realty** — City of Hollywood BTR | Lilian | Double (client note) + [`client-intelligence`](./projects/client-intelligence/clients/best-broker-realty.md) | DBPR license **sent to the city 2026-07-16** (confirmed in Gmail). Next: await the city's payment instructions for the Broker/Real Estate category, then pay the difference | 2026-07-20 |
