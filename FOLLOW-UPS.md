...
| 3 | **Pro Title Agency** — City of Hollywood BTR tracking | Lilian | Double (client note) | The client's email was used on the application, so the firm can't track status — decide: ask the city to switch the contact email, or have the client forward the status emails | 2026-07-15 |
