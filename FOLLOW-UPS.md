...
| 8 | **Knowledge Hub** — add the pricing calculator + publish the live link | Lilian | [`projects/knowledge-hub/`](./projects/knowledge-hub/) + the pricing-calculator artifact | The business engagement-letter generator is already embedded in the Hub (Tax preparation). Pending **Lilian's go-ahead**: (a) surface the **internal pricing calculator** from the Hub (link the artifact / internal section), and (b) **publish the Hub to its official link** so the team sees the latest | 2026-07-28 |
