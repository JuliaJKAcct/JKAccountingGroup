...
> change them.** The firm's proposal and engagement-letter tools produce output
> **Julia fixed and wants
> preserved exactly as it is** *(Lilian, 2026-08-14)*. Those tools carry their own
...
> design system — is the brand guide and design system, and this file never duplicates it. This
...
> firm's proposal-generator skill. **Both are
...
- **Lilian makes the IRS calls** *(her own words, 2026-08-14: Julia very rarely does)* — and
...
**Sources.** The firm's own team email signatures
...
and the enrollment number is missing. Everything marked *(pending)* is genuinely unknown
to this repo, not omitted for sensitivity.
