...
| 🔴 **27a · 27b** | **The two that are inverted from what everyone assumes** | 📄 **2025 form, verbatim:** `27 a Energy efficient commercial bldgs deduction (attach Form 7205)` · `b Other expenses (from line 48)`. 🛑 **`Other expenses` is 27b, NOT 27a** — and 27b is a **total**: the amounts are typed one by one in **PART V, page 2, lines 48**, with a description each. ⚠️ **Read these two off the current-year PDF every year** — they have moved before |
