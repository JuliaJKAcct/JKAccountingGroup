...
- **`amazon-partner/referral-proposal-ru.html`** (+ `.pdf`) — the native-Russian
  ...
  what he asked about: the two rates as a three-number deal line (10% once a year
  · 15% every month · no time limit), what a seller's accounting actually looks
  like from day one, our price anchors with his cut beside each, an earnings
  matrix (each package × 1 / 5 / 10 clients, monthly and annual) and a worked
  ten-client year (**$18,150** in year one, **$17,460** of it recurring), then
