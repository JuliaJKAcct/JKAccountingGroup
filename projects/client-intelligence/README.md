...
| Mikayel Shakhyan | [`clients/mikayel-shakhyan.md`](./clients/mikayel-shakhyan.md) | Lilian | ⚠️ **Created 2026-09-05.** **Nonresident individual who owns a Florida LLC — Lum and Ari LLC**, so the LLC is a **foreign-owned U.S. disregarded entity**: it files a **pro forma Form 1120 with Form 5472 attached**, captioned *“Foreign-owned U.S. DE”*, which **cannot be e-filed** (fax/mail to Ogden) and carries a **$25,000** penalty. 🔴 **Neither the $10M small-corporation nor the $5M de-minimis exception applies to a DE (TD 9796)** — and **Part V makes money moving between him and his own LLC reportable at zero income** (contributions, distributions, formation, dissolution). 🟠 `FDOR - company was dissolved.pdf` is on file, and the **liquidation year is itself a reporting year**. **Four gates before any figure:** is it single-member (or it is a 1065 instead), the formation and dissolution dates, the **missing Jan–Sep 2025 bank statements**, and whether the 2025 5472 on file was already sent. Double's `Tax Return Type` says `1040` for a nonresident |
