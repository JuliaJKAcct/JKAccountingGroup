...
| YMI TRUCKING LLC | [`clients/ymi-trucking.md`](./clients/ymi-trucking.md) | Firm | ✅ **First full historical sweep 2026-08-29.** An unexplained 7004 filing + **IRS address in the wrong state**, both still unresolved; note **491842**. 2025 return confirmed filed on time. Sibling company found: **Prime Road Carriers Inc** (same owner, no CI file yet) |
...
| VITALII IVANOV & TETIANA MOGYLOVA | [`clients/vitalii-ivanov.md`](./clients/vitalii-ivanov.md) | Firm | ✅ **First full historical sweep 2026-08-29.** 🔴 **The firm's mail-forwarding arrangement for this couple + THREE companies EXPIRES 2026-09-18.** 50% of FOUR Ukrainian companies — a foreign-entity reporting question (5471/8865/8858) is open on all four, and FBAR/8938 workpapers are now in progress; 2025 unfiled, organizer still `Sent`. **Russian only** |
...
| Igor Melomed & Yelena Lovkina | [`clients/igor-melomed.md`](./clients/igor-melomed.md) | Firm | ✅ **First full historical sweep 2026-08-29 — settled the ownership question.** He is **not** connected to R & G Friendly Inc; his confirmed operations are **Sunoma Inc** and **Magnum 152, Inc** (a firearms/gun-show retail operation, not just pawn/jewellery). Firm does monthly books while Double says `Bookkeeping = N/A`; `1040` vs 2023 Schedule C unsettled; **he works by email, not the portal** |
| R & G Friendly Inc | [`clients/rg-friendly.md`](./clients/rg-friendly.md) | Firm | ✅ **First full historical sweep 2026-08-29 — this is Grigoriy & Margarita Melomed's company (settled), unrelated to Igor Melomed.** "Lucky Pawn & Jewelry", two Broward locations. **The firm ran and PASSED a Florida sales-tax audit for this client in 2025.** 1120-S filed; ADP payroll since ≥2025-11; PNC closed mid-2025, Truist took over |
