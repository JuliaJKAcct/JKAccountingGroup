...
| Denys Melnyk | [`clients/denys-melnyk.md`](./clients/denys-melnyk.md) | Lilian | In progress — 2025 1040, first year with us. **S-corp shareholder in three trucking entities**, with a large NOL carried forward from 2024. 🔴 **He answered the review on 2026-08-12 and the return is now blocked on one thing:** he worked only in **Midwest Expedited**, was **locked out after a dispute with his partner**, and holds **no K-1 and no W-2** for income he did receive — **the route is a decision for Lilian and Julia** (§5). Residence, the wife's Schedule C, retirement and 1099s are all answered; the 1095-A blocker is back to a question |
