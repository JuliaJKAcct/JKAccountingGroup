...
| BOGOPOLSKYY, MARAT and YULIANA | [`clients/bogopolskyy-marat-yuliana.md`](./clients/bogopolskyy-marat-yuliana.md) | Lilian | In progress — **the joint 1040**, split out of the Gossip Miami file 2026-09-10. 🟠 **2025 prepared but NOT transmittable**: the 1095-A figures and the Gossip K-1 amounts closed 2026-09-10; ✅ **The vehicle percentages came back 2026-09-10 — ONE car, Marat 49.99%, Yuliana 16.67%** — and **three things** still stand between it and transmission: **two client answers** — what Yuliana's business actually is (no principal-business description or code) and **whether the car was used for Marat Boxing in 2024**, which decides the mileage method — and **one of ours**, filing Gossip Miami's 1120-S and re-checking box 1 and 16D against what was filed. Two Schedule Cs, three K-1s, a first-year home office, and Yuliana's disposal of the salon |
