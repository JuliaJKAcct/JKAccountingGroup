...
|---|---|---|---|
| Anton & Olga Stenin (laundry portfolio buyers) | [`clients/anton-laundry-buyer.md`](./clients/anton-laundry-buyer.md) | Julia | **Engaged in practice — first-milestone invoice issued 2026-09-02; the seller's four-volume binder, Financial Binder and full QuickBooks exports are in, and the FY2025 add-back schedule has been tested against the ledgers** (the firm's first consulting-type engagement): buyer-side financial and tax due diligence on a five-location FL laundry portfolio (the seller is three companies) whose adjusted earnings rest almost entirely on seller add-backs. Two price parts — a fixed diligence fee on two milestones (the client refused hourly) and a fixed structuring/tax-planning package; we source and coordinate the third-party specialists, their fees paid by the client directly; 🛑 never describe it with assurance words. Open: the Double client (none yet), the signed agreement not yet seen, the acquisition entity |
