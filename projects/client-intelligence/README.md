...
| GOSSIP MIAMI LLC | [`clients/gossip-miami.md`](./clients/gossip-miami.md) | Lilian | In progress — tax-prep only (business return + the owners' individual return + a Schedule C); financial-statement cleanup quoted separately and under way, now **blocked on the client's bank documents** (§4) |
