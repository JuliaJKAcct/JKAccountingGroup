...
| AXDIGITAL LLC | [`clients/axdigital.md`](./clients/axdigital.md) | Liudmyla | In progress — full sweep done 2026-08-22/29. **Amazon + eBay + Turo seller; 1120-S.** 🔑 **Its 1120-S gates the owners' 1040** ([Bereznyak](./clients/oleksiy-liudmyla-bereznyak.md)) and has not been prepared. 🔴 The Aug 2026 work-authorization question is **the OWNER's own W-2**, not an anonymous employee — still unresolved |
| Bereznyak, Oleksiy and Liudmyla | [`clients/oleksiy-liudmyla-bereznyak.md`](./clients/oleksiy-liudmyla-bereznyak.md) | Lilian | ⚠️ **Created 2026-09-01 from a pre-return review + 2025 worksheet build.** Individual 1040 MFJ, one child; owners of [AXDIGITAL LLC](./clients/axdigital.md). ⛔ **2025 blocked on three things:** the AXDIGITAL K-1 doesn't exist yet, mileage for **seven of nine listed-property vehicles** is missing, and 🔴 **the organizer answers "no" to foreign income and foreign accounts while a 100%-owned Ukrainian company (IT POINT LTD) sits on the 2024 return as a Form 5471** — an FBAR/8938 determination is open. Large Marketplace advance credit across **two 1095-As** with an allocation overlap |
