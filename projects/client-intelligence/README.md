...
| Zakom Incorporated | [`clients/zakom-incorporated.md`](./clients/zakom-incorporated.md) | Lilian | ⚠️ **Created 2026-09-13** — he had **no Client Intelligence and no Double notes** while sitting mid-organizer. FL **S-corp, Form 1120-S**, trucking; income tax + 1099 preparation, **no bookkeeping and no QuickBooks**. 🔴 **FILES IN TWO STATES — FL *and* IL** (the firm established it preparing 2022), **and the 2025 organizer answers "no" to multi-state** — work it off the organizer alone and Illinois is missed. 🔴 **There is no ledger:** the only books are the firm's own P&L/balance-sheet and Home Office templates, returned through the organizer on 2026-09-13 and **never opened to see if they carry figures.** 🔴 **No W-2 employees in 2025, so the owner took no salary** — reasonable compensation, and the condition [`form-1120s-preparation.md`](../sops/form-1120s-preparation.md) §5C-v is written around. 🔴 **The company HAS an Amex** — his words, *"Zakom Amex"*, and the firm's own annual request asks for the December credit-card statement — **and 2025 is the first year nothing came**, while January shows two Amex payments under two different references. 🔴 **A SECOND entity, Mema Colors LLC, has its own Amex that Zakom's account appears to be paying** *(the client: it has "no activity/revenue… just Amex expenses")* — **no Double record, no CI file, yet the firm filed its BOI**; **Palm Terra LLC** is a third. 🟢 Twelve 2025 monthly statements are **Fifth Third business checking**, verified through the redactor; the `ZAKOM 7807` offsets are that same account. 🔑 Julia ruled in Aug 2025 the **2021 Audi is 100% Zakom**. Also open: shareholder count answered impossibly, `Tax Return Filed > 2024` empty, and he runs late every year |
