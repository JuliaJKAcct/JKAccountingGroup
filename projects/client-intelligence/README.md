...
| MENDELEEV INC (Gridin) | [`clients/mendeleev-inc.md`](./clients/mendeleev-inc.md) | Julia | **Prospect — first-year Form 1120 engagement letter drafted 2026-09-25** + a one-time 2026-books cleanup starting Oct 1 (in the letter at Julia's instruction). ⚠️ Owner is a non-US-resident (Armenia): check Form 5472 before filing — not yet in scope. Open: fee confirmation, 5472, TY assumption, EIN |
