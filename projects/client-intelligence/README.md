...
| BOGOPOLSKYY, MARAT and YULIANA | [`clients/bogopolskyy-marat-yuliana.md`](./clients/bogopolskyy-marat-yuliana.md) | Lilian | In progress — **the joint 1040**, split out of the Gossip Miami file 2026-09-10. 🔴 **2025 prepared but NOT transmittable**: it waits on Gossip Miami's 1120-S being filed, on the vehicle business-use % (two organizers published, both unanswered), and on the 2025 Form 1095-A figures. Two Schedule Cs, three K-1s, a first-year home office, and Yuliana's disposal of the salon |
