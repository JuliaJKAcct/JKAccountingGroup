...
| MENDELEEV INC (Gridin) | [`clients/mendeleev-inc.md`](./clients/mendeleev-inc.md) | Julia | **Prospect — bilingual MONTHLY proposal drafted 2026-09-25, service start Oct 1** (corrected from a tax letter mid-session): bookkeeping + statements, Form 1120 in the annual bundle, one-time 2026-books cleanup as a one-time service. ⚠️ Owner is a non-US-resident (Armenia): check Form 5472 before filing — not yet in scope. Open: 5472, EIN, industry |
