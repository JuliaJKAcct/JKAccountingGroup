...
| BOGOPOLSKYY, MARAT and YULIANA | [`clients/bogopolskyy-marat-yuliana.md`](./clients/bogopolskyy-marat-yuliana.md) | Lilian | In progress — **the joint 1040**, split out of the Gossip Miami file 2026-09-10. 🟠 **2025 prepared but NOT transmittable**: the 1095-A figures and the Gossip K-1 amounts closed 2026-09-10; it still waits on **two client answers** — the vehicle business-use % (two organizers published, both unanswered) and Yuliana's principal-business description — and Gossip Miami's 1120-S must be filed first. Two Schedule Cs, three K-1s, a first-year home office, and Yuliana's disposal of the salon |
