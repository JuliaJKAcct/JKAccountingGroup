...
|---|---|---|---|
| Atman Parts | [`clients/atman-parts.md`](./clients/atman-parts.md) | Lilian | Active — TX sales-tax SOP written ([`atman-parts-tx-sales-tax.md`](../sops/atman-parts-tx-sales-tax.md)); open: `Sch C` vs `1120-S`, the franchise position |
