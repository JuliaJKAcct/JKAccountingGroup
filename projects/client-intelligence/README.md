...
| M5 Studio Miami | [`clients/m5-studio-miami.md`](./clients/m5-studio-miami.md) | Lilian | ⏳ **Company set-up — the SS-4 was FAXED on 2026-08-18, re-faxed 2026-08-27, and the EIN has not been seen back** (due ~09-03 on the second attempt; why it was re-sent is unrecorded). It went by fax, not online, because the two owners are **foreign investors with E-2 visas pending — no SSN or ITIN**, which is the [EIN SOP §1](../sops/ein-application-irs.md) Path-B fork; the domestic fax was correct because *the entity* is in Florida. Legal name confirmed **M5 STUDIO MIAMI LLC** (Articles filed 2026-08-07, effective 08-03). Design services + retail of decorative wall plaster, **no installation**. Its SS-4 designee block set the firm's standing pattern ([EIN SOP §4D](../sops/ein-application-irs.md)). Still open: what went on **line 16**, **which** investor signed as responsible party, the Sunbiz document number, and whether the Form 2848 draft names someone who may actually be named |
