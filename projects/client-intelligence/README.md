...
| Mikayel Shakhyan | [`clients/mikayel-shakhyan.md`](./clients/mikayel-shakhyan.md) | Lilian | ⚠️ **Created 2026-09-05, documents read the same day.** **Nonresident (F-2, exempt individual) who wholly owns Lum and Ari LLC** — a **foreign-owned U.S. disregarded entity**, so it owes a **pro forma Form 1120 + Form 5472**, captioned *“Foreign-owned U.S. DE”*, **not e-fileable** (fax/mail to Ogden), **$25,000** penalty, and **no size exception applies** (TD 9796 removes DEs from both). 🔴 **The 5472 sitting in Double is a SHELL — do not file it:** Parts II and III are empty (the owner is named nowhere), Part V is unchecked with no attachment. 🔴 **There ARE reportable transactions:** the account's whole life is owner funding in and legal/vendor payments straight back out, closing at zero — Part V contributions — **plus the formation costs paid in the 80 days before the account existed, which no statement shows.** 🟠 Dissolution unread (image scan): if it falls in 2026, **2026 owes its own filing**. Blocked on four client questions. Figures in [`tax-returns/lum-and-ari-llc/2025-form-1120-proforma-5472.md`](../tax-returns/lum-and-ari-llc/2025-form-1120-proforma-5472.md) |
