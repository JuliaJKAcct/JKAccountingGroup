...
| Zakom Incorporated | [`clients/zakom-incorporated.md`](./clients/zakom-incorporated.md) | Lilian | ⚠️ **Created 2026-09-13** — he had **no Client Intelligence at all**, and **no Double notes**, while the client was mid-organizer. FL **S-corp, Form 1120-S**, trucking; income tax + 1099 preparation, **no bookkeeping and no QuickBooks**. 🔴 **No W-2 employees in 2025, so the owner took no salary** — the reasonable-compensation question, and the condition [`form-1120s-preparation.md`](../sops/form-1120s-preparation.md) §5C-v is written around. 🔴 **There is no ledger:** the only books are the firm's own **Balance Sheet & P&L** and **Home Office** templates, which he returned through the organizer on 2026-09-13 — **nobody has opened them to see whether they are filled in.** 🟢 **Twelve monthly statement files cover Jan–Dec 2025**, with truck/trailer financing and interest statements — ✅ **Identified 2026-09-13 through the redactor: Fifth Third Bank business checking** — the two January copies are the same document byte for byte *(only January was opened; the other eleven months are assumed)*. 🔴 **And that statement proves the records are INCOMPLETE:** two Amex ACH payments in one day under two different Amex references, with **no 2025 card statement anywhere**; **thirteen `ZAKOM 7807 CASH DISB` offsets** against a statement answering "Business Loan or Line of Credit? Yes", so a second account or facility is unaccounted for; and **Cash App payments to named individuals** — the client's own 1099 question. Revenue is dominated by one payer. 🔴 **He answered "No" to "fewer than 100 shareholders"** — impossible for an S-corp, a misread to correct before anything is keyed; **the EIN letter and the licence were answered "na" instead of uploaded**; and the S-election dates, start date and ownership % are blank. 🟠 **The 2024 return is filed under `1099 > 2024`, not `Tax Return Filed > 2024`, which is empty.** Organizer **75% and NOT submitted** — he was still swapping files on 2026-09-13 |
