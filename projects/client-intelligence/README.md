...
| GOSSIP MIAMI LLC | [`clients/gossip-miami.md`](./clients/gossip-miami.md) | Lilian | In progress — tax-prep only (business return + the owners' individual return + a Schedule C); financial-statement cleanup quoted separately and under way, now **waiting on the client's remaining bank documents and on his answers to the 2026-08-11 cleanup questions** — he delivered the 2025 credit-card statements 2026-08-05 (live status in §6) |
