...
| Valentin Volzhanskiy | [`clients/valentin-volzhanskiy.md`](./clients/valentin-volzhanskiy.md) | Lilian | ⚠️ **Created 2026-09-12** — he had **no Client Intelligence at all**, from the 2025 pre-return review. 🔴 **2025 is BLOCKED and the return was not prepared**: his **Form 1095-A is on file but is a phone photograph**, so Form 8962 cannot be computed; his organizer answered `Wages (W2)` **only** while he uploaded 1099-NECs, which closed the whole self-employed branch so **no business expenses were ever asked for**; and the **tips still have to be shown ELIGIBLE**, since **both** tip-bearing employers — and in fact all four of his 2025 employers — are catering/events businesses, where a distributed service charge is not a qualified tip. ✅ **A fourth blocker CLOSED 2026-09-13: the 2025 1099-NEC from VoiceCapital Inc — our own client — was found in the PAYER's Drive folder, not his, and confirmed as his**; what is left there is asking him what the work was, since none of his three 1099 payers is a caterer. 🟢 **He is a BARTENDER with tips in TWO different W-2 boxes** (one employer box 7, the larger one **box 14**) in the first year of the tips deduction — box 14 is allowed for 2025 only, under Notice 2025-69. 🔒 **A qualified-business-loss carryforward runs in from 2024** and nothing in the 2025 documents points at it. Extension filed → **15 Oct 2026** |
