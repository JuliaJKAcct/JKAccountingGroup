...
└── clients/               ← one file per client (59 so far — see the Clients index below)
```
...
|---|---|---|---|
<<<<<<< HEAD
| Anton & Olga Stenin (laundry portfolio buyers) | [`clients/anton-laundry-buyer.md`](./clients/anton-laundry-buyer.md) | Julia | **Engaged in practice — first-milestone invoice issued 2026-09-02; seller document request list drafted 2026-09-03 (v1, awaiting Julia's edits)** (the firm's first consulting-type engagement): buyer-side financial and tax due diligence on a five-location FL laundry portfolio (the seller is three companies) whose adjusted earnings rest almost entirely on seller add-backs. Two price parts — a fixed diligence fee on two milestones (the client refused hourly) and a fixed structuring/tax-planning package; we source and coordinate the third-party specialists, their fees paid by the client directly; 🛑 never describe it with assurance words. Open: the Double client (none yet), the signed agreement not yet seen, the acquisition entity |
=======
| Anton & Olga Stenin (laundry portfolio buyers) | [`clients/anton-laundry-buyer.md`](./clients/anton-laundry-buyer.md) | Julia | **Prospect — Financial Due Diligence & Purchase Analysis proposal, final draft 2026-08-30** (the firm's first consulting-type engagement): buyer-side review of a five-location FL laundry portfolio (the seller is three companies) whose adjusted earnings rest almost entirely on seller add-backs. Two fixed price parts — the diligence on milestone installments (the client refused hourly) and a structuring/tax-planning package; we source and coordinate the third-party specialists, their fees paid by the client directly; 🛑 never describe it with assurance words. Open: acquisition entity |
>>>>>>> origin/main
...
| SM Group USA Inc. (Kostetskyi) | [`clients/sm-group-usa.md`](./clients/sm-group-usa.md) | Julia | **Prospect — monthly proposal delivered 2026-09-21**: e-commerce bundle (bookkeeping across sales channels, financial statements as the foundation, owner payroll, 1099s, Form 1120-S) at a negotiated 20% partnership discount; personal returns + cleanup excluded. Price-sensitive; a SECOND company is waiting for its own quote. Open: entity state/S election, sales channels, second company |
...
| BOGOPOLSKYY, MARAT and YULIANA | [`clients/bogopolskyy-marat-yuliana.md`](./clients/bogopolskyy-marat-yuliana.md) | Lilian | In progress — **the joint 1040**, split out of the Gossip Miami file 2026-09-10. 🟠 **2025 prepared but NOT transmittable**: the 1095-A figures and the Gossip K-1 amounts closed 2026-09-10. ✅ **The vehicle METHOD and COST BASE are now answered** *(Lilian ruled the base from the bookkeeping, 2026-09-11)* — one car *(Marat 49.99%, Yuliana 16.67%)*, and on 2026-09-11 Lilian read the contract: it is a **LEASE**, so the return runs on **actual expenses** and the 2024-use question no longer decides the method. 🔴 **TWO things still stand between it and transmission:** **one client answer** — what Yuliana's business actually is *(no principal-business description or code, and e-file rejects without them)* — and **one of ours**, filing Gossip Miami's 1120-S and re-checking box 1 and 16D against what was filed. Two Schedule Cs, three K-1s, a first-year home office, and Yuliana's disposal of the salon |
...
| Vitaliy Vasyutyk (10-company group) | [`clients/vitaliy-vasyutyk.md`](./clients/vitaliy-vasyutyk.md) | Lilian | ⚠️ **Created 2026-09-07** — the group had **no Client Intelligence at all**: ten LLCs, one owner, one portal contact, and **only an owner-level file so far** (nine companies still owe their own). 🔴 **An invoice's customer is not the company the work was for** — six QuickBooks records bill ten entities, so "has this been billed?" is answered on **line descriptions**, not customer names. 🔴 **Zumfi 2 LLC is a TENNESSEE LLC — annual report due 1 April, not Florida's 1 May.** **Tropical Coast 1 LLC dissolved 2026-03-31**; **Zumfi 1 is to be closed**; SYS 1 and Remodel Master had **no activity in 2025** and **both owe a change of address**. Three 2026-03-25 invoices are unpaid after six reminders — the charges were verified clean on 2026-09-07, so it is a collection question |
| Zumfi 2 LLC | [`clients/zumfi-2.md`](./clients/zumfi-2.md) | Lilian | ⚠️ **Created 2026-09-13** — the first per-company file split out of the [Vasyutyk group](./clients/vitaliy-vasyutyk.md); nine still owe one. 🔴 **A TENNESSEE LLC — annual report due 1 APRIL**, not Florida's 1 May. **Form 1065, two members: Vitaliy 35% / Bahruz Naghiyev 65%.** Bought a **parcel of land in Chattanooga TN on 2025-11-06, for cash**, and is not renovating it. 🔴 **The client's "books" are a one-sheet spreadsheet that puts the land purchase in EXPENSES** — there is no balance sheet, no cash account and **no bank statement has ever been provided**; the closing statement governs, and their own closing-cost total reconciled to nothing. ✅ **2025 return prepared 2026-09-13 — ordinary income (loss) is $0, not the large loss the books report.** ✅ **The identifier blocker CLOSED 2026-09-13** — the 65% partner's TIN is keyed on his K-1 and on Schedule B-1, and **question 33 was ruled NO** *(Vitaliy designated Partnership Representative)*, so no Schedule B-2 is needed. 🟠 **ONE blocker remains: confirmation that the Form 7004 was ACCEPTED**, since the copy in Double is an unreadable scan. ✅ **And the 65% partner is PASSIVE** *(Julia, 2026-09-13)* — keyed as `I -- Passive Individual`; what that settles, and the §461(k)(4)(B) limb it does **not** settle, is in the client file. 🔴 **And a TENNESSEE STATE RETURN IS OWED FOR 2025, AND IT IS LATE** — established by phone on **2026-09-17**, after standing as *"never asked for this group"*: **no TN extension was filed, because the firm believed the company was Florida-registered.** ✅ **The penalty is nominal and nothing on the federal return moves.** ⚠️ **WHICH Tennessee return — franchise & excise, or the FONCE exemption filing — is NOT established**; see the client file §4. 🔑 **Schedule B question 4 is Yes**, which is the only reason it can be filed without the balance sheet we do not have — **and filing after the extended due date reverses that.** Figures in [`tax-returns/zumfi-2-llc/2025-form-1065.md`](../tax-returns/zumfi-2-llc/2025-form-1065.md) |
| Valentin Volzhanskiy | [`clients/valentin-volzhanskiy.md`](./clients/valentin-volzhanskiy.md) | Lilian | ⚠️ **Created 2026-09-12** — he had **no Client Intelligence at all**, from the 2025 pre-return review. 🟡 **2025 was REVIEWED 2026-09-12 and PREPARED 2026-09-13 — checked line by line, NOT yet filed and NOT yet reviewed by Julia.** ✅ **Two of the four blockers closed that day**: the **Form 1095-A** *(she supplied a readable copy — 12 months, no gap)*, and the **VoiceCapital 1099-NEC**, found in the PAYER's Drive folder rather than his and confirmed as his. 🔴 **Two remain, and both move money**: the organizer answered `Wages (W2)` **only** while he uploaded 1099-NECs, which closed the whole self-employed branch, so **no business expenses were ever asked for and the Schedule C was prepared with none** *(a declared, documented decision)*; and 🆕 **the larger employer's box-14 tips are now CLAIMED but NOT shown ELIGIBLE** *(2026-09-13 p.m.)* — a liability to close before filing, not a gap, since **both** tip-bearing employers — and in fact all four of his 2025 employers — are catering/events businesses, where a distributed service charge is not a qualified tip. 🆕 🧾 **2026-09-18 — HE SENT THE EXPENSES, AND THE FILE MOVED THE *INCOME* SIDE.** A bank/card extraction with his own labels and **no business-purpose column**, so it can be triaged and not deducted from. 🛑 **A large block of its "unclassified" inflows is W-2 pay ALREADY on the return** — the tool keyed on the word `PAYROLL` and one employer changed its descriptor mid-year; one employer's net ties to the penny. ⛔ **"Work income" in his vocabulary means "money I earned by working", not which schedule it belongs on.** 🔴 **Business income from named payers is MISSING from the return** *(the amount is in the working paper, §13E Tier 1)*. ✅ **Credit repair CONFIRMED in his own words** — and 🆕 **a THIRD activity nobody had raised: REAL ESTATE** *(brokerage fees to a Florida brokerage, a licence renewal, meals "with realtors")*. 🔑 **So the open question is no longer "what was the VoiceCapital work" but HOW MANY BUSINESSES THIS IS** *(this supersedes the narrower question)* — and **Schedule C lines A and B are both wrong either way.** 🔴 **Unfiled 2025 Forms 1099-NEC, with line I answering "No".** ⚠️ **Also open:** a taxpayer signature dated months before the preparation, and a **live IRS installment agreement a new balance can default.** 🟢 **He is a BARTENDER with tips in TWO different W-2 boxes** (one employer box 7, the larger one **box 14**) in the first year of the tips deduction — box 14 is allowed for 2025 only, under Notice 2025-69. 🔒 **A qualified-business-loss carryforward runs in from 2024** and nothing in the 2025 documents points at it. Extension filed → **15 Oct 2026** |
| Zakom Incorporated | [`clients/zakom-incorporated.md`](./clients/zakom-incorporated.md) | Lilian | ⚠️ **Created 2026-09-13** — he had **no Client Intelligence and no Double notes** while sitting mid-organizer. FL **S-corp, Form 1120-S**, trucking; income tax + 1099 preparation, **no bookkeeping and no QuickBooks**. 🔴 **FILES IN TWO STATES — FL *and* IL** (the firm established it preparing 2022), **and the 2025 organizer answers "no" to multi-state** — work it off the organizer alone and Illinois is missed. 🔴 **The BOOKS DO NOT SUPPORT A RETURN:** the returned workbook **is** filled in, but its balance sheet carries `#REF!` errors in net income, total equity and the balance check, shows **every fixed-asset line as zero** on a company running a dozen trucks, and has **no equity detail at all** — so Schedule L, M-1, M-2 and every basis figure have no source. Its "2024" income statement repeats 2023's revenue to the cent. 🛑 **Block A closed on 2026-09-13: the 2025 return was NOT prepared.** 🔴 **No W-2 employees in 2025, so the owner took no salary** — reasonable compensation, and the condition [`form-1120s-preparation.md`](../sops/form-1120s-preparation.md) §5C-v is written around. 🔴 **The company HAS an Amex** — his words, *"Zakom Amex"*, and the firm's own annual request asks for the December credit-card statement — **and 2025 is the first year nothing came**, while January shows two Amex payments under two different references. 🔴 **A SECOND entity, Mema Colors LLC, has its own Amex that Zakom's account appears to be paying** *(the client: it has "no activity/revenue… just Amex expenses")* — **no Double record, no CI file, yet the firm filed its BOI**; **Palm Terra LLC** is a third. 🟢 The twelve 2025 `stmnt` files cover Jan–Dec; **January was opened through the redactor and is Fifth Third business checking** — the other eleven are assumed, not verified — and the `ZAKOM 7807` offsets are that same account. 🛑 **And the DEADLINE is the first thing to check every year: Double's project date (`2026-04-15`) is the individual one — the 1120-S was due 2026-03-16, extended 2026-09-15 — and the 7004 in Double is an unreadable scan.** 🔑 Julia ruled in Aug 2025 the **2021 Audi is 100% Zakom**. Also open: shareholder count answered impossibly, `Tax Return Filed > 2024` empty, and he runs late every year |
