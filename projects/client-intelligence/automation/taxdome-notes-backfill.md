...
| 2026-08-13 | **Phase 2 (iCloud source only) — batch 2** | **4 existing files enriched:** Candramas (note **491844**) · Deep Tech (**491845**) · Masciave (**491846**) · Gossip Miami (⚠️ note **485291** is full — history added to the file only, see its §7) | Lilian |
...
**(a)** four clients — Optic Gold, Voicecapital, Voxago, YMI Trucking — have an **outdated address
at the IRS or the FDOR**, which suggests checking it roster-wide rather than one client at a time;
**(b)** three separate companies were found with **no Form 2553 on file at the IRS while the firm
files an 1120-S** (Voicecapital, Masciave, and Candramas with the wrong effective year). That is a
pattern worth a deliberate look, not three coincidences.
