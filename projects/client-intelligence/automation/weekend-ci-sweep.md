...
- 🔴 TWO RULES ABOUT "NOTHING NEW", BOTH BROKEN ON 2026-08-15:
  ...
  (b) 🔴 IN AT A GLANCE, COLOUR BY OPEN ITEMS — NOT BY WHETHER SOMETHING NEW HAPPENED. Any client carrying an open item is amber #9C6A39 AND CARRIES THE OLDEST ITEM'S AGE, whether or not new facts were saved this week; the "N new fact(s) saved" count rides ALONGSIDE the amber, it never replaces it. Green #2F8F5E is only for a client with genuinely nothing outstanding. ⚠️ The old wording scoped amber to "nothing new BUT items open", which made the state ranking (proposals ▸ new facts ▸ quiet) override it: on 2026-08-22 OPTIC GOLD INC printed a neutral blue "1 new fact(s) saved" while carrying a 15-day unopened Sunbiz notice AND a 159-day IRS-address item, with no age shown. A one-line summary must answer "what is rotting?", not "did anything happen?".
