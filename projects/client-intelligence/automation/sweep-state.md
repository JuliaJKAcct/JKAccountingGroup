...
| AXDIGITAL LLC | 2026-09-01 | ✏️ **Corrected 2026-09-01 (manual, out-of-band — a full 1040 review of its owners read this company's thread too):** the "Ukrainian-employee work-authorization/payroll question" is **the OWNER's own salary and W-2**, not a staff member's — the 2026-08-07 email says so in his own words. Still open, now 25 days. Also added: the Amazon and eBay 2025 1099-Ks are the **company's** (both under the company EIN) and were filed by the client into the owners' personal 1040 folder; and a **third, foreign related party** exists — the shareholder owns 100% of a Ukrainian wholesaler of the same goods category, with a Schedule M on the 2024 personal return |
| Bereznyak, Oleksiy and Liudmyla | 2026-09-01 | ⚠️ **First pass — file created 2026-09-01**, out-of-band, from a full pre-return review + 2025 worksheet build at Julia's request. All ten sources read (2024 return via the redactor, Drive folder in full, Double record/organizer/files, Gmail both directions, Ping). 🔴 **Return blocked on three things** — no AXDIGITAL K-1 yet, mileage missing for 7 of 9 listed-property vehicles, and a foreign-account answer that contradicts the Form 5471 on the 2024 return. **Ten client questions drafted, not yet sent.** ⓘ Ping's transcripts for this client are largely unusable (garbled RU/EN) |
