...
- **Donated-inventory tax deduction** — STILL OPEN, now ~58 days pending since 2026-07-23, no deadline. CHASED again 2026-09-19 (bounded ≥2026-09-12, `donat*` query): no update found.
- **"JK 2025 Business Tax Organizer - Sunoma" reverted to draft** by Lilian (2026-07-31) — STILL OPEN as its own Double entity, now ~50 days pending; but see the new §4 fact above — **the 2025 tax PROJECT itself was Filed 2026-09-16**, which may make this specific organizer-draft question moot without actually resolving it. Not settled by this sweep; flag for whoever next needs the fact.
- **Recurring Bravo access/license problems** — STILL OPEN, no new correspondence found this window either (CHASED 2026-09-19). _(Gmail, 2026-07)_
- A missing **Auto Pawn April-2024 expense report** was requested from the owner (2026-06-28) — not separately re-chased this run (budget; same search as on [`magnum-152.md`](./magnum-152.md) covers it, and that search found nothing either); still open, now ~83 days pending since the original ask.
- ✅ **July 2026 close — checklist now fully complete (2026-09-17), but STILL no `EndClose` confirmation.** Every remaining July task was marked Done 2026-09-17 (see §6 log); a targeted `EndClose`-entity query bounded from 2026-08-01 still found only June's close event. Pending since 2026-09-17 (last observed task activity), no deadline stated — worth flagging to Maria directly rather than waiting on another sweep, since the checklist itself is no longer the blocker.
...
- 🆕 **"True up loan balances for the car"** — a vehicle-loan balance true-up Julia asked Maria to do 2026-09-14, tied to the Sunoma/Magnum intercompany-loan reconciliation work ahead of filing. Which entity's vehicle this concerns is not yet established from the sources read this run — flag for confirmation with Maria/Julia.
