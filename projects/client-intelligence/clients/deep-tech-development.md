...
- 2026-09-22 — 🔴 **SHOPIFY DID ANSWER JULIA'S 2026-09-07 QUESTION — THE SAME DAY — AND THE REPLY HAS SAT UNREAD FOR TWO WEEKS.** Gmail holds a `no-reply@shopify.com` notice, *"New message from Shopify Support — Alex L replied to your conversation"*, dated **2026-09-07 17:36 UTC (1:36 pm EDT)**, about three hours after Julia's 10:43 am question on whether the same bank account can be re-added after Shopify Payments is deactivated. It is still **unread**. ⚠️ **The 2026-09-12 and 2026-09-19 sweeps each wrote "no reply found" — true of the reply's TEXT (which never arrives by email), wrong about the case:** the notification that a reply exists was in the inbox the whole time. So the case has been waiting on **us**, not Shopify, since 2026-09-07 — the same failure as 2026-08-27 → 2026-09-03. **The content of Alex L's answer is not known to the firm**; it can only be read inside the Support Inbox (`help.shopify.com/en/inbox/14006272`, ticket `#69851505`). No other Deep Tech Shopify communication found in Gmail after 2026-09-07 (searched `from:no-reply@shopify.com`, `from:do-not-reply@shopify.com`, "Deep Tech", gorobots, "Go Robots"). _(Gmail check, 2026-09-22 — worked by Lilian.)_

- 2026-09-22 — 🟢 **ALEX L'S 2026-09-07 REPLY, READ (screenshot of the Support conversation supplied by Lilian): YES — THE SAME BANK ACCOUNT CAN BE ADDED BACK.** His words: *"Yes, the same external bank account can be used again when Shopify Payments is set up after the ownership transfer, as long as the new Shopify Payments setup is completed with the correct business, tax, representative, and banking details for the new owner/business."* He confirms **Shopify Balance was the only thing that could not survive the ownership change** (*"That does not mean the external bank account itself is blocked from being used again"*). **The path he gave, in his order:** (1) Balance already closed · (2) deactivate Shopify Payments · (3) complete the ownership transfer · (4) **the new owner** sets up Shopify Payments again with the appropriate business and account details · (5) the same external bank account is added again during that setup, if it is still the right account for the new owner/business. ⚠️ **His one condition:** the bank account entered in the new setup must **match the new owner/business details** — *"If there is a mismatch between the account holder/business information and the bank account, additional verification may be required."* ⓘ **Our reading, not Shopify's:** the account holder is the company (Deep Tech Development Group LLC) and the business does not change — only the store owner moves from Julia to Vitalii Ivanov — so a match is expected; the representative details in the new setup will be **Vitalii's**, not Julia's. Also ours, not his: while Shopify Payments is off (between step 2 and step 4) the store cannot take payments through Shopify Payments, so steps 2–4 are best done back to back, with Vitalii ready to do step 4. **The gate Julia set on 2026-09-07 is therefore cleared; nothing blocks the transfer except doing it.** _(Shopify support conversation, ticket `#69851505`, Alex L 2026-09-07 1:36 pm — read 2026-09-22, worked by Lilian.)_

### Outstanding items (CI-only — never in the SOP)
- 🟢 **SHOPIFY — SUPPORT ANSWERED "YES": THE SAME BANK ACCOUNT CAN BE ADDED BACK. The transfer is now OURS TO DO** (Alex L, 2026-09-07; read 2026-09-22 — see the log). **Do, in order, back to back:** (1) deactivate Shopify Payments — *Settings → Payments → Shopify Payments → Manage → bottom → Deactivate Shopify Payments*; (2) *Settings → Users* → transfer ownership to **Vitalii Ivanov**; (3) **Vitalii** sets up Shopify Payments again with the company's business, tax and representative details and the **same bank account** — it must match the business, or Shopify may ask for extra verification. ⚠️ Payouts through Shopify Payments stop between (1) and (3), so line Vitalii up before starting. Still separate and still owed: ask Support for the **August 2026 Balance statement**.
- ⛔ **SUPERSEDED 2026-09-22 — the two items below were written while Alex L's reply was unread; they are kept for the trail only.**
