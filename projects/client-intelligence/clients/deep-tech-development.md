...
> **Status:** ⚠️ **BOOKKEEPING PAUSED** — the client is between chapters, not gone (Lilian, 2026-08-11) · **Owner:** Lilian · **Last updated:** 2026-09-22
...
- 🟡 **SHOPIFY — TRANSFER INITIATED 2026-09-22; WAITING ON VITALII TO ACCEPT. Everything on the firm's side is done** (Lilian). **What is left:** (1) **Vitalii accepts** the transfer from the invitation email — ⚠️ _(our reading)_ the store stays in Julia's name until he does; if it stalls, nudge him; (2) **Vitalii sets up Shopify Payments again** with the company's details and the **same bank account** (Shopify's match-the-business condition applies — see the 2026-09-22 log entry on Alex L's reply); (3) **still owed by us:** ask Shopify Support for the **August 2026 Balance statement**; (4) the chase Routine `trig_014ZK9ZhX4su7hJ8DpaWh4xa` — re-prompt or delete, **Lilian/Julia to decide**; (5) once he accepts, **close the case** here and in Double note `503544`, and confirm Julia's inbox stops receiving this store's notices.
