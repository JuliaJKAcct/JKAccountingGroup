...
- 🟢 **SHOPIFY — DONE: the Balance account closed 2026-09-04, and the ownership transfer is no longer blocked.** ⛔ **This supersedes the 🟡 item below**, which was written 2026-09-03 while the closure was still pending: its *"look on 2026-09-08, act by 2026-09-10"* dates are **moot**, and so is the chase Routine armed for them (`trig_014ZK9ZhX4su7hJ8DpaWh4xa` — it will fire into a check that no longer has anything to detect; delete it or ignore its report). **What is actually left, in order:**
