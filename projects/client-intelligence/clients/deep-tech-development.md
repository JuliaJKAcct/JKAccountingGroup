...
> **Status:** ⚠️ **BOOKKEEPING PAUSED** — the client is between chapters, not gone (Lilian, 2026-08-11) · **Owner:** Lilian · **Last updated:** 2026-09-26
...
- 🟢 **THE SHOPIFY STORE TRANSFER TO VITALII IVANOV IS COMPLETE — confirmed 2026-09-22, found 2026-09-26.** The store **Deep Tech Development / gorobots.us** is **no longer in Julia's Shopify organization**; Vitalii accepted the transfer invitation the same day the firm sent it (Gmail, `mailer@shopify.com`, 2026-09-22 18:39 UTC). **What is left is narrower now:** (1) Vitalii still needs to set up **Shopify Payments** again on his own admin, with the company's details and the **same external bank account** — not yet confirmed done; (2) the firm still owes Shopify Support a request for the **August 2026 Balance statement**, lost when the Balance account closed — not yet confirmed requested. _(Updated 2026-09-22: Balance closed 2026-09-04; Shopify confirmed 2026-09-07 the same bank account can be re-added after Shopify Payments is deactivated; Julia deactivated Shopify Payments and completed the transfer 2026-09-22 — see §6.)_ The history as first written: The store **Deep Tech Development** (**gorobots.us**) has Julia as its store owner and `julia@jkaccountinggroup.com` as its email of record; the real owner is **Vitalii Ivanov**. Adding him as a staff user **errors**, and *Transfer ownership* refuses and sends us to support. Shopify's diagnosis (2026-08-25) is that the store's **Shopify Balance account is active and is the blocker, even at $0**, and it has to be **closed permanently** first — a closure Shopify **requested on 2026-08-25, with no ETA and, at that point, no ticket number**. 🔴 **CORRECTED 2026-09-03 — between 2026-08-27 and 2026-09-03 the case sat on OUR desk, not Shopify's.** Its reply that day (advisor "Alex L") confirms the Balance account shows **$0** and that they can proceed, and then asks for Julia's **express permission in writing, inside the support conversation**, before closing it — *"We'll wait for your confirmation before taking the next step."* **That message sat unread for seven days**, because ⚠️ **Shopify's substantive replies do NOT arrive by email**: the notification is a bare *"you have a new message"* and the text lives only in the **Shopify Support Inbox** (`help.shopify.com/en/inbox/14006272`). So through that window no closure confirmation was pending, and none could have arrived. **Ticket `#69851505`.** 🟢 **RESOLVED the same day — 2026-09-03, 5:27 pm: Julia gave the express written permission inside the conversation, so the case now sits with Shopify.** ⚠️ **Live status and next actions are in §6 outstanding items, not here.** **Full trail: Double note `503544`.** _(Shopify support conversation, 2026-08-25 and 2026-08-27, read and answered 2026-09-03 — Lilian and Julia.)_
...
- 2026-09-03 — **Shopify transfer chased (Lilian).** Question asked: what exactly did Shopify tell us, and has
  the promised confirmation email arrived and been missed? ⓘ **SUPERSEDED the same day by the entry below** —
  the reason no email arrived turned out to be that Shopify was waiting on us. **Answer at the time: nothing was
  missed in Julia's mailbox, and the closure has not happened.** Her mailbox was searched (`in:anywhere` plus
  trash, all senders, 2026-08-15 onward; **spam held nothing at all when searched on 2026-09-03**) and holds
  **no** Balance-closure confirmation in that range.
  ...
  normal **2026-09-01** bill. The one thing nobody has read is Shopify's **2026-08-27** reply from
  agent **"Alex L"**, which is unread in the Support Inbox because the email notification carries no content.
  Also noted at the time: Julia's out-of-office auto-reply went back into the Shopify support thread twice on
  2026-08-25 — **almost certainly irrelevant, since the entry below explains the seven-day gap in full.**
...
- 2026-09-04 — 🟢 **SHOPIFY CLOSED THE BALANCE ACCOUNT — the transfer blocker is GONE, and the statements went with it.** Two notices from `do-not-reply@shopify.com`, both **2026-09-04 16:02 UTC**: *"Your Shopify Balance account is now closed"* and *"Access to Shopify Credit removed"*. The closure Julia authorised in writing on 2026-09-03 was executed the next day. ⚠️ **This one DID arrive by email** — the 2026-09-03 entry's rule that Shopify's substantive replies never do is about *replies inside the support conversation*; an account **state change** is a different notification and does reach the inbox. Do not read that rule as covering both. 🔴 **The cost, in Shopify's own words: _"Your Balance cards have been deactivated, and you won't be able to access your account, including your statements."_** The **August 2026** Balance statement — issued 2026-09-03, one day before the closure, and never confirmed downloaded — is therefore **no longer retrievable from the store admin**. Shopify's notice names the only remaining route: *"If you want copies of your Balance statements … contact Shopify Support."* ⓘ **Found 2026-09-07 by a manual catch-up, not by the sweep — the 2026-09-05 run never completed** (see [`automation/sweep-state.md`](../automation/sweep-state.md)). Both emails were still unread when found, three days after the fact. _(Gmail, `do-not-reply@shopify.com`, 2026-09-04.)_

- 2026-09-04/07 — 🔴 **A SECOND BLOCKER NOBODY KNEW ABOUT: SHOPIFY PAYMENTS MUST BE DEACTIVATED BEFORE THE TRANSFER — and Julia has stopped to ask the right question first.** Read off the support conversation itself (screenshot supplied by Lilian, 2026-09-07). **(a) Alex L, Support Specialist, Friday 2026-09-04 12:06 pm:** *"Your Shopify Balance account has now been closed, so that Balance-related blocker has been removed."* Then a **new requirement**: *"Before transferring store ownership, please also disable Shopify Payments on the store. This helps ensure the new owner can set up Shopify Payments and any related financial services under their own business and banking information after the transfer is complete."* The route he gave: **Settings → Payments → Shopify Payments → Manage → scroll to the bottom → Deactivate Shopify Payments → follow the prompts**; then retry the transfer from **Settings → Users**. **(b) Julia Kononova, 2026-09-07 10:43 am — she did NOT just follow it, and she was right not to.** The firm does **not** want the banking to change: *"we will still be using the same bank account. The only thing that will change is the ownership."* So she asked, before touching anything: *"If I go ahead and disable Shopify Payments, do the ownership transfer, will I be able to add the same bank account back?"* **No reply yet — she is waiting on Shopify.** ⛔ **This corrects what was written into this file earlier on 2026-09-07**, which read the Balance closure as leaving the transfer free to proceed: **it is not**, and deactivating Shopify Payments on a live store is not a step to take on an assumption about whether the bank account can be restored. _(Shopify support conversation `help.shopify.com/en/inbox/14006272`, ticket `#69851505`, via Lilian 2026-09-07.)_

- 2026-09-22 — 🔴 **SHOPIFY DID ANSWER JULIA'S 2026-09-07 QUESTION — THE SAME DAY — AND THE REPLY HAS SAT UNREAD FOR TWO WEEKS.** Gmail holds a `no-reply@shopify.com` notice, *"New message from Shopify Support — Alex L replied to your conversation"*, dated **2026-09-07 17:36 UTC (1:36 pm EDT)**, about three hours after Julia's 10:43 am question on whether the same bank account can be re-added after Shopify Payments is deactivated. It is still **unread**. ⚠️ **The 2026-09-12 and 2026-09-19 sweeps each wrote "no reply found" — true of the reply's TEXT (which never arrives by email), wrong about the case:** the notification that a reply exists was in the inbox the whole time. So the case has been waiting on **us**, not Shopify, since 2026-09-07 — the same failure as 2026-08-27 → 2026-09-03. **The content of Alex L's answer is not in email** _(read the same day from a screenshot — next entry)_; it can only be read inside the Support Inbox (`help.shopify.com/en/inbox/14006272`, ticket `#69851505`). No other Deep Tech Shopify communication found in Gmail after 2026-09-07 (searched `from:no-reply@shopify.com`, `from:do-not-reply@shopify.com`, "Deep Tech", gorobots, "Go Robots"). _(Gmail check, 2026-09-22 — worked by Lilian.)_

- 2026-09-22 — 🟢 **ALEX L'S 2026-09-07 REPLY, READ (screenshot of the Support conversation supplied by Lilian): YES — THE SAME BANK ACCOUNT CAN BE ADDED BACK.** His words: *"Yes, the same external bank account can be used again when Shopify Payments is set up after the ownership transfer, as long as the new Shopify Payments setup is completed with the correct business, tax, representative, and banking details for the new owner/business."* He names **Shopify Balance as "the main item that could not continue through the ownership change"**, and adds: *"That does not mean the external bank account itself is blocked from being used again."* **The path he gave, in his order:** (1) Balance already closed · (2) deactivate Shopify Payments · (3) complete the ownership transfer · (4) **the new owner** sets up Shopify Payments again with the appropriate business and account details · (5) the same external bank account is added again during that setup, if it is still the right account for the new owner/business. ⚠️ **His one condition:** the bank account entered in the new setup must **match the new owner/business details** — *"If there is a mismatch between the account holder/business information and the bank account, additional verification may be required."* ⓘ **Our reading, not Shopify's:** the account holder is the company (Deep Tech Development Group LLC) and the business does not change — only the store owner moves from Julia to Vitalii Ivanov — so a match is expected; the representative details in the new setup will be **Vitalii's**, not Julia's. Also ours, not his: while Shopify Payments is off (between step 2 and step 4) the store cannot take payments through Shopify Payments, so steps 2–4 are best done back to back, with Vitalii ready to do step 4. **The gate Julia set on 2026-09-07 is therefore cleared; nothing known blocks the transfer except doing it** (subject to Shopify's possible extra verification). _(Shopify support conversation, ticket `#69851505`, Alex L 2026-09-07 1:36 pm — read 2026-09-22, worked by Lilian.)_

- 2026-09-22 — 🟢 **THE FIRM DID ITS SIDE OF THE SHOPIFY TRANSFER — the store is now waiting on Vitalii Ivanov to accept.** Lilian, same day, after Alex L's reply was read: *"Ya hice la transferencia… Ya Vitaly recibió el correo con la invitación y estamos esperando a que termine la transferencia, pero ya todo está hecho de nuestra parte."* So the ownership transfer was **initiated** and **Vitalii received the invitation email**; _(our reading of how Shopify works, not her words:)_ it completes when he accepts it. ⓘ **Not stated separately:** that Shopify Payments was deactivated first — it is Shopify's prerequisite for the transfer and "everything is done on our side" covers it, but it was not named. _(Lilian, 2026-09-22.)_
- 2026-09-22 — ✅ **CONFIRMED FROM GMAIL, THE SAME DAY: Shopify Payments WAS deactivated first, and the transfer WAS accepted the same evening.** Two Shopify system notices to Julia's inbox: **18:19 UTC**, *"Payment settings changed… Julia Kononova deactivated Shopify Payments as a payment provider"* — closing the "not stated separately" gap above; and **18:39 UTC**, *"Store transfer of Deep Tech Development was accepted — willivanoff@gmail.com has accepted the store transfer invite. As a result, this store is no longer part of your organization."* 🟢 **THE TRANSFER IS THEREFORE COMPLETE — the store is now Vitalii Ivanov's, not Julia's.** _(Gmail, `mailer@shopify.com`, 2026-09-22, found in this sweep 2026-09-26 — four days after the fact; nobody had re-checked Gmail on the Shopify matter since the 2026-09-22 log entries above.)_ **What is left is exactly the two items Alex L's path named and nothing has confirmed either done:** (1) **Vitalii sets up Shopify Payments again**, on his own Shopify admin, with the company's business/tax/representative details and the **same external bank account** — no evidence found either way that this has happened; (2) **the firm still needs to ask Shopify Support for the August 2026 Balance statement** — no evidence found that this request has been made. **Also unresolved:** whether Julia's inbox has stopped receiving this store's notices (it received the transfer-acceptance notice itself, which is expected as part of the transfer completing — not yet evidence either way about ongoing notices).

### Outstanding items (CI-only — never in the SOP)
- 🟢 **SHOPIFY — THE TRANSFER IS DONE. Confirmed 2026-09-22, found in this sweep 2026-09-26** (Gmail, `mailer@shopify.com` — see §6). **What is genuinely still left, and neither has evidence of being done:** (1) **Vitalii sets up Shopify Payments again** on his own admin, with the company's details and the **same bank account** (Shopify's match-the-business condition applies — see the 2026-09-22 log entry on Alex L's reply) — nobody has confirmed this happened; (2) **still owed by us: ask Shopify Support for the August 2026 Balance statement** — no evidence this request has been made; it does not heal with time and cannot be recovered once forgotten. **Lower priority, needs a decision, not an action:** the chase Routine `trig_014ZK9ZhX4su7hJ8DpaWh4xa` has now fully lost its purpose (both the reply it was chasing and the transfer itself are done) — **Lilian/Julia to decide: repurpose it to chase item (1)/(2), or delete it.** **Also still open:** confirm Julia's inbox has actually stopped receiving this store's routine notices (the 2026-09-22 transfer-acceptance notice itself is not evidence either way — it is the notice OF the transfer, not an ongoing one). **Double note `503544` is in sync with this — its `updatedAt` is 2026-09-22 and its own text already reads "TRANSFER INITIATED… WAITING ON VITALII," which is now one step behind this file; update it in the same pass as this file if this session has Double write access, otherwise flag it for whoever next opens this client's Double record.**
- ⛔ **SUPERSEDED 2026-09-22 (same day) by the item above — the transfer (step 2) is done; step 1 (deactivating Shopify Payments) is presumed but was not stated — see the 2026-09-22 log:** 🟢 **SHOPIFY — SUPPORT ANSWERED "YES": THE SAME BANK ACCOUNT CAN BE ADDED BACK. The transfer is now OURS TO DO** (Alex L, 2026-09-07; read 2026-09-22 — see the log). **Do, in order, back to back:** (1) deactivate Shopify Payments — *Settings → Payments → Shopify Payments → Manage → bottom → Deactivate Shopify Payments*; (2) *Settings → Users* → transfer ownership to **Vitalii Ivanov**; (3) **Vitalii** sets up Shopify Payments again with the company's business, tax and representative details and the **same bank account** — it must match the business, or Shopify may ask for extra verification; the representative will be **Vitalii**, not Julia _(our reading)_. ⚠️ _(Our inference, not Shopify's:)_ between (1) and (3) the store cannot take payments through Shopify Payments, so line Vitalii up before starting. Still separate and still owed: ask Support for the **August 2026 Balance statement**. ⓘ The chase Routine `trig_014ZK9ZhX4su7hJ8DpaWh4xa` has lost its purpose (reading this reply) — **Lilian/Julia to decide: re-prompt it to chase the transfer, or delete it.** Double case note `503544` was rewritten on 2026-09-22 to this state.
- ⛔ **SUPERSEDED 2026-09-22 — the three Shopify items below were written while Alex L's reply was unread; they are kept for the trail only.** (Their live pieces — the August statement and the Routine — are carried into the 🟡 item at the top of this list.)
- 🟡 **SHOPIFY — WAITING ON SUPPORT, and the question in flight is the one that matters.** The Balance closure (2026-09-04) removed the *first* blocker, but Support then named a **second**: **Shopify Payments must be deactivated before ownership can transfer.** ⛔ **Do not deactivate it yet.** Julia asked Support on **2026-09-07 10:43 am** whether the **same bank account can be re-added afterwards** — the firm is keeping the same banking and only changing the owner — and **no answer has come back.** 🛑 **That answer is the gate:** if the account cannot be restored, deactivating first would break the client's payouts to solve a paperwork problem. **Next step is to read the reply inside the conversation** (`help.shopify.com/en/inbox/14006272`) — ⚠️ **substantive replies do NOT arrive by email**, only bare notifications do; the 2026-09-04 closure notices were account *state changes*, which is a different thing. Ticket **`#69851505`**. Then, and only then: deactivate Shopify Payments → *Settings → Users* → transfer to **Vitalii Ivanov**.
- 🟠 **SHOPIFY — the Balance account closed 2026-09-04. That was the FIRST blocker only; the transfer is still blocked — see the 🟡 item above.** ⛔ **This supersedes the 2026-09-03 🟡 item further down**, which was written while the closure was still pending: its *"look on 2026-09-08, act by 2026-09-10"* dates are **moot**, and so are the dates on the chase Routine armed for them (`trig_014ZK9ZhX4su7hJ8DpaWh4xa`) — ⚠️ **do not delete it**: what it now needs to prompt is reading Shopify's reply to Julia's 2026-09-07 question inside the conversation. **What is actually left, in order:**
  1. 🔴 **Ask Shopify Support for the AUGUST 2026 Balance statement.** It can no longer be downloaded from the admin — the closure revoked statement access on 2026-09-04 — and Shopify's own notice names Support as the route. This is the one piece of client data the closure cost us, and **it does not heal with time**; every other statement was already saved on 2026-08-25.
  2. ⛔ **The transfer itself — SUPERSEDED, see the 🟡 item above.** This step was written before the support conversation was read and said the transfer *"should now simply work"* once the Balance account closed. **It will not:** Shopify named a **second** blocker on 2026-09-04 — **Shopify Payments must be deactivated first** — and whether the same bank account can be re-added afterwards is an **open question Julia put to Support on 2026-09-07 and has not had answered.** Do not act on this line.
  ⓘ Found 2026-09-07 by manual catch-up; the 2026-09-05 sweep never ran.
- 🟡 **SHOPIFY — Julia has given the permission; we are now genuinely waiting on Shopify.**
  ...
  **2026-08-25**; the August one was only issued on **2026-09-03**, and **no record of it being downloaded
  was found** — though the search was narrow: the client's Drive folder was **not** opened on 2026-09-03 and
  **Julia was not asked**, so this is an unchecked gap, not an established absence. Shopify may close the account at any moment and closure
  destroys access to the statements permanently, so this is a same-day item:
  the store's Shopify admin → **Shopify Balance → Statements** → file it in the client's Drive folder
  with the others. _(The direct link, with the account id in it, is in Double note `503544`.)_
  ...
  `no-reply@shopify.com` carries no text and that address is not monitored. **2026-09-08 is when to LOOK**
  (the Routine below fires); **2026-09-10 is the deadline to ACT** — if Shopify has still not answered by
  then, chase inside the conversation quoting the ticket. Then
  ...
  *"Deep Tech Shopify — chase the Balance closure (ticket #69851505)"*. ⚠️ **It was created from a
  ...
  attached — see the `automated-email-reports` skill's `created_via` table. ⚠️ **That is a trade, not an
  upgrade:** a Routine made in the UI can never be rewritten by a session again. A session-made one also
...
- 🟡 **USPS mail forwarding for this company (and for 1701 N M ST LLC, Universal Trading Technology
  LLC, and the owner individually) — deadline was 2026-09-18, now 8 days past it, and the digests kept arriving.** No evidence found that a renewal or a permanent address change was formally filed. ⚠️ **Read carefully — still corroborating, not conclusive:** a USPS Informed Delivery digest addressed to "TETIANA" (i.e. Tetiana Mogylova, the owner's related individual — see §7) arrived in Julia's inbox on **2026-09-21** — three days *after* the stated deadline — which is mild evidence the forwarding is still active (Informed Delivery digests reflect mail addressed to the household, forwarding or not, so this is not proof the forwarding order itself renewed). **No further digest for this household was found in a search bounded `after:2026/09/19`** through this sweep. **Recommend Lilian/Julia confirm directly with USPS or check the online forwarding-order status** rather than inferring from digest timing alone. STILL OPEN; no decision found. _(Gmail, `USPSInformeddelivery@email.informeddelivery.usps.com`, bounded `after:2026/09/18` and `after:2026/09/19`, checked 2026-09-19 and 2026-09-26.)_
...
- ~~File the downloaded Shopify Balance statements into the client's Drive folder~~ — **done, confirmed by
  ...
  that account. ⚠️ **REOPENED 2026-09-03 — this is no longer complete.** The **August 2026** statement was
  issued after that upload and is not on file; see the Shopify item above.
...
- 2026-09-26 — **Incremental sweep (baseline 2026-09-19→2026-09-26) — the Shopify transfer's completion was found this run, four days after the fact.** Double: `list_client_properties` unchanged; `list_notes` — both notes re-read in full: **491845 (FDOR) unchanged since 2026-08-13; 503544 (Shopify) IS current** — its `updatedAt` is 2026-09-22 and its text already reads "TRANSFER INITIATED… WAITING ON VITALII," one step behind what this sweep found in Gmail (below) — flagged in outstanding items, not edited (this sweep's scope is the repo file). `list_activity_log` (from 2026-09-19) returned **zero entries**. Gmail (business names + Ivanov + Shopify, after:2026/09/19): **found the two Shopify system notices of 2026-09-22 confirming Shopify Payments was deactivated (18:19 UTC) and the store transfer was ACCEPTED by Vitalii (18:39 UTC)** — folded into §5/§6 above, this is the single most consequential finding of this sweep; a further search (`from:no-reply@shopify.com OR from:do-not-reply@shopify.com`, after:2026/09/19) found **no further Shopify activity** on this store since the 2026-09-22 notices — no evidence yet that Vitalii has set up Shopify Payments again or that the firm has asked Support for the August Balance statement. A targeted search for FDOR/reemployment, Safe Guard Self Storage, Penn Credit and "Balance statement" (after:2026/09/19) found **nothing new** on any of those — all STILL OPEN, no movement. Gusto "payroll is late/due" reminders continued on **2026-09-20, 2026-09-22 and 2026-09-24** for the Sep 14–27 pay period — folded into outstanding items above (now ~52 days unsettled). A USPS Informed Delivery digest for "TETIANA" was found on **2026-09-21** (three days past the 09-18 deadline) — folded into outstanding items above. Google Drive (`fullText contains 'Deep Tech'`, `modifiedTime > 2026-09-19`, `excludeContentSnippets: true`) returned only a general "BUSINESS FORMATION ITAKE FORM (Responses)" spreadsheet (not client-specific — a firm-wide intake form) and the internal "My hours" spreadsheet — no new client-specific document. Ping (org-wide, "Deep Tech Development Go Robots Shopify payments Ivanov Gusto FDOR toll Penn Credit storage USPS mail forwarding") returned no legible, on-topic hits — same pattern as every prior run. **Chase pass (client's own outstanding items, in full):** the Shopify transfer — **RESOLVED this run** (see above); the two remaining Shopify sub-items (Vitalii's Shopify Payments setup, the August Balance statement) — STILL OPEN, no evidence either way; the Gusto cancellation decision — STILL UNSETTLED, ~52 days, evidence now overwhelming it was never actioned; the USPS mail-forwarding deadline — STILL OPEN, past due, mild evidence forwarding is still active; the FDOR Q2-2025 demand-withdrawal confirmation — STILL OPEN, ~44 days since first flagged, nothing found; Safe Guard Self Storage cancellation confirmation — STILL OPEN, ~58 days pending, nothing found; the new Penn Credit toll balance — STILL OPEN (recurring, no deadline), nothing found; the second "Deep Tech" Drive folder identity check, the sales-tax state/registration confirmation, and the State Farm UM wet-signature hand-off — **not chased this run** (budget).
