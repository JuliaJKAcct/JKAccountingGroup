...
- 2026-08-13 — **TaxDome notes read (Phase 2).** The migrated note on the FDOR matter **closes what the phone note left open**: both effective-date changes went through and the FDOR's confirmation letter is in the client's Drive folder. §5 and Double note **491845** corrected the same day. _(TaxDome notes, migrated — filed under Deep Tech.)_ _(Worked by Lilian.)_
