...
- 🔴 **SHOPIFY — SUPPORT HAS REPLIED (2026-09-07 1:36 pm EDT) AND NOBODY HAS READ IT — the case is on OUR desk (see the 2026-09-22 log entry).** Next step: Julia opens the Support Inbox and reads Alex L's answer; what follows depends on it. The text below describes the state before that reply was found.
