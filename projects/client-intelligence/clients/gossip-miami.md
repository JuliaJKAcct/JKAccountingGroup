...
- 2026-08-23 — 🔴 **THE FEBRUARY 2025 RENT WAS EXPENSED IN THE BOOKS AND NEVER PAID FROM THE COMPANY'S ACCOUNTS — a new question for the client.** The `Rent` account holds nine cheques to the landlord and one **journal entry dated 28 February with no payee and no bank account**, whose other side is an `Accrued Expenses` liability that **carries a single entry all year and is never reversed**. There is no February cheque to the landlord anywhere in the ledger. ✅ **The bookkeeping is right** — nine payments plus one accrual is ten months of rent for ten months of occupancy — and on the **cash method the unpaid month is properly excluded from the return's rent deduction.**
  🔴 **What nobody has established is what became of the debt**, and it is worth real money on the return: **never paid** (the liability went to the buyer with the company) leaves the return as computed; **paid from outside the company's bank account** — an owner's own money, or till cash that never reached the bank — makes it **deductible on the cash method**, and if an owner paid it, that payment is also a **capital contribution**; **settled at closing** gives the same result.
  ⚠️ **There is a documentary reason to think it was settled:** covenant 6.7(a) obliged the sellers to leave the company clean before closing, and an unpaid month of rent to the landlord of the premises is exactly the debt a buyer refuses to inherit — **yet the liability is still open on the books at 31 December.** Either it truly was never paid, or it was paid off the bank feed and **nobody recorded it**.
  🛠️ **The question to put, in one line:** *"La renta de febrero de 2025 al Keystone Plaza — ¿se llegó a pagar? Y si sí, ¿desde dónde: la cuenta de la compañía, dinero personal de ustedes, o se descontó en el cierre de la venta?"* Figures and the full effect on each line are in the working paper (§6 finding 15).
...
- 🔴 **TWO OPEN ITEMS MOVE THE RETURN'S HEADLINE FIGURE, AND THEY RUN IN OPPOSITE DIRECTIONS** _(the second added 2026-08-22)_. **(1) The Vagaro report for 1–29 October 2025.** October revenue in the books is bank deposits only (no Vagaro Q4 export exists), so the month is missing its cash sales, tips, card-surcharge income and discounts — and October is inside the short S period. Ask the client; if he no longer has access, the buyer does. **(2) The TIPS PAYOUT — the larger of the two, and it runs the other way.** Tips are counted as income, so if what was paid on to the workers is not deducted anywhere, income is **overstated** — and the contractor account contains no journal entries at all, so the payout is either inside the bank payments or absent. ⚠️ **Resolve it together with the undeposited cash-sales asset**, which is a near-identical amount and may be the same money seen twice. Both questions go to Maria in one message.
