...
- 2026-08-22 — 🔵 **THE 2025 RETURN WAS RE-CUT TO THE FULL CALENDAR YEAR, on Lilian's decision relaying Julia.** *"Quiero hacer el análisis teniendo en cuenta el año entero. Sin dejar nada de 2025 fuera. Luego Julia decidirá si hay que excluir algo."* Julia's reason: the money banked after 30 October is **collection of sales made before the sale**. The working paper now carries **both columns in every table** — full year and the 29-October cut — so whichever way Julia rules, nothing is rebuilt. What is durable:
  ...
  - 🔴 **THE DEADLINE IS SHORTER THAN THE FILE PREVIOUSLY SAID, and it depends on the branch.** If the S election **survived**, this is an ordinary calendar-year 1120-S: due 15 March 2026 (a Sunday → 16 March), extended to **15 SEPTEMBER 2026**. If it **terminated**, the S short period follows the buyer's C period: 15 April, extended 15 October. ⚠️ **The branch with the tighter deadline is the one where the firm's existing 7004 actually works** — it was filed as an ordinary calendar-year extension. **Treat 15 September as the working deadline until Julia rules.**
...
- 🔴 **THE 2025 RETURN IS BUILT ON THE FULL CALENDAR YEAR, AND THE FILING SHAPE IS STILL UNDECIDED** _(re-cut 2026-08-22)_. The working paper carries **both columns** — the full year and the 29-October cut — because which one is *filed* depends on a fact nobody has: **is the buyer a US citizen or resident?** If the S election **survived**, one full-year 1120-S is filed and **the buyer gets a K-1 as well** (three shareholders, and an allocation method that swings thousands per person). If it **terminated**, the year is cut by law and the tail is the buyer's separate return. 🔴 **THE WORKING DEADLINE IS 15 SEPTEMBER 2026** — the full-year branch is an ordinary calendar-year return, and that is the branch the firm's existing 7004 actually fits. *(The cut branch would run to 15 October, but there the extension may not cover the right period at all.)* **Still open besides the branch:** the post-sale deposits question, asked 2026-08-20 and unanswered; the Draw / undeposited-cash / owner-loan classification, which the books hold only as pooled totals; and **who engages and who signs**, the year-end owner not being our client.
