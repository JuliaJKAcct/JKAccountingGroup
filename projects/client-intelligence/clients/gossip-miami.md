...
- 2026-08-21 (later) — 🧮 **PHASE 2 · THE 2025 1120-S WAS PREPARED.** ⚠️ **Re-cut 2026-08-22 to the FULL CALENDAR YEAR** — see the entry at the foot of this log; the short-period version below is now one of two columns, not the answer. The figures, every line, the decisions and the tie-outs are in the working paper [`projects/tax-returns/gossip-miami-llc/2025-form-1120s.md`](../../tax-returns/gossip-miami-llc/2025-form-1120s.md) — **not here**, and not in Double. What is durable and non-numeric:
