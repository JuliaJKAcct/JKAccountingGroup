...
- 🔴 **THE VAGARO REPORT FOR 1–29 OCTOBER 2025 — the one document that still moves the return's headline figure.** October revenue in the books is bank deposits only (no Vagaro Q4 export exists), so the month is missing its cash sales, tips, card-surcharge income and discounts — and October is inside the short S period. Ask the client; if he no longer has access, the buyer does.
