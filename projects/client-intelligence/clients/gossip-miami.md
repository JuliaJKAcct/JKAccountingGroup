...
- **2025-09-29 → 2026-02-19 — THE FDOR COLLECTIONS EPISODE, recovered 2026-08-13 from Lilian's own call notes.** _(Lilian's iCloud notes, migrated — folder "Gossip Miami"; notes dated 2025-11-24 and 2026-02-19.)_ None of this was in any source the firm had swept, and it changes the picture of the sales-tax account materially. ⚠️ **It is NOT yet in the Double case note — see the warning under §7.**
  ...
  - **Julia filed amendments for Q4 2024, Q1 2025 and Q2 2025**, which the state takes **90 days** to process, and **asked the FDOR to apply the company's existing credit against the penalties.** The credit stood at **$4,251.15** as at 2025-10-08.
  ...
  - 💰 **2026-02-19 — the FDOR confirmed an AVAILABLE SALES-TAX CREDIT of $3,102.06**, and told the firm that **Form DR-26S is what claims it back as a cheque.** **Nothing records that being filed.** See Outstanding items.
...
- 💰 **CLAIM THE SALES-TAX CREDIT — $3,102.06, confirmed available by the FDOR on 2026-02-19, and it needs a Form DR-26S to come back as a cheque.** Nothing records that form being filed, and this is **money owed to the client that nobody has asked for.** ⚠️ **Two things to settle first:** the credit had been **$4,251.15 on 2025-10-08** and Julia asked the FDOR to apply it against the penalties on the amended Q4 2024 / Q1–Q2 2025 returns — so **part of it has already been absorbed and the balance may have moved again**; and if the business really was sold (§4), **whether the credit follows the entity or the owner** decides who may claim it. **Confirm the current balance with the FDOR before filing anything.**
- **DID THE COLLECTOR MATTER EVER CLOSE?** A collector was assigned on **2025-09-29** over the December 2024, March 2025 and June 2025 bills, with a stated risk of **frozen bank accounts**. The amendments and the credit were the answer to it, but **no source records the account being cleared.** This sits underneath the "nothing filed since Q3 2025" problem and may be the same account still open.
...
- **Double case note — the team-facing history of the 2025 tax preparation:** "CASE · 2025 tax preparation", note **485291** on the client record. It carries the full detail including contact names and emails (that belongs in Double, not here). **Update it in place whenever this matter moves** — never a second note (see the [`double-mcp`](../../../.claude/skills/double-mcp/) skill §7).
  - 🔴 **THIS NOTE IS EFFECTIVELY FULL, AND THE 2025-09 → 2026-02 FDOR COLLECTIONS HISTORY (§6) IS NOT IN IT.** The body is close to the ~7,500-character wall where Double returns a `403` rather than truncating, so the recovered material — the assigned collector and the bank-freeze warning, the DR-841 request, the amendments, and the **$3,102.06 credit claimable on a DR-26S** — was deliberately **not** appended. **Do not simply paste it in: the write will fail.** The fix is one of the two the skill sets out — **trim the note first** (its §7 rule 12 names what to cut: the derivation behind settled facts, and client-handling background), or **split it `Part 1 / Part 2`** under the discipline in §7. **The credit is the piece the team most needs in front of them**, so it should lead whatever goes in. _(Raised 2026-08-13.)_
