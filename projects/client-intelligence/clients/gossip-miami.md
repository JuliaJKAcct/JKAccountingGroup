...
- 2026-08-21 — 🔍 **PRE-RETURN REVIEW (phase 1) RUN FOR THE 2025 1120-S — the session Lilian opened to start the return.** All ten sources read; the durable findings are folded into §1/§2/§4/§5 above. The specifics of this pass:
  ...
  - **The 3 post-sale deposits question went to the client 2026-08-20 (Lilian's email) and is unanswered** as of this review.
...
- 🟡 **FOUR ITEMS THE 2025 RETURN STILL NEEDS — reduced from blocking to open, because Julia ruled the route** _(2026-08-21)_. The S-election question is now a **working assumption** (§1) rather than a blocker; the allocation method question dissolves with it (a real termination forces the books-closing cut). Still genuinely open: **(a)** confirmation of the buyer's US-person status, **(b)** the three post-sale deposits (asked 2026-08-20, unanswered), **(c)** the Draw / undeposited-cash / owner-ATM-deposit classification, **(d)** who engages and who signs, the year-end owner not being our client.
- 🔴 **THE 2025 1120-S IS BLOCKED ON FOUR ANSWERS — everything else about it is ready _(phase-1 review, 2026-08-21)_.** (1) **Is the buyer (Sergei Kopyrin) a US citizen or resident?** If not, the S election **terminated at the 2025-10-30 transfer** and the year splits into an S short year + a C short year — it decides which forms even exist. Ask the sellers/buyer. (2) **The three post-sale deposits** — asked 2026-08-20, unanswered. (3) **Allocation method for the ownership change** — per-share-per-day by default vs a **§1377(a)(2) closing-of-the-books election** (needs consents, incl. the buyer's) — **Julia rules**. (4) **The Draw / Cash-Sales / Loan-from-Owners classification** — what the owners kept in cash vs lent vs contributed; decides distributions, basis and Schedule L (Julia/Lilian + client). ⓘ Also practical, before filing: **an officer must sign the return, and at year-end the only owner is the buyer** — who is not our client; settle with Julia/Lilian who engages and who signs.
