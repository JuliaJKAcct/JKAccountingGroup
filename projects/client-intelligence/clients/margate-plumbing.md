...
> **Status:** Active · **Owner:** Maria · **Last updated:** 2026-09-19
...
- 🔴🔴 **Workers' Comp EXEMPTION (FUBA Policy #13719) expiring 2026-09-30 — NOW 11 DAYS OUT, STILL NOT CONFIRMED RENEWED.** Distinct from the standing WC/GL premium-audit item below. The owner forwarded FUBA's notice 2026-09-04; Julia told him the same day to renew the exemption directly with the State of Florida. CHASED again 2026-09-19 (bounded ≥2026-09-12): still no confirmation the renewal was filed. **This deadline should be raised directly rather than left to the next sweep.**
- **Workers' comp audit** and **general liability (GL) audit** — STILL OPEN, no new correspondence found this run either (CHASED 2026-09-19); now ~61 days pending since at least 2026-07-20; last known state is that a payment was applied to the current policy, not the outstanding prior-term audit balance, which remains outstanding.
- **QuickBooks Payments chargeback dispute (Pre-Arbitration, escalated 2026-07-30)** — STILL OPEN. CHASED again 2026-09-19: no new correspondence on this item; now ~51 days pending, no deadline stated.
- **Mercury IO card credit limit — continued volatility, now including a further decrease on 2026-09-16** (no dollar figure retained) — the pattern from the 2026-08-19/26 decreases and the 2026-09-02–09-11 activity is continuing rather than resolving; worth flagging to the owner given the frequency.
- **"CJM" AR item / check-payment classification** — not chased this run (budget; no targeted search run for this specific item).
...
- Weekly Gusto payroll continues on its normal cadence (payroll-due reminders for Sep 9–15 and Sep 16–22 arrived 2026-09-12 and 2026-09-18, no dollar figures recorded).
- 🔴 **Cross-client lead, now seen TWICE — see [`beemold-usa.md`](./beemold-usa.md).** An Intuit QuickBooks payment-details notice named "Vasile Bivol" against **Kolo Florida Inc**'s subscription, first on 2026-09-06/10 and again on 2026-09-15 — a possible owner-group link neither this file nor `kolo-florida.md` currently records. Not actioned by this sweep (out of scope); flagged for whoever next works `kolo-florida.md`.
