...
- 🔴 **NEW — Workers' Comp EXEMPTION (FUBA Policy #13719) expiring 2026-09-30** — ~18 days out from today. Distinct from the standing WC/GL premium-audit item below. The owner forwarded FUBA's notice 2026-09-04; Julia told him the same day to renew the exemption directly with the State of Florida. CHASED this run: no confirmation yet that the renewal was filed — deadline is live.
- **Workers' comp audit** and **general liability (GL) audit** — STILL OPEN, no new correspondence found this run either; now ~54 days pending since at least 2026-07-20; last known state is that a payment was applied to the current policy, not the outstanding prior-term audit balance, which remains outstanding.
- **QuickBooks Payments chargeback dispute (Pre-Arbitration, escalated 2026-07-30)** — STILL OPEN. CHASED this run: a targeted search (`Margate (comp OR liability OR WC OR GL OR audit OR JDA) after:2026/08/29`) found no new correspondence on this item; now ~44 days pending, no deadline stated.
- **Mercury IO card credit limit — continued volatility, 2026-09-02 through 2026-09-11**: at least one further decrease and one increase recorded (no dollar figures retained) — the pattern from the 2026-08-19/26 decreases is continuing rather than resolving; worth flagging to the owner given the frequency.
