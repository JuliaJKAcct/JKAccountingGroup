...
- **State returns:** federal is not the whole job for this client. 2024 was federal + **Montana** (resident) + **Illinois** (Schedule NR). **For 2025 his residence is Washington until May, then Florida** — neither taxes personal income _(client call, 2026-08-12)_. ✅ **Montana is CLOSED** — Lilian's decision, 2026-08-12 (§1). 🟠 **MINNESOTA is NARROWED** — no rental income in 2025, so no Schedule E _(client, 2026-08-17, relayed 2026-09-21; §5)_. ⛔ **Not closed:** a nonresident is also taxed on **gain from selling Minnesota real property**, and whether he still owned the house at year-end is open (§5). ⚠️ **The other candidate never turned on where he lived either: ILLINOIS**, which followed his companies' Illinois income. ✅ **It now attaches to a named entity — Midwest Expedited Corp** _(Lilian, 2026-09-21)_ — but **it still cannot be settled without the K-1** (§5), so it stays "it depends on the document he cannot get", not "ask him".
...
> (`organizerId 146070`, visibility `admins_only`). **The tax facts it established are recorded
> below** — Lilian's ruling of 2026-08-12 ([`double-mcp`](../../../.claude/skills/double-mcp/)
...
- ✅ **WHICH "Midwest" — SETTLED 2026-09-21: MIDWEST EXPEDITED CORP** _(Lilian, closing her own
  August hedge)_. He holds shares in **two** companies whose names begin that way — Midwest
  Expedited Corp and **Midwest Truck Leasing LLC** — which is why this was open, and **this file
  had already been caught once by a "Midwest" it read too quickly** (the working note's "Midwest"
  turned out to be his own company, not an outside payer). **The 1120-S chase, the Illinois question
  and the expense fork all now point at Midwest Expedited Corp.** 🔴 **And it is the entity that ran
  a very large 2024 loss**, which is why the basis question below now carries money (see the
  2026-09-21 block).
...
- **Routes worth putting in front of Julia** (options for that conversation, not decisions):
  ...
  **amending** when the K-1 appears — ⚠️ if we go that way, **Form 8082** (Notice of Inconsistent
  Treatment) is the disclosure that goes *with* it. **8082 supplies no figures** and is not a route
  on its own; it protects him from the consistency requirement when he reports a share no K-1 states.
- ⚠️ **"He received no money" does NOT mean the other two companies owe him no K-1.** An S
  corporation allocates its income or loss to each shareholder **whether or not it distributes a
  cent** — so the two silent companies still owe him 2025 K-1s if he held shares at any point in
...
- ✅ **ANSWERED 2026-08-12 — NO FINAL K-1, NO SALE, AND THE COMPANIES ARE STILL OPEN.** Lilian asked
  ...
  - 🟠 **The worthlessness branch probably stays available for that company** — §165(g) needs
...
- ⚠️ **"He is no longer part of these companies" — RESOLVED as the lock-out, not a disposal**
  ...
  **still owns the stock and is still allocated income or loss on a K-1**; nothing about the dispute
  ...
  - **If he never disposed of them,** he is a 2025 shareholder in all three and **all three K-1s are
...
**The organizer says Marketplace**, which is why Form 1095-A was written up as a hard blocker.
...
on the return and Form 8962 is missing — **an unsubsidised exchange plan produces a 1095-A and no
rejection**. So he may turn out to have bought on-exchange and still not be blocked. Conversely a
...
answer** — a known defect, [`FOLLOW-UPS.md`](../../../FOLLOW-UPS.md) row 25 — so a client with
rental property completes the organizer at 100% and is never asked. Silence there is not evidence.

**✅ Answered, and not to be re-asked:**

- **His wife had NO income in 2025** — so **no Schedule C for her**, where 2024 carried a small one.
  _(One narrow follow-through only: if the activity continued and had **expenses** without income, a
  Schedule C can still be right; if it simply ceased, note the year so nobody carries it forward.)_
- **No distribution from the IRA account in 2025.** ⚠️ **Asked and answered for an IRA specifically
  — that is what Lilian put to him, and it is what he answered.** His 2024 early distribution with
  the §72(t) penalty may have come from a **401(k) or another plan**, and that question has still
...
**✅ The children — SETTLED as to who they are** _(Lilian's correction, 2026-08-12, resolving her own
wording the same day)_. **He has TWO CHILDREN, not two dependants** — she had written "dependents"
and corrected it to *hijos*. They are:

1. **The DAUGHTER already claimed on his 2024 return** — the one who carried the Earned Income
   Credit and the Additional Child Tax Credit there. _(Her first name was given on the call; it
   stays in Double.)_ **She is a child, not his spouse** — an earlier reading of this file had it
   the other way round and Lilian corrected it.
2. **A SON from a previous relationship**, whom he supports with **child support**, who **does not
   live with him** and is **reported nowhere** — not on his return, and we hold no information on him.
...
- **The son: on his account we need nothing, but there is a branch worth one question.** A
  ...
  deductible to the payer**. So to file it as he describes it, **no name, date of birth or SSN is
  needed** — nothing on a 1040 asks for a child who is not claimed. ⚠️ **But that is the answer to
  "do we need it to file", not to "do we need it".** If the mother would sign an 8332 release, the
  **Child Tax Credit moves onto his return** — and then we would need the child's details. **That
  is the branch with money in it, and it is Lilian's open question for Julia** _(our read, not a
  decision — she asked whether the information is needed and it has not been put to Julia yet)_.
...
**Home office:** he completed the firm's Home Office Deduction template. The file is `Home_Office_Deduction_Filled.xlsx`, in Double
...
- ✅ **Is the Minnesota house RENTED OUT? — ANSWERED 2026-08-17: NO RENTAL INCOME IN 2025**
  _(client, by Google Voice; relayed by Lilian 2026-09-21)_. **No Schedule E.** ⛔ **But see the
  2026-09-21 block: that does NOT close Minnesota**, because gain on selling Minnesota real property
  is Minnesota-source too, and whether he still owned the house at year-end is open. **The rest of
  this bullet is kept as the reasoning that produced the question, not as a live ask.**
  ⓘ *What it said before the answer came: a house he owns and does not live in either sits empty
  or produces **rental income** — **Schedule E**, with depreciation, and **Minnesota-source income**.*
  ⚠️ **The Minnesota return is threshold-gated, and the threshold has a trap:** a nonresident files
  when **Minnesota gross income reaches $14,950 (2025)** — measured on **GROSS RENTS, not net** — so
  **a rental running a depreciation loss can still require the return**, while a small one may not.
  ...
  **Schedule A** would show Minnesota mortgage interest and property tax. ⛔ **BOTH ROUTES ARE NOW
  ...
  haya rentado durante el año 2025"* — could mean **he rented a place to live** or **the house was
  rented out**; it was read here as the first. **The client's own 2026-08-17 answer settles it the
  same way: he rents where he lives and the Minnesota house produced no rent.** _(If it is empty, the mortgage
  interest is still deductible as a **second home** on Schedule A — and solidly so: **§163(h)(4)(A)(iii)**
  treats a dwelling unit the taxpayer does **not rent at any time in the year** as a residence
  without any personal-use test. ⚠️ **But only if he itemises**, which is not a given.)_
...
✅ **The rental-income question is ANSWERED — no rental income in 2025** _(2026-08-17)_, so no
Schedule E. 🟠 **What replaces it as the live half is the DISPOSAL question: did he still own the
Minnesota house at 31 December?** — see the 2026-09-21 block.
...
- **A small suspended passive loss** also carries forward (Form 8582, prior-years' unallowed).
  **It is a separate carryforward from the NOL and is trivial in size.**

🔵 **THE 2024 RETURN WAS READ LINE BY LINE ON 2026-09-21, at Lilian's request, to settle what
carries into 2025. 💰 EVERY FIGURE IS IN THE WORKING PAPER —
[`tax-returns/denys-melnyk/2025-form-1040.md`](../../tax-returns/denys-melnyk/2025-form-1040.md)
§2 — and none of them is repeated here, because this file publishes.** What belongs here is what
they mean:

- ✅ **THE CARRYFORWARD IS NOT IN DOUBT, AND AN EARLIER READING OF THIS FILE COULD BE TAKEN THE
  OTHER WAY.** The 2024 return carries its whole NOL into 2025 — **nothing was consumed**, because
  2024's taxable income was already zero before any NOL was applied (Schedule 1 line 8a blank,
  Form 172 Part II empty). 🔑 **The open question is not *whether* it carries. It is whether the
  AMOUNT is right and whether it is even that KIND of carryforward.**
...
- 🔑 **WHAT WOULD SETTLE ALL OF IT:** what he paid for the stock, what he lent the corporation
  **out of his own pocket**, and what distributions he took. **Three facts, and only he or the
  ...
  year-end basis and close the question without relying on his memory.**
...
- **An early retirement distribution in 2024**, with the 10% penalty on part of it (Form 5329,
  partial exception claimed). 🟠 **Partly answered 2026-08-12: no distribution from his IRA in 2025.**
  ⚠️ **That is narrower than the question.** If the 2024 distribution came from a **401(k) or another
  plan**, it has still not been asked about for 2025.
- **He had W-2 wages in 2024, with withholding.** An S-corp shareholder-employee generally must
  take reasonable wages, so a 2025 W-2 was expected. ⚠️ **Asked 2026-08-12 — and the answer is that
  there is none, because he was locked out of the company** (the call block above). So the
  expectation was right and the document is unobtainable through him; **that is the problem, not a
  gap in what he has sent us.** An IRS wage & income transcript would show whether one was ever
  filed under his SSN.
...
materially higher. ✅ **The Midwest question is now settled — Midwest Expedited Corp, 2026-09-21** — so this can be confirmed rather than assumed.)
...
**✅ ANSWER 1 — NO RENTAL INCOME IN 2025.** _(Client, by Google Voice, 2026-08-17, relayed by
Lilian.)_ The Minnesota house produced no rent, so **there is no Schedule E for it.** ⛔ **Do not
re-ask about rent received.**

⚠️ **BUT THIS DOES NOT CLOSE MINNESOTA, AND AN EARLIER VERSION OF THIS BLOCK SAID IT DID.** _(Struck
on review, 2026-09-21, PR #419.)_ Two things were wrong with that:

- ⛔ **The premise was too narrow.** Rental income is not the only Minnesota-source income a
  nonresident can have — **gain on the sale of Minnesota real property is Minnesota-source too.**
  🔗 **And that is a live question on this very house:** the open item below records that a 1098 is
  issued for interest **paid during the year, including the year a loan is paid off**, so the form
  **does not prove he still owned the house at 31 December.** *"No rent"* and *"no Minnesota-source
  income"* are different statements and only the first was answered.
- ⛔ **And closing a state is not this file's call.** Montana was closed by **Lilian's own ruling**,
  quoted. Minnesota would have been closed by a session's inference, in the same vocabulary — which
  is exactly what she ruled out in August: *"no lo definas tú, no lo determines tú."*

✅ **What the answer DOES do is narrow it to one question:** did he still own that house at the end
of 2025, or did he dispose of it? **Answer that and Minnesota resolves either way.**

🟢 **And the rent answer probably helps him on the FEDERAL return, which is the part worth chasing.**
**If** the house was not rented at any point in the year, it can be designated as a **second
qualified residence** under §163(h)(4)(A)(iii) — the provision waives the §280A(d)(1) personal-use
test for a residence not rented at all, though the residence must still be **selected for the year**
and the §163(h)(3) acquisition-debt cap still applies. That would put the 1098 interest on
**Schedule A**. ⚠️ **The real test is NOT the SALT cap, and saying "the cap went up to $40,000 so
itemising is live" does not follow** — for a man whose entire SALT is one property-tax bill, what
matters is whether **interest + property tax + everything else clears the married-filing-jointly
standard deduction.** **Run that arithmetic before telling him anything.**

ⓘ *The reason the rental question ever existed: the 1040 organizer's rental branch is unreachable
once the upstream income answer is "no", so his 100% "complete" organizer never asked him — see the
block above. It took a direct question to get a direct answer.*

**✅ ANSWER 2 — THE 2025 MONEY CAME FROM MIDWEST EXPEDITED CORP.** _(Lilian, 2026-09-21, settling her
own August hedge — recorded on this file as *"something like Midwest Expedited, or something like
that"* — which was open precisely because **two** of
...
becomes a capital gain** (§1368(b)(2)). ⚠️ **And that section presumes NO accumulated E&P** — where
there is AE&P it is **§1368(c)** and the excess over AAA is a **dividend first**, which is a
different tax and a different line. ⛔ **That is a flag for Julia, not a conclusion here** — it
...
— which is how a **sole proprietor** computes net profit. ⚠️ **Whether he is one for 2025 is the
unsettled fork itself** (§4, and the top of this section), so his arithmetic assumes the answer to
the question the return has not yet decided. Sorted by what kills
them:
...
1. ⛔ **DEAD WHATEVER THE FORK DECIDES — these are not deductions on anybody's return.**
   ...
   - **The car loan payment — but only the PRINCIPAL half of it, and this line moved out of "dead"
     on review.** ⛔ **Repaying a loan is not an expense**, so the capital portion of what he listed
     is not a deduction on anybody's return and he listed the **whole payment**, apparently monthly.
     🔵 **The INTEREST is a different matter, and there are now TWO routes to it — neither of which
     this file knew about until 2026-09-21.** _(Caught by the independent review on PR #419; both
     read off irs.gov, not from memory.)_
     - **If there is a Schedule C**, the business-use share of car-loan interest is deductible
       **in addition to the standard mileage rate** — the rate covers depreciation, fuel and
       maintenance, not interest, parking or tolls. ⛔ **The earlier wording here — "only under the
       actual-expense method" — was WRONG and is struck.**
     - 🔵 **And OBBBA created a PERSONAL car-loan interest deduction for 2025–2028**, up to
       **$10,000** a year, **available to non-itemizers as well as itemizers**, reported on the new
       **Schedule 1-A**. ⚠️ **Its conditions are narrow and none of them is established for him:**
       the loan must have been **incurred after 31 December 2024** and be secured by a **first
       lien**; the vehicle's **original use must begin with the taxpayer** (⛔ **a used vehicle does
       not qualify**); **final assembly in the United States**; and it must be bought for
       **PERSONAL use** — ⛔ **which means a truck used in the business does not qualify for THIS
       deduction**, and the two routes are therefore mutually exclusive on any one vehicle. It
       **phases out above $100,000 MAGI ($200,000 joint)**, and he files jointly.
     🔑 **So the question to put is not "is this deductible" but "which vehicle, bought when, new or
     used, and used for what"** — the same four facts the vehicle-sale item below needs. **Ask them
     once, together.** ⚠️ **Do not promise him the $10,000 deduction** — on the facts we hold it is
     unestablished in every one of its conditions.
   - **Rent.** ⛔ Personal living cost (§262). **The only route in is the home office** — a different
     ...
     if there is a Schedule C. ⚠️ **Two of his lines LOOK like the same rent counted once as rent and once as
     home office** — that is this file reading his list, not something he said. **Check it with him.**
...
2. 🔴 **THE CORPORATION'S, NOT HIS — this is Lilian's point, and one line says so in his own words.**
   ...
   their own limits even where they do land**: the **road-trip line bundles fuel, hotels and FOOD** —
   *reading his own wording, not a fact he stated* — and **meals are 50% limited** (a DOT-hours
   driver gets 80%, which is a question about *who was driving*), while the **phone** is
   business-share only. **The line has to be split before any of it can be used.** ⚠️ **The
   fuel paid to drivers is not just an expense question** — it may be the **1099-NEC** obligation
   already flagged in §4. ⓘ **Careful, though: 1099-NEC reports payments for SERVICES, and fuel is
   goods.** Whether these were reimbursements of a driver's fuel, payments for his driving, or the
   company buying diesel is **not established** — and it changes the answer. It also turns on whether
   he or the company paid.
3. 🟠 **HEALTH INSURANCE HAS ITS OWN REGIME AND FAILS THE ORDINARY ONE.** For a **more-than-2%
   ...
   **pay or reimburse the premiums AND include them in his W-2 Box 1**. ⛔ **He has no W-2**, so as
   things stand that route is unavailable — **twice over**, because **§162(l)(2)(A)** caps the
   deduction at earned income from that trade or business, and for a >2% shareholder that earned
   income **is** the W-2 wages — which ties this line to the missing-K-1/W-2 blocker, not
...
these costs personally tells us nothing about **what the sum he was sent legally was**. A trucking corporation
...
- 🔗 **This is not new ground for him:** his **2024** return already carries a **Form 4797 ordinary
  ...
  it was not explained to him in a way that stuck. **Ask for the sale document and the purchase/
...
- _(2026-08-12, Lilian)_ — **Second full review — the first run of the finished companion, end to end.** Read all nine sources including his 2025 organizer answers and his 2024 return **fetched from Double and redacted automatically** (no hand-redaction). It **closed** the file's biggest open item (filing status — answered in the organizer all along), **turned a maybe into a blocker** (Form 1095-A is now the first thing to chase), **retired the states expectation** so 2025 is established from scratch rather than carried forward from 2024, and found in Julia's Gmail that **the P&L Statement template was sent on 2026-08-05 and never returned**. _(Written up under the pre-2026-08-12 rule as pointers rather than facts; rewritten the same day once Lilian reversed it.)_ Fourteen questions delivered to Lilian as a PDF, in Spanish and Russian. §1, §5 and §6 rewritten accordingly.

- _(2026-08-12, Lilian)_ — **The client answered. Lilian spoke to him and brought back the first
  real answers to the fourteen questions**, recorded in §5 under *"What he told Lilian on the call"*.
  What it changed: 🔴 **a new top blocker** — he worked in only ONE of the three companies in 2025
  (**"something like Midwest Expedited" — Lilian's hedge, and he holds two companies whose names
  start that way, so the entity is NOT established**), was **locked out after a dispute with his
  partner**, and therefore holds **no K-1 and no W-2** for income he did receive (**pending: Lilian
  and Julia decide the route**); 🟠 **the 1095-A blocker is now contested**, not confirmed (he named
  **Blue Cross Blue Shield**; Lilian is checking whether it is Marketplace); ✅ **residence largely
  settled** — Kirkland WA until **May 2025**, then Florida, so no resident state return, though
  **Montana's end date is still missing and Illinois rides on the missing K-1**; ✅ **wife had no
  income** (no Schedule C), ✅ **no IRA distribution**, ✅ **no 1099**; 🟠 a **Form 1098** arrived (he
  has an apartment) with a **rental** question still to put to him; ⚠️ his **expenses are incomplete**
  and more are coming; and on the dependants, **neither of the two people he named is the daughter
  his 2024 return claimed** — which is the question, and it had been mis-framed as "who is the first
  person he named" until the independent review caught it. Two items surfaced that nobody had
  raised: **whether a 2025 extension was ever filed** (§4 — and it cannot have been us), and that
  **"received no money" does not release the other two companies from issuing K-1s** (§5).

- _(2026-08-12, Lilian)_ — **She corrected three things from that call, two of them her own wording,
  and one of the corrections reversed a conclusion this file had reached.** ✅ **The children are
  settled:** the first person he named is **the DAUGHTER already claimed in 2024**, not his wife —
  and she had written "dependents" where she meant **children**. So the two are that daughter and
  the **son** who does not live with him; **the wife was never one of them.** The file had reasoned
  its way to the opposite reading and to *"neither of them is the 2024 daughter"* — wrong, and it
  came from taking the words as given rather than asking. **What survives is the useful half:** the
  live question is the daughter's **2025 residence and her age**, not who she is. ⓘ **On Montana,
  her hypothesis** — that it came from a company registered there — **would produce a nonresident
  return, not the resident one our reading of the 2024 return records**; recorded with the caveat
  that the word "resident" came from us and is worth re-checking. ⚠️ **And she relayed that "he is
  no longer part of these companies"** — recorded, with the distinction that matters: **locked out
  is not the same as having disposed of the shares**, and only a disposal in a *prior* year removes
  a 2025 K-1. **She also asked for the working method on the health-coverage question, so it is
...
- _(2026-08-12, Lilian)_ — **She went back to the client on the shareholder question and got a clean
  ...
  **worthlessness branch probably stays available** for the third company — ⚠️ **inferred, not
  confirmed: his answer covered only the other two.** 🛑 **A session then wrote a PASSIVE-SHAREHOLDER conclusion off an offhand remark of hers, into
...
- _(2026-08-12, Lilian)_ — **She corrected the shape of the company problem, struck a conclusion a
  ...
  partner problem — the one he says filed for bankruptcy), and **the other two generated nothing and produced no
...
- **His 2024 return is in Double** — `Tax Return Filed/2024`, and that is the route: read it
  ...
  text), so an absence in that output is not an absence on the return. Most of what it established
  is in the next bullet — check that first; you may not need to open it at all.
...
- **Settled by the second review (2026-08-12), so nobody re-opens them:** his **filing status**
  for 2025 (answered in the organizer — §5), and the **Head-of-Household / §7703(b) theory is
  closed**. ⚠️ **One item from that review was UN-settled the same day:** *"Marketplace coverage is
  confirmed"* — the client then named **Blue Cross Blue Shield**, so it is back to a question (§5).
- **Fourteen questions were put to him on 2026-08-12**, and **he answered most of them the same day**
  (the call, §5). Status of each:
  - ✅ **A 2025 W-2** — none, he is locked out of the company. ✅ **Any 1099** — none. ✅ **Any other
    income** — none; only the one "Midwest" company, in the first months of the year. ✅ **The wife's
  ...
  - ✅ **The children — WHO they are is settled** _(Lilian's correction, 2026-08-12)_: **two
    ...
    not her identity.
  - 🔴 **What the Midwest money was** — **cannot be answered by him**: no K-1, no W-2, no access.
    This is the blocker, and it also leaves **whether he is still a shareholder in all three** and
...
- 2026-09-19 — **Weekend sweep (incremental, baseline 2026-09-12→2026-09-19). 🔴 THE CHASE DATE HAS
  PASSED — the three K-1s were due 2026-09-15 and it is now 2026-09-19, FOUR DAYS OVERDUE, with
  nothing received.** **Both notes re-read in full per the standing rule, not just their metadata:**
  485225 unchanged — `updatedAt` still Mon Aug 17 2026 13:47:21, body identical (his figures, the
  two Google-Voice batches, the Home Office template pointer); 490984 unchanged — `updatedAt` still
  Thu Aug 20 2026 20:34:21, body identical (the K-1 route, the ex-partner's contact, the chase date,
  the fallback routes, the question for Julia). **Neither note has been touched since 2026-08-20 —
  ...
  returned nothing legible specific to this client — same pattern as every prior run. Google Drive:
  a title search for "Melnyk" bounded to `modifiedTime > 2026-09-12` returned **zero files** — still
  no dedicated Drive folder for this client, consistent with every prior sweep. `FOLLOW-UPS.md`/
...
- 2026-09-21 — **Lilian relayed the August Google Voice traffic, and it moved four things at once.**
  ...
  **All dollar figures stay in Double note 485225, where they already are.**
  🔑 **AND THE ENTRY THAT MATTERS MOST HERE IS THIS ONE: THE CLIENT ANSWERED ON 2026-08-17 AND THE
  FILE CARRIED "NOBODY HAS ASKED" FOR FIVE WEEKS.** The 2026-09-19 sweep and the 2026-09-21 gap check
  both swept Double, the file library and Gmail and **could not have found it** — it was a Google
  Voice message on **Lilian's phone**, which is the one source the gap check named as unsearchable.
  ⚠️ **So her phone holds client answers the firm's systems do not, and the REST of that August
  traffic has still not been read.** **That is a standing gap, not a one-off.**

- 2026-09-21 — **The 2024 return was read line by line, at Lilian's request, to settle the NOL.**
  Fetched from Double through the redactor and worked through form by form; **the figures went to
  the new working paper** ([`tax-returns/denys-melnyk/2025-form-1040.md`](../../tax-returns/denys-melnyk/2025-form-1040.md)),
...
- 2026-09-23 — 📧 **AN ACKNOWLEDGEMENT EMAIL WAS DRAFTED FOR THIS CLIENT — not sent.** Lilian asked for
  ...
  **state in writing** the facts the return rests on: that he received **no Form W-2 and that no money
  was run through payroll**, that the funds came from the one corporation and relate to work he
  performed, that he paid the business costs personally and was not reimbursed, that he had **no
  Marketplace health insurance in 2025 and never received a Form 1095-A**, and that there is no other
  income. ⚠️ **It also warns him that an amendment can carry additional tax, interest and penalties from
  ...
  **does not settle the payroll question** *(his answer is a representation, not evidence — a Form W-2
  ...
  ordinary question list. 📌 **Open point: whether to send it in English only or English + Russian** —
  a consent he cannot read closely protects nobody, and **a Russian version under Julia's name is written
  at full native register, not the simplified Russian used for Lilian's own messages.** **The draft and
  the reasoning are in the return's working-paper folder; his reply must be filed in Double.**
...
- 🔴⏰ **THE THREE K-1s — PROMISED 2026-08-20, STILL NOT ARRIVED, AND THE CHASE DATE (2026-09-15) IS
  ...
  and **someone needs to actually chase the ex-partner again, or decide among the fallback routes,
  rather than let the date slide unremarked.** Three things still needed: **(a) chase the ex-partner
  again** — the 2026-09-15 date was the extended 1120-S due date, not a promise of the K-1 itself,
  and ⚠️ **nobody has established that those companies actually extended**, so silence past that
  date is not itself alarming — but it is a reason to ask, not a reason to keep waiting silently
  (§5); **(b) whoever receives them files them in Double and logs it here**; and **(c) check what
  the corporation actually FILED before relying on a K-1 handed over pre-filing** (§5). ⓘ **Waiting
  is not the expensive option** — §5 works the penalty clock through. ⚠️ **The fallback routes stay
...
- 🔴 **HIS EXPENSE LIST CANNOT BE USED AS SENT, on three separate grounds** — and Lilian's own
  ...
  back to Schedule A behind the 7.5% floor (§5). ⚠️ **On at least two lines he APPEARS to be treating a
  monthly figure as an annual one** — read off his own wording, not confirmed with him. **The figures stay in Double note 485225.**
...
- ~~**Is the MINNESOTA house rented out?**~~ — ✅ **ANSWERED: NO RENTAL INCOME IN 2025** _(client, by
  Google Voice, 2026-08-17; relayed by Lilian 2026-09-21)_. **No Schedule E.** **Do not re-ask.**
  🟠 **What it does NOT answer, and what replaces it: DID HE STILL OWN THE HOUSE AT 31 DECEMBER
  2025?** A nonresident is taxed by Minnesota on **gain from selling Minnesota real property**, so
  *no rent* does not mean *no Minnesota return* — and the 1098 does not prove ownership at year-end
  (§5). **Ask it together with the vehicle question; both are disposals.**
...
- **Does Julia want the son's details** — the child he pays support for? Not needed to file him as he
...
- ✅ **His remaining business expenses — MORE ARRIVED 2026-08-13**, by Google Voice, and Lilian
  ...
  whether that is all of them** — and ✅ **the Midwest question IS now settled — Midwest Expedited Corp,
  2026-09-21 — so the cataloguing is unblocked**, and §5's three-way sort of that list is where it
  starts; if that money came out of his own S corp, those expenses are the corporation's (§5).
...
- ~~**His 2025 W-2**~~ · ~~**any 1099**~~ · ~~**an IRA distribution**~~ · ~~**any other
  ...
  on 2026-08-12; do not re-ask** (§5). ✅ **Rent or mortgage is FULLY answered — he pays both**
  (§5). ✅ **The rental half is ANSWERED — no rental income in 2025** _(2026-08-17)_; what remains from it is **whether he still OWNED the Minnesota house at year-end**, listed above.
  ⚠️ **One item is only PARTLY answered and stays on the list above:** **retirement** — he was asked
  about an **IRA**, not about a 401(k) or another plan, and his 2024 distribution may have been one. The W-2 answer
...
- **The P&L Statement template — asked for and never returned.** Lilian emailed him two templates
  on **2026-08-05**; he sent back the Home Office one the same evening and **not the P&L**. The
  figures from his text message are the working substitute, but they are not a completed template.
  _(Found in Julia's Gmail on 2026-08-12 — it appears nowhere else.)_
...
- [ ] ⚠️ **RE-OPENED 2026-08-12** — whether the health coverage is **Marketplace**, asked as *where
  ...
  the year (§5 holds the method). The organizer
  ...
  exchange plan bought with no advance credit equally well, and **the second still produces a
  1095-A** (§5). ⛔ **An earlier version of this row said such a plan "still needs Form 8962". That
  is WRONG and is struck** _(review, 2026-09-21)_: Form 8962 is required where **APTC was paid**, or
  where the taxpayer **claims** the credit. 🟢 **Which inverts the finding — an unsubsidised exchange
  plan is not a blocker but a possible CREDIT**, worth computing rather than fearing.
...
- [ ] The **chapter, petition date, entity and trustee** of the bankruptcy — from the docket, not
  from him (§5).
- [ ] **Whether there is a bankruptcy at all**, and if so the **chapter, petition date, entity and trustee** — and whether it is the **COMPANY** or the **partner personally**. ⚠️ The claim is the client's and Lilian does not treat it as reliable; the
...
- [x] Whether the **MINNESOTA house** is rented out — ✅ **NO RENTAL INCOME IN 2025** _(client, by
  Google Voice, 2026-08-17; relayed by Lilian 2026-09-21)_. **No Schedule E.** _(The "does he also
  rent" half was already answered: yes, he rents where he lives.)_
- [ ] 🟠 **Whether he still OWNED the Minnesota house at 31 December 2025** — this, not the rent
  question, is what decides a Minnesota nonresident return, because gain on selling Minnesota real
