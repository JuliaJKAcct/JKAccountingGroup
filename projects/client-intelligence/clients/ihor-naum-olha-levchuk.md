...
- Ask the client to raise the possible duplicate from the two 2026-05-06 transmissions — STILL OPEN (a client-side action, not a searchable arrival), ~136 days pending since the transmissions, no deadline. A targeted Gmail search bounded `after:2026/09/12` found nothing new.
...
- Confirm a **Form 2848 for Ihor Naum as an individual** is on file — STILL OPEN/UNCONFIRMED; a targeted Gmail search bounded `after:2026/09/12` found nothing relevant.
