...
- 🟠 **NEW 2026-09-12 — the "Pay FPL bill" task has been overdue since 2026-09-05, still showing overdue in the firm's own Double Task Digest as of 2026-09-11 (~7 days).** This is the electric utility, not the water bill (which is on autopay and needs no action). Confirm whether it is genuinely unpaid or the task simply wasn't marked done.
