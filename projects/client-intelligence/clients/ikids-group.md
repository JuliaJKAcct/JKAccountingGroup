...
- 🟠 **STILL OVERDUE as of 2026-09-19 — the "Pay FPL bill" task, now ~14 days overdue (due 2026-09-05), confirmed still showing in the firm's own Double Task Digest through at least 2026-09-18** (Gmail, `noreply@doublehq.com`, daily digests 09-14 through 09-18, each still naming this task). This is the electric utility, not the water bill (which is on autopay and needs no action). **Confirm whether it is genuinely unpaid or the task simply was never marked done** — now two sweeps running.
