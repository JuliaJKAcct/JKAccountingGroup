...
- **Both nonresident members' ITIN applications** — W-7 packages went out by certified mail in
  **May 2026** via the outside CAA. STILL OPEN, **~4 months** pending. Confirm the ITINs were actually issued; a search of Gmail bounded `after:2026/08/29`, on 2026-09-12, again found nothing.
- 🔴 **STILL OVERDUE as of 2026-09-26 — the "Pay FPL bill" task, now ~21 days overdue (due 2026-09-05), confirmed via `list_tasks`: status `notStarted`, priority, assigned to Lilian**, and still showing in the firm's own Double Task Digest daily through at least 2026-09-25 (Gmail, `noreply@doublehq.com`). This is the electric utility, not the water bill (which is on autopay and needs no action). ✅ **This is now corroborated as a genuine non-payment, not just a task-hygiene miss:** the firm's own recurring-expense monitor (2026-09-20, mid-month check) found **FPL (electric) has not appeared in the ledger at all this period — not in July, August, or September.** Three straight months with no FPL payment in the books, on a task that has sat `notStarted` since its due date. **Confirm with the client/site contact whether FPL is being paid by some other route (e.g. directly by the site, bypassing the firm) or is genuinely unpaid** — three months unpaid on an active utility account risks disconnection during a construction build-out. _(Double `list_tasks`, `list_client_properties`; Gmail Double Task Digests 09-19→09-25; firm's recurring-expense-monitor email 2026-09-20.)_
- ⓘ **NEW 2026-09-01 (recurring-expense review): a City of Fort Lauderdale charge posted in July, coded differently from the regular water-bill payment and well outside the normal range, is still unexplained as of the August check.** No dollar figures recorded here — see the monitor email/watchlist. Worth resolving before it recurs.
- ⓘ **NEW 2026-09-12 — an "IKIDS MEP Equipment Material Deposit Invoice" (2026-09-07) and a "Rest Invest Kyiv" kitchen-equipment invoice, partially paid (2026-09-04), appeared in Drive.** Both plausibly tie to the venue build-out and are capitalization candidates; content not opened. The Rest Invest Kyiv one is worth a specific check — Rest Invest Kids LLC is this owner group's other related entity, so confirm which entity should actually carry that cost before it's booked.
- 🟡 **UPDATED 2026-09-26 — the KATCO Insurance thread continued through 2026-09-24, still not settled.** The **builder's-risk policy is CONFIRMED current and paid in full, good through 2026-12-03** (KATCO, 2026-09-24, sent as a formal policy confirmation). The **workers'-compensation / requote conversation is still open and got briefly confused**: the site contact (Denys Rudovol) asked KATCO on 2026-09-24 to line up insurance ahead of construction starting and to requote "on the same basis as last year" (last year's gross-sales and payroll figures, not restated because it's still too early); KATCO's Katerina Moskaleva initially replied asking **"which park are you referring to? Is it the one from last year or is this a brand new project?"** — a mix-up that reads as KATCO not clearly tracking that this is the same iKidsPark entity from a prior quote, now moving toward opening. **No workers'-comp quote or bind confirmed as of this sweep.** No dollar figures recorded here. Still worth flagging to whoever tracks the "operations begin"/hiring-ramp timeline (§5) — WC coverage needs to be in place before the ~35–70-person opening staffing ramp, and this thread shows it is not yet in place with ~2 months to the target opening window. _(Gmail, KATCO Insurance thread, 2026-09-14 through 2026-09-24.)_
- ⓘ **NEW 2026-09-19 — two related PDF documents for the same Rest Invest Kyiv kitchen-equipment invoice appeared in Drive (created 2026-09-14), confirming the partial-payment split already flagged 2026-09-12** — one records a payment received, the other the remaining balance owed. Content/amounts not opened beyond the filenames; still unconfirmed which entity (iKids Group vs. Rest Invest Kids LLC) should carry the cost.
...
- **Confirm the identity of the new no-portal-access contact** registered 2026-08-10 (a
  "contractor" role in Double) — Double contacts now name him **Sergey Yalansky** (2026-08-22), who attended the 2026-08-13 engagement-scoping meeting. STILL unconfirmed whether this is the CFO already documented in §2, or a separate operational contact. ⓘ **New data point, not a resolution (2026-09-01):** Sergey accepted an invitation as a **QuickBooks Accountant** user on the client's QBO — shows he has a real operational role, but does not by itself settle whether he is the CFO or someone else.
...
- 2026-09-12 — **Incremental sweep (baseline 2026-08-29→2026-09-12).** Double: `list_client_properties` unchanged (10 properties, same values); `list_notes` unchanged (still the single 2026-08-13 meeting note); `list_activity_log` (from 2026-08-29) shows only a task-name/description edit on 2026-09-02 (the "Pay FPL bill" task, by Lilian) — **that task is showing as due/overdue in the firm's Double Task Digest emails every day from 2026-09-01 through at least 2026-09-11**, which reads as the FPL electric bill sitting unpaid past its due date (Sep 05) — folded into outstanding items below; this is distinct from the water bill, which is on autopay and needs no action. Gmail (business names + Balasiuk/Matiukha/Yalansky, after:2026/08/29) surfaced: (a) **Sergey accepted an invitation as QuickBooks Accountant user on the client's QBO** (2026-09-01) — a data point on the still-open "confirm Sergey Yalansky's role" question, not a resolution of it; (b) the hands-on-AP permit-expediting vendor's latest invoice was issued (2026-09-02) and its payment confirmed (2026-09-09) — routine, vendor not named per the 2026-08-14 redaction; (c) two City of Fort Lauderdale LauderBuild permit-fee payments processed 2026-09-09 — continuing the established permit-payment process, no new fact; (d) routine Double Task Digest and Gusto-adjacent noise, already reflected above. Google Drive (`fullText contains 'iKids'`, `modifiedTime > 2026-08-29`, `excludeContentSnippets: true`) surfaced: the shared credentials document (`iKids-Password`) was edited 2026-09-09 (content not opened); a new **"IKIDS MEP Equipment Material Deposit Invoice"** PDF (2026-09-07) — plausibly HVAC/mechanical-electrical-plumbing equipment for the build-out, a capitalization candidate, content not opened; and an invoice from **"Rest Invest Kyiv"** for kitchen equipment, partially paid (2026-09-04, no figures recorded here) — worth noting because Rest Invest Kids LLC is this owner group's other related entity, so confirm which entity should actually carry this kitchen-equipment cost before it is booked. The firm's own **recurring-expense review (2026-09-01, covering August)** flagged this client for attention: a City of Fort Lauderdale charge coded differently from the usual water-bill payment posted in July, well outside the normal range and still unexplained as of the August check (no figures recorded here — see the monitor email/watchlist). Ping and a client-scoped Double `get_questions` pull were not separately re-run this window (budget; the org-wide Ping note from 2026-08-13/27 already covers this period's only substantive Double note). **Chase pass:** the 1065-extension question, both ITIN applications, and the third member's US tax status — searched via Gmail (`after:2026/08/29`, ITIN/W-7/7004/extension terms) — STILL OPEN, nothing found; the Manager's loan-allocation question (asked via WhatsApp 2026-08-27) — STILL OPEN, **~16 days** pending, no reply found in Gmail or Double notes; the KaTom credit-application document (found 2026-08-28) — not re-chased this run (budget), still unconfirmed; the W-9 sweep and the five decisions waiting on Julia — **not chased this run** (budget).
...
- 2026-09-19 — **Incremental sweep (baseline 2026-09-12→2026-09-19; Ping NOT searched, per standing note that its index predates this client's Jun–Jul 2025 calls).** Double: `list_client_properties` unchanged (10 properties); `list_notes` unchanged (still the single 2026-08-13 meeting note); `list_activity_log` (from 2026-09-12) returned **zero entries**; `list_projects` re-confirms the "2025 Taxes" project is still `notStarted` with `filedAt: null`. Gmail (business names + Balasiuk/Matiukha/Yalansky/ikidsllc, after:2026/09/12) surfaced: (a) the **"Pay FPL bill" task confirmed still overdue** through the 09-14→09-18 Double Task Digests (folded into outstanding items above); (b) **East of Collins Expediting's INV-39178 payment confirmed 2026-09-17** (routine, continuing the established permit-expediting process, no figures recorded); (c) a **new insurance-quote thread with KATCO Insurance** (2026-09-14, folded into outstanding items above); (d) nothing on the Manager's loan-allocation question, the 1065 extension, the ITIN applications, or the third member's tax status — a second targeted Gmail search (loan/agreement/wire/W-7/ITIN/7004/extension terms, after:2026/09/12) also found nothing. Google Drive (`fullText contains 'iKids'`, `modifiedTime > 2026-09-12`, `excludeContentSnippets: true`) surfaced: the East of Collins invoice PDF and payment confirmation, a generic "Invoice.pdf" (2026-09-15, content not opened), a water-bill document (2026-09-17, routine AP retrieval per §4, amount not recorded here), and two Rest Invest Kyiv PDFs (2026-09-14, folded into outstanding items above). **Chase pass:** the Manager's loan-allocation question (asked via WhatsApp 2026-08-27) — STILL OPEN, **~23 days** pending, no reply found in Gmail or Double notes; the 1065-extension question, both ITIN applications, and the third member's US tax status — STILL OPEN, nothing found; the KaTom credit-application document — not re-chased this run (budget); the W-9 sweep and the five decisions waiting on Julia — not chased this run (budget).

- 2026-09-26 — **Incremental sweep (baseline 2026-09-19→2026-09-26; Ping not searched, per standing note — org-wide search still returned no legible on-topic hits when tried).** Double: `list_client_properties` unchanged (10 properties, including `Organizer Status: N/A (we have QBO access)`); `list_notes` unchanged (still the single 2026-08-13 meeting note); `list_activity_log` (from 2026-09-19) returned **zero entries**; `list_projects` re-confirms the "2025 Taxes" project is still `notStarted` with `filedAt: null` — the 1065-extension question remains genuinely unconfirmed either way; `list_tasks` (filtered "FPL") confirms the "Pay FPL bill" task is still `notStarted`, due 2026-09-05, priority — folded into outstanding items above; `get_questions` (open, clientId 706689) returned **zero open questions** for this client. Gmail (business names + Balasiuk/Matiukha/Yalansky/ikidsllc, after:2026/09/19) surfaced: (a) the KATCO Insurance thread's continuation through 2026-09-24 (folded into outstanding items above); (b) East of Collins Expediting's new invoice INV-39328, issued 2026-09-24 for the site's permit-expediting work — routine, continuing the established process, no figures recorded; (c) the firm's own recurring-expense-monitor email (2026-09-20, read in full) naming **two new possible recurring charges** — a payment to **Maryna Supanta** (three consecutive months, same amount each time) and a payment to **Denys Rudovol** (two consecutive months, not seen in July) — both plausibly tied to the staffing/consulting relationships named in the 2026-08-13 engagement-scoping meeting note, worth confirming and adding to the watchlist if recurring; and the FPL non-payment finding (folded into outstanding items above); (d) nothing on the Manager's loan-allocation question, the 1065 extension, either ITIN application, or the third member's tax status — a targeted second search (loan/agreement/wire/W-7/ITIN/7004/extension terms, after:2026/09/19) also found nothing. Google Drive (`fullText contains 'iKids'`, `modifiedTime > 2026-09-19`, `excludeContentSnippets: true`) surfaced: the East of Collins invoice PDF (2026-09-25), and a **new furniture-purchase invoice from Atlantic Express Corp** (2026-09-22, content not opened beyond the filename) — plausibly a build-out furnishing cost and a capitalization candidate (Fixed Assets or CIP, per the five-bucket framework in §5), not yet confirmed or booked. **Chase pass (client's own outstanding items, in full):** the Manager's loan-allocation question (asked via WhatsApp 2026-08-27) — STILL OPEN, **~30 days** pending, no reply found; the 1065-extension question — STILL OPEN, nothing found, Double's own project record still shows no extension filed; both ITIN applications — STILL OPEN, ~4.5 months pending, nothing found; the third member's US tax status — STILL OPEN, no lead beyond the existing capital-contribution-account lead; the KaTom credit-application document (2026-08-28) — **not re-chased this run** (budget); the W-9 sweep and the five decisions waiting on Julia — **not chased this run** (budget); fiscal year-end, the credentials Drive link, and "which other vendors are on autopay" — **not chased this run** (budget; none carries a deadline).
