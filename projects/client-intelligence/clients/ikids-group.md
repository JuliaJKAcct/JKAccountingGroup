...
- ⓘ **NEW 2026-09-19 — the venue is actively shopping insurance ahead of opening, and one coverage gap surfaced.** A Gmail thread with **KATCO Insurance** ("IKIDS, GROUP Insurances Quote," 2026-09-14) shows Julia working through quotes for the policies the venue will need once it opens to the public — a builder's-risk policy currently in force (KATCO confirmed it is not subject to audit), and a **workers'-compensation policy the company did NOT carry this past year** (KATCO: "you did not have it this past year"). Julia asked a payroll-threshold pricing question, unanswered in the thread as read. No dollar figures recorded here. Worth flagging to whoever tracks the "operations begin"/hiring-ramp timeline (§5) — WC coverage needs to be in place before the ~35–70-person opening staffing ramp.
