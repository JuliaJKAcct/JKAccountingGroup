...
- 🟢 **The §199A worksheet with QBI and W-2 wages belongs to the 2025 return, not 2024** _(established 2026-09-05 by Lilian; confirmed against the filed 2025 return, whose ordinary-income line matches the worksheet)_. ⛔ **It could not have been the 2024 one, because a Form 1120 has no §199A at all.**
- 🔑 **2025 IS an 1120-S** _(read 2026-09-05)_ — so the entity filed as a C corporation for 2024 and as an S corporation for 2025, while the IRS's own record still shows no Form 2553. ⚠️ **That tension is unresolved and is the same §1 issue, now with a second year attached to it.**
- ✅ **2025 also ran NO payroll** — page 1 line 8 is blank, and the officer-compensation line carries the owner's pay, exactly as in 2024. ⚠️ **The §199A W-2 wages figure on the 2025 K-1 does NOT equal that officer-compensation line**; Lilian's explanation is that a >2% shareholder's health-insurance premiums are added to compensation. **Worth confirming before that return goes out.**
...
- 2026-09-01 — **Recurring-expense review (August 2026) flagged this client for attention** — the Comcast/Xfinity pattern above (now three months running) and a new Florida Blue question. Folded into §6 outstanding items; no dollar figures recorded here. _(Firm's recurring-expense-monitor email, 2026-09-01.)_
...
- 🟠 **Comcast/Xfinity charge — now a THREE-MONTH pattern, not a one-off.** The end-of-month recurring-expense review (2026-09-01, covering August) confirms the charge has been elevated for three consecutive months (June → July → August, each higher than the last) and reads as a rate or plan change rather than an anomaly. STILL OPEN, **~2 months** pending since first flagged (mid-July), no deadline — needs confirming with the client and, if it's the new normal, the watchlist's typical amount updated. _(Firm's recurring-expense-monitor email, 2026-09-01; no dollar figures recorded here — see the email/watchlist for amounts.)_
- ⓘ **NEW 2026-09-01 (recurring-expense review): a second, larger Florida Blue charge posted twice in July but not at all in August** — separate from the regular monthly premium already on the watchlist. Worth confirming with the client whether that larger policy is still active. Not yet chased beyond the monitor's own flag.
...
- 2026-09-12 — **Incremental sweep (baseline 2026-08-29→2026-09-12).** Double: `list_client_properties` unchanged (11 properties, same values as prior sweeps — Sales Tax remains Quarterly, Organizer Status Completed); `list_notes` — both notes (491846, 471126) re-read in full, **neither has moved since 2026-08-13/2026-07-20**; `list_activity_log` (from 2026-08-29) returned **zero entries** — no bank-feed, reconciliation-task, or portal-question activity this window. Gmail (business name + "Pallisso", after:2026/08/29) surfaced only routine Gusto AutoPilot payroll notices (Aug 17–30 pay period, confirmed/paid 2026-09-01/02), the firm's own recurring-expense-check email (2026-09-01, read in full — see §5/§6), and the firm's automated weekly CI-sweep digest — nothing else client-specific. Google Drive (`fullText contains 'Masciave'`, `modifiedTime > 2026-08-29`, `excludeContentSnippets: true`) surfaced one new file, `08.2026.pdf` (created 2026-09-01 by Julia) — plausibly an August bank statement or close document, parent folder not confirmed as the client's vault, content not opened; not asserted as a fact pending confirmation. Ping (org-wide, "Masciave Design Studio Pallisso EIN S-election IRS Form 2553 sales tax county Comcast") returned no legible, on-topic hits — all results are noise from unrelated clients' meetings. **Chase pass:** the EIN/no-Form-2553 case (note 491846) — STILL OPEN, no movement since 2026-01-14/2026-08-13, checked again via the note re-read and the Gmail/Ping searches above; the Comcast item — see §5, now better evidenced via the recurring-expense review rather than newly resolved; the Florida Blue question — not independently chased beyond the monitor's flag (budget); the Double bank-feed-support-ticket resolution and the exact FL sales-tax county/registration — **not chased this run** (budget; no registry-lookup tool available for the latter).

- 2026-09-19 — **Incremental sweep (baseline 2026-09-12→2026-09-19).** Double: `list_client_properties` unchanged (11 properties, same values); `list_notes` — both notes re-read in full, **neither has moved since 2026-08-13/2026-07-20**; `list_activity_log` (from 2026-09-12) shows **nine `ClientPortalPost` "Transaction question resolved" events, all on 2026-09-17 between 15:25 and 15:46, all by Lilian** — a batch resolution of aged transaction questions, consistent with the client's ongoing bookkeeping cadence; the individual questions were not pulled this run (budget). Gmail (business name + "Pallisso", after:2026/09/12) surfaced only routine Gusto AutoPilot payroll notices (Aug 31–Sep 13 pay period, confirmed/scheduled 2026-09-14/15) and the firm's own weekly CI-sweep digest — nothing else client-specific; no update on the EIN/S-election case, Comcast/Xfinity, or Florida Blue. Google Drive (`fullText contains 'Masciave'`, `modifiedTime > 2026-09-12`, `excludeContentSnippets: true`) returned only the firm's internal "My hours" spreadsheet — no client-specific document. Ping (org-wide, "Masciave Design Studio Pallisso EIN S-election IRS Form 2553 sales tax county Comcast Florida Blue") returned no legible, on-topic hits — all results are noise from unrelated clients' meetings. **Chase pass:** the EIN/no-Form-2553 case (note 491846) — STILL OPEN, no movement since 2026-01-14/2026-08-13; the Comcast/Xfinity three-month pattern and the second Florida Blue charge — not independently re-chased this run (budget; no dedicated recurring-expense-monitor email found in this window); the Double bank-feed-support-ticket resolution and the exact FL sales-tax county/registration — not chased (budget; no registry-lookup tool available for the latter).
