...
- 🔴 **Settle the health-coverage contradiction** between the migrated TaxDome note and native Double note 447824 (see §5) before asking him for anything else. STILL OPEN — pending since 2026-08-22 (~28 days as of 2026-09-19); no deadline. Note 447824 re-verified (not resolved) again 2026-09-19, no change.
- 🔴 **Establish where he is tax-resident now, and whether the firm still files for him at all.** He has been out of the US since 2025-05-31 (pending 480+ days on that fact alone; as a tracked item, open since 2026-08-13, ~37 days as of 2026-09-19). No deadline. A 2026-09-19 unbounded Gmail search for Spain/residency terms found nothing new.
- **Check the IRS account for 2025 estimated payments** rather than asking him again — STILL OPEN, pending since 2026-08-13 (~37 days as of 2026-09-19); no source reachable by this session can check an IRS account directly, so this stays a firm-side action item, not something a search can close.
- **Get a current photo ID** — the licence on file expired in 2025. STILL OPEN, pending since 2026-08-13 (~37 days as of 2026-09-19); not something a document search can resolve — needs to be asked of the client directly.
