...
- ⚠️ **NEW, unverified 2026-08-29 — possible Sunbiz Annual Report delinquency.** A third-party filing-service marketing email (`fl@e.myfilingservices.com`, 2026-08-28) states the 2026 Annual Report (EID P26000000628) is past due since May 1. **Contradicts** Double's `Annual report: Yes — we handle it`. No corroboration found in Double, Gmail (firm's own sent mail), or Drive. **Recommend a direct Sunbiz lookup** (no registry-lookup tool available to this session) before treating this as real — these solicitation emails are commonly sent regardless of actual status.
...
- **Retirement plan** — proposals were presented (Feb 2026) by an external TPA. STILL OPEN, **~7 months** pending, no deadline. A search of Gmail bounded `after:2026/08/22`, on 2026-08-29, for TPA/retirement-plan/401k terms found only threads about the **firm's own** 401(k) plan (Human Interest) — nothing specific to this client's decision.
- **Mellanni invoice format** — the customer asked (Jun 2026) that invoices be reissued with proper vendor info + service names. STILL OPEN, **~2.5 months** pending, no deadline. A search of Gmail bounded `after:2026/08/22`, on 2026-08-29, for "Mellanni" found nothing.
