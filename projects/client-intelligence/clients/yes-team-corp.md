...
| Owner's credit card ending `9575` (`I. POLUYKO`) — **connected feed** | A card in the owner's NAME that the **company pays** from the operating account. Its feed posts into QuickBooks and is categorised line by line | n/a | 🔴 **Not the card the expense reports come from** — see §4 *Personal-card expense reimbursement*, *two cards*. **Its personal lines go to `Distributions`.** |
...
- 🛑 **AND THE 1120-S PREPARER MUST BE TOLD ABOUT THE SECOND CARD TOO: it feeds `Distributions` month after month.** Those drive **Schedule M-2 / AAA** and the **shareholder's basis**, and they are the input to **Julia's contributions-vs-distributions netting policy** ([`form-1120s-preparation.md`](../../sops/form-1120s-preparation.md) §5C-v) — whose own test **cannot be applied to a net figure**, so the gross distributions have to be visible. ⚠️ **A personal charge on this card is a distribution the moment it is categorised**, with no separate decision anywhere, which is exactly how it gets missed at year end. *(Pairs with the reasonable-compensation watch in §5.)*
...
- 🧾 **The quarterly entry, and only ONE of the two is ours to make** _(read off the Q2 pair, 2026-09-16)_:
  ...
  - ✅ **Before posting, `Used personal card` should be back at zero** from the previous period. If it is not, stop — either the last payment was never booked or something is booked twice.
  - ⚠️ **CHECK THE PERIOD BOUNDARY AGAINST THE PREVIOUS ENTRY'S MEMO, not against the previous report.** Q2's memo reads `1-Reimbursement 01-06` and the entry is dated **06/30**, while the export now in hand **starts 06/19** — so on the memo's face, 06/19–06/30 sits inside a period already claimed. ✅ **In fact there is no overlap: the Q2 report's last transaction is 06/18**, so nothing was paid twice. 🔑 **But the memo is what the next person reads**, and a loose period label is how a double payment happens: **make the new memo state the real span**, and check transaction dates, not labels.
  - ⓘ **The cadence is looser than "quarterly": the first entry covered six months and this one covers about two and a half.** The §4 heading and the payroll note both say quarterly; the entries say *whenever the owner sends the export*. **Do not derive a period from the calendar — derive it from where the last report actually ended.**
...
- 🔴 **The owner's card `9575` is part of this close, and its categorisation rules live in §4 *Personal-card expense reimbursement* (two cards).** The short form: the **company pays it**, so its business lines are ordinary expenses with **no reimbursement**, and **its personal lines go to `Distributions`** — never to the reimbursement route. ⚠️ **Closing this card's month is a PREREQUISITE of the quarterly reimbursement entry**, because a charge categorised late can duplicate a line on the other card's report.
...
- 2026-09-19 — **Incremental sweep (baseline 2026-09-12→2026-09-19).** Double: `list_client_properties` unchanged (10 properties); `list_notes` still empty; `list_activity_log` (from 2026-09-12) returned **zero entries**. Gmail (business name + "Poluyko"/"Mellanni"/"Alirm", after:2026/09/12) surfaced the Gusto off-cycle-payroll confirmation above (folded into outstanding items) and a routine Gusto AutoPilot payroll-run notice — nothing else. A second targeted Gmail search (Sunbiz/annual report/Mellanni/retirement-plan/401k terms, after:2026/09/12) found nothing beyond the firm's own 2026-09-12 CI-sweep digest. Google Drive (`fullText contains 'Yes Team'`, `modifiedTime > 2026-09-12`, `excludeContentSnippets: true`) surfaced the two personal-card-expense workbooks (folded into outstanding items above) plus unrelated noise (a laundry-portfolio DD binder, an hours spreadsheet, a Prime Road Carriers driver list). Ping (org-wide, "Yes Team Corp Poluyko marketing retirement plan Mellanni Sunbiz annual report personal card reimbursement") returned no legible, on-topic hits. **Chase pass, all outstanding items:** the personal-card reimbursement block — see above, partial movement, not resolved; the Sunbiz Annual Report delinquency lead — STILL UNVERIFIED, no corroboration found, no registry-lookup tool available; the retirement plan — STILL OPEN, **~8 months** pending, nothing found; the Mellanni invoice-format item — STILL OPEN, **~3.5 months** pending, nothing found.
- 2026-09-26 — **Incremental sweep (baseline 2026-09-19→2026-09-26), specific chase on whether the blocked personal-card reimbursement can now be confirmed resolved.** Double: `list_client_properties` unchanged (10 properties); `list_notes` still empty; `list_activity_log` bounded ≥2026-09-19 returned **zero entries** — no further payroll/off-cycle activity logged in Double itself since the 2026-09-16 run. Gmail: `from:igorpoluyko@gmail.com`, bounded ≥2026-09-19, found **no messages at all** — no purpose answers, no confirmation. A broad Gusto/reimbursement sweep (`after:2026/09/19`, unscoped — run to catch anything client-specific) returned over 200 Gusto notifications this week, **none of them naming Yes Team Corp**; every hit was another client's payroll run (Candramas, Margate Plumbing, Cedar Rock Farms, Deep Tech, Le Delice, Kolo Florida, OneTwo Strategies, Airtouch, AXDIGITAL, JK Accounting Group's own payroll, Prime Road Carriers, Zetech, Setatech, Fly Plumbing). A second search for "Yes Team"/"Poluyko"/"Mellanni"/"Alirm", bounded ≥2026-09-19, found only the firm's own automated digest. Google Drive (`fullText contains 'Igor Poluyko'`, `modifiedTime > 2026-09-19`) returned two unrelated files (a business-formation intake spreadsheet, Lilian's own hours sheet) — neither concerns this client's reimbursement; the personal-card workbook from 2026-09-16 has not been touched again. Ping (org-wide, "Yes Team Corp personal card reimbursement Mellanni Sunbiz") returned no legible, on-topic hits dated on/after 2026-09-19. 🔴 **Answer to the specific question asked this run: NOT CONFIRMED RESOLVED.** No source reachable from this sweep shows whether Igor supplied the business-purpose answers the 06/20–08/31/2026 claim needs, or whether the 2026-09-16 off-cycle run covered the full claim or only the lines the firm could already settle without his answer (§4's exclusions). **Nothing found this week either closes it or reopens it — the same evidentiary gap the 2026-09-19 entry already flagged persists one week on.** Since the answer likely arrived (if at all) by phone or WhatsApp, outside Gmail/Ping's reach, **recommend Lilian confirm directly rather than waiting on another sweep to find it.** **Chase pass, remaining outstanding items:** the Sunbiz Annual Report delinquency lead — STILL UNVERIFIED, **29 days** pending since 2026-08-28, no corroboration found (a broad Sunbiz/Annual-Report search this week surfaced only two OTHER clients' unrelated filing matters — Airtouch Florida LLC's dissolution notices and M5 Studio Miami's address change — neither concerning this client), no registry-lookup tool available; the retirement plan — STILL OPEN, **~8 months** pending, nothing found; the Mellanni invoice-format item — STILL OPEN, **~3.5 months** pending, nothing found; card `9575`'s August-month closure and the Julia meals-account decision — **not chased this run (budget)**, both need a direct answer/action rather than a document search.

### Outstanding items (CI-only — never in the SOP)
- 2026-09-16 (second session, same day) — **Read the Q2 reimbursement entry in order to prepare this period's, and the ledger answered two questions nobody had asked.** Pulled the `Used personal card` account's whole 2026 activity through Double (`get_transactions`) and the Gusto-labelled entries alongside it. **Found the expense-side entry and its payment-side pair**, and recorded the convention in §4. **Also found the owner's SECOND card (`9575`) and that it is treated in the opposite way** — company-paid, feed connected, personal lines to `Distributions` — which is now in §3 and §4. **Duplicate check across the two cards for 06/20–08/31/2026: same merchants, different days and amounts, no duplicates**; ⚠️ *that read showed no activity on `9575` after early August, so it is a check to repeat once that card's month is closed, not a settled answer.* Separately, a merchant the client's export left unlabelled and that a web search could not identify **was already booked in this client's own ledger** with a vendor record and a memo saying what it was — the research lesson is now in the [skill](../../../.claude/skills/personal-card-reimbursement/) §2. Lilian returned her own categorisations the same day; the review of them went to her directly, with the figures. No figures or payee names in this file.
- 🔴 **OPEN since 2026-09-16 — the 06/20–08/31/2026 personal-card reimbursement is BLOCKED on the owner.** He has to state the business purpose of the summer travel before the bulk of the claim can be booked or paid; the firm has settled only the lines that need no purpose (§4). **Waiting on:** Igor, question list grouped by trip leg. ⚠️ **And a SECOND prerequisite that is ours, not his: card `9575`'s month must be closed before the entry is posted** (§3, §4) — a charge categorised late there can duplicate a line on this report. **Until he answers there is no reimbursement figure for the period** — and a number produced without his answer would not be an accountable-plan reimbursement, it would be wages. ⓘ **Also worth putting to him once:** the Q2 file carried his purpose label on every line and this one did not, so asking him to keep labelling the export closes this permanently instead of quarterly.
  - 🟢 **2026-09-19 — something moved on 2026-09-16, and it is not yet clear how much of the block it clears.** An off-cycle Gusto payroll run described by Gusto as **"for reimbursements"** debited Yes Team Corp's account 2026-09-16, employees paid 2026-09-18 (Gmail, `gustonoreply@gusto.com`, 2026-09-16 — no dollar figure recorded here per the two-data-homes rule). Google Drive corroborates: a new file **"Yes Team Expenses on Personal Card - from 06 to 08-2026.xlsx"** was created 2026-09-16 in the same Drive folder as the Q2 workbook, its date range matching the blocked period exactly. ⚠️ **No Gmail or Ping evidence was found that Igor actually supplied the business-purpose answers this block requires** — the off-cycle run may cover only the lines the firm could already settle without his answer (§4's exclusions), or the full claim if he answered by phone/WhatsApp, outside Gmail's reach. **Recommend confirming with Lilian directly** whether his purpose answers arrived and whether the payment reflects the full claim or only the no-purpose-needed lines.
  - 🔴 **STILL NOT CONFIRMED AS OF 2026-09-26 — a full week's targeted search found nothing either way.** No email from Igor, no further Double/Ping activity, no further Drive file. The gap flagged 2026-09-19 is unchanged one week later. **This needs a direct answer from Lilian, not another sweep** — see the 2026-09-26 log entry.
- ⚠️ **Unverified since 2026-08-29 — possible Sunbiz Annual Report delinquency.** A third-party filing-service marketing email (`fl@e.myfilingservices.com`, 2026-08-28) states the 2026 Annual Report (EID P26000000628) is past due since May 1. **Contradicts** Double's `Annual report: Yes — we handle it`. STILL OPEN, **29 days** pending as of 2026-09-26, no deadline beyond the claimed May 1 date. No corroboration found in Double, Gmail, or Drive across five sweeps (2026-08-29 through 2026-09-26) — this week's broad Sunbiz/Annual-Report search surfaced only two OTHER clients' unrelated matters (Airtouch Florida LLC, M5 Studio Miami), nothing for this client. **Recommend a direct Sunbiz lookup** (no registry-lookup tool available to this session) before treating this as real — these solicitation emails are commonly sent regardless of actual status.
...
- [ ] **Close card `9575`'s August month before posting the reimbursement entry** — prerequisite, see §4. The duplicate check run on 2026-09-16 could not see past early August.
