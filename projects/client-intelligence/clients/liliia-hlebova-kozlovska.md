...
> ⚠️ **The 2025 return was FILED 2026-08-20 (§4/§6) while most items below still read as open in this file's own record.** Neither the 2026-09-12 nor the 2026-09-19 sweep found, in Double, Gmail or Drive, a closing entry for the income-substantiation, mileage, digital-asset, or youngest-dependant items. Ages below are computed from each item's last-known date to today (**31 days from 2026-08-19** as of the 2026-09-19 sweep, unless noted); none of these were chased further this run beyond the searches described in the 2026-09-19 log entry above (~5 calls' worth: Double notes re-read, Gmail, Ping, no Drive re-walk this run) — a deeper document-by-document chase (e.g. opening the SSN/EAD cards, or the software file itself, to see what was actually typed) was **not attempted**, per the redaction rule and this sweep's budget.
