...
> full activity log, notes and properties). 🔴 **Biggest finding: the 2025 return has been FILED —
> see §4/§6.** The file's own narrative had stopped mid-preparation on 2026-08-19/20; Double shows
> the engagement closed out the same evening.
...
- **Process notes (→ future SOP):**
  - ✅ **FILED 2026-08-20.** [`2025 Taxes`, cid 710644 / project 219331](https://app.doublehq.com/tax-return?cid=710644&projectId=219331) moved from Not Started straight to **Filed** at 2026-08-20T19:56 UTC (Lilian), and all nine of its project tasks (organizer through "Send final returns to client") were marked Done within the same three minutes. Double also now carries three new tracking properties confirming close-out: **`Ext. Filed: true`**, **`Signature: Signed`**, **`Invoice: Sent`**. The signed return (`HLEBOVAKOZLOVSKALILIIA2025.pdf`) was filed into the client's `2025` folder the same day. _(Found 2026-09-12 — the file's own log had stopped at the 2026-08-20 ATX session and never recorded that the return actually went out.)_
  - ~~status `notStarted` as at 2026-08-17~~ — superseded by the above.
...
- 🔴 **THE MARKETPLACE POLICY IS WHAT GATES THIS RETURN, and it cannot be settled on her side alone.** She had **Marketplace coverage** in both 2024 and 2025, reconciled on **Form 8962**, and the return is **rejected without it**. ✅ **The 2025 Form 1095-A arrived on 2026-08-18, and is now filed in Double** — **one policy covering the whole household and shared by THREE separate returns**, hers, her ex-husband's and her adult daughter's. **All three of the minor children are covered on it**, including the youngest _(established 2026-08-18)_, so there is no separate Medicaid/CHIP question to chase. ⚠️ **The form lists only five covered people per page** — the sixth is on a continuation page, and reading page one and counting is exactly how this file first got it wrong. See §6. In 2024 the household was covered on **one policy** and answered "no allocation". **Filing separately, that route is gone:** Part IV requires an **allocation percentage**, every return sharing the policy must carry the **same** figures, and between them the shares must cover the policy exactly — **no overlap and no gap** for the same months, which in practice means the three add to **100%**. ⓘ **The rules are pairwise** — the pair *her ↔ her ex-husband* runs under the divorced-during-the-year situation (**by agreement**), the pair with the adult daughter under a different one. 🔑 **In money it is very nearly neutral** here, because everyone's required contribution works out at zero, so **this is a consistency question, not a money question**. ✅ **SETTLED 2026-08-19: 80% hers / 20% his**, with the adult daughter at 0% — see §6.
- 🔴 **DEPENDANTS: ALL THREE MINOR CHILDREN LIVED WITH HER FOR THE WHOLE OF 2025 — corrected 2026-08-19, and it changed her return more than anything else in the engagement.** _(Lilian, confirmed; her ex-husband **lived alone** all year.)_ ⚠️ **This SUPERSEDES the 2026-08-18 position** that two of the three lived with their father. **She claims all three children and every credit — the child tax credit and the earned income credit; he claims nothing and files as a single filer.** 🔑 **And the reason it matters so much is the shape of the credits, not their number.** She has **earned income** and he has **none**, so the credits that pay out in cash are reachable only on her return; but **residence is not transferable** — head of household, the **earned income credit** and the dependent-care credit follow where a child actually lives, and only the child tax credit and the dependency move on a **Form 8332**. **With all three children resident with her, the Form 8332 conversation is closed — there is nothing to release, and none should be sent.** 🔑 **The lesson the firm should keep: the lever it was about to recommend (one signed release) was worth a fraction of what the children's actual residence was worth.** Where a child sleeps and who claims a child are two different levers, and only one of them carries the earned income credit. ⚠️ **One consequence that reverses the firm's usual advice:** with three children her earned income credit is on its **phase-in**, below the plateau — so **an extra deduction now COSTS her money and extra receipts GAIN her money**, the opposite of the position she was in with one child. **Deductions must still be right; they are no longer worth selling to her as savings.** _(Analysis run 2026-08-18 and recomputed 2026-08-19 at Lilian's request; the figures are in the working paper.)_
...
- **2026-08-19 (Lilian)** — 🔴 **SUPERSEDED THE SAME EVENING — see the entry below.** **The Form 8962 allocation was settled at 50 / 50** with her ex-husband. **Her adult daughter filed her own return and reported nothing from the 1095-A**, so the two parents reconcile the whole policy between them. 🔑 **An even split is the no-agreement default under Allocation Situation 1**, which is what made it defensible. ⓘ **The allocation percentage was, and remains, very nearly neutral in money on both returns** — the nonrefundable child tax credit absorbs the small excess advance either way. **It is a consistency question, not a money question.**
  - ⓘ **She also settled the phone at the same business-use percentage as the internet**, and explained how ATX handles the home office: the figures are entered on the **Home Office Expenses worksheet**, and the software builds the Form 8829 from it.

- **2026-08-19 (Lilian, in the software)** — **Preparing the return in ATX surfaced three procedural rules the firm did not have written down**, all now in the 1040 SOP. **(1)** On Form 8962 an **allocated** return can never use the annual line 11 — ATX enforces it, encoding the IRS rule in the software's own words, and filling line 11 while the monthly lines sit empty produces a repayment of the whole limitation instead of a couple of dollars. **(2)** **Line 34 must be ticked Yes** — on the form it is the completeness question that closes Part IV, in ATX it is what makes the percentages take effect, and its printed text is itself the instruction for the monthly lines. **(3)** The children for the earned income credit are entered on the **Form 1040 Dependents tab**, never on Schedule EIC, whose own screen will not accept the Social Security number or the lived-in-the-US tick. 🔑 **She also set the delivery standard for this kind of work:** tables per form, the flow of figures between forms, the explanations, and **the boxes to tick** — recorded in the [`tax-return-sop`](../../../.claude/skills/tax-return-sop/) skill.

- **2026-08-19 (Lilian, evening) — 🔴 A CHANGE OF PLAN THAT REWROTE BOTH RETURNS.** Lilian confirmed
  that **all three minor children lived with her for the whole of 2025** and that **her ex-husband
  lived alone** — reversing the residence facts recorded the previous day, on which two of the three
  lived with their father. **Both sets of facts came from her; the later one governs and is recorded
  as a correction rather than an overwrite.** What followed from it:
  - ✅ **She claims all three children and every credit** — child tax credit and earned income credit.
    **He claims nobody** and files as a **single filer**; head of household is unavailable to him
    because no qualifying person lived in his home.
  - 🟡 **She is head of household on two of the three tests** — unmarried at year end, and all three
    children resident with her. ⚠️ **The cost-of-keeping-up-a-home test is still open**, and it must
    not be closed on the ground that he lived alone: **that answers the qualifying-person test, not
    the cost test.** The cost test asks whether *she* paid more than half the cost of *her* home,
    and **he is a named co-tenant on her lease** — which is a reason to establish who paid, not a
    reason to close it _(caught in independent review, 2026-08-19)_.
  - ✅ **The Form 8962 allocation moved to 80% hers / 20% his**, replacing the 50/50 set earlier the
    same day. Under Allocation Situation 1 the split is **by agreement**; an even split is only the
    no-agreement fallback, so this is a different agreed position, not a weaker one. ⓘ **It divides
    the policy's cents exactly, where the halves did not** — every column reconciles with no rounding
    residue on either return.
  - ⛔ **The Form 8332 recommendation is withdrawn.** With all three children resident with her there
    is nothing for him to release. **Do not put it to the parents.**
  - 🔑 **The lesson worth keeping.** The firm was about to ask for one signed release — the *small,
    releasable* lever. **What actually moved her return by an order of magnitude was where the
    children slept** — the earned income credit follows residence and **cannot be released on any
    form**. *Where a child sleeps and who claims a child are two different levers.*
  - ⚠️ **And her incentives inverted.** With three children her earned income credit sits on the
    **phase-in**, below the plateau, so **an extra deduction now costs her money and extra receipts
    gain her money** — the reverse of her position with one child. **Deductions still have to be
    right; they are no longer savings to be sold to her.** The item genuinely worth chasing is now
    the identity of the company's contract-labour payee, because if that person is her it is
    **additional business receipts**.
  - 🟡 **Her new driver's licence** — Lilian has it and is uploading it to Double. **Close the pending
    item once the file is visible there.**
  - ⚠️ **One methodological note the firm should not lose.** The joint organizer had said all along
    that all three children lived with their mother for twelve months. **The session treated that
...
- **2026-08-19 → ✅ CLOSED 2026-09-12 (Lilian) — THE HOME-OFFICE WORKING SHEET WAS BUILT, HANDED
  OVER, AND CONFIRMED FILED.** Lilian's rule: **the home-office figure on the return must have a
  ...
  an interactive picker only a person can operate). ✅ **Confirmed by Double's activity log: `HomeOffice2025Liliia.xlsx` was created in the client's `2025` file-library folder 2026-08-19T21:23 UTC.** The return's working paper's open item is resolved.
...
- **What gates the return.** ✅ **(1)** The **Form 8962 / Marketplace allocation** — **settled 2026-08-19 at 80 / 20** with her ex-husband; the adult daughter reported nothing from the form. ⓘ **(2)** Her 2025 income — **settled 2026-08-18: consulting services, Schedule C** (§5). ✅ **Neither gate blocked filing: the return went out 2026-08-20** (§4/§6). ⚠️ **The substantiation items below (her income document, mileage, the digital-asset transaction, the youngest dependant's details) do not appear to have been closed off in this file's own record before the return was filed** — found 2026-09-12, not resolved by this sweep. This is stated as what the record shows, not as a claim that the return is wrong; **ask Lilian whether these were settled outside the file, or remain open post-filing** (e.g. for an amendment or in case of inquiry).

- **2026-09-12 — First full historical CI sweep.** Findings by source:
  - **Ping** (`resolve_person` on the client, org-wide `search_meetings` for her name and "tax return status"): **zero results specifically about this client** — every hit was about an unrelated client. Corroborates the 2026-08-17 review's finding that "Ping held nothing on this client."
  - **Double** (`get_client`, properties, `list_notes`, full `list_activity_log`, 28 entries, full history): confirmed the **return filed 2026-08-20** (above). Both notes (447853, 495721) re-read in full — no content beyond what the file already carries (495721 holds the month-by-month telephone/home-office cost figures behind the working paper; **dollar figures not copied here**, per rule).
  - **Gmail** (full history, unbounded — no baseline existed): her own direct correspondence with the firm is thin but real and predates the current CI system — **2023-12-26, 2024-04-08/10, 2024-10-11** (from `lilia.od.ua@gmail.com` directly to Julia) — nothing found addressed to or from her personally **after** the 2026-08-20 filing. ⚠️ **A naming-collision negative, worth recording so it is not mistaken for new mail:** a broader search on "Kozlovska OR Kozlovskyi" also returned a 2026-09-10 USPS Informed Delivery digest email — its own snippet opens *"Hi, TETIANA!"*, so it belongs to a **different client's household** and merely matched the search text; **not evidence of anything arriving for this client.** Several other matches (firm-wide contact-list and client-list spreadsheets) are administrative rosters that list every client by name — noise, not client-specific facts.
  - **Google Drive** (`excludeContentSnippets: true`, both her folder and the firm's shared vault): confirmed the known organizer PDFs and the 2024/2025 combined-return PDFs. 🔎 **New, not opened:** the shared vault holds `SSN cards — Kozlovkyi Family.pdf` and `EAD Cards — Kozlovskyi Family.pdf`, each filed **2023-12-28** and re-filed **2024-02-05**. **Existence only, not content** — identity documents are never opened per the redaction rule — but this is a lead worth pointing at the open "her own SSN, valid for employment" item (§6/Information still needed): the family holds or held EAD-based Social Security numbers, which is exactly the fact that item needs settled.
- 2026-09-26 — **Incremental sweep, baseline 2026-09-19 (bounded 2026-09-19→09-26).** Double: both notes (447853, 495721) re-read — `updatedAt` unchanged on both, no new content. `list_client_properties` unchanged (`Tax Return Type: 1040`, `Ext. Filed: true`, `Signature: Signed`, `Invoice: Sent` — still Sent, not Paid, unlike her ex-husband's and Kolo Florida's, which moved to Paid this window; worth a glance but not flagged as a problem on its own). `list_activity_log` bounded ≥2026-09-19 returned **zero entries**. Gmail (`Kozlovsk OR Hlebova`, `after:2026/09/19`, then a second targeted pass for `(W-2 OR digital asset OR material participation OR driver's licence OR contract labor) AND (Kozlovsk OR Hlebova)`, same bound): **no hits specific to her** beyond the standing weekly Client-Intelligence sweep digest — none of her six open substantiation items (income document, mileage, digital-asset transaction, youngest dependant's details, driver's licence, the Jan–Aug cost-of-keeping-up-a-home test) show any movement. Ping (`resolve_person` "Liliia Hlebova Kozlovska" — single match; org-wide `search_meetings` for "Kolo Florida Kozlovskyi Kozlovska tax return Marketplace 1095-A"): no legible, client-specific hits — consistent with the standing zero-meetings finding. Google Drive: no title search run this pass (budget went to the two Gmail passes and the Kolo Florida company-side findings written up on [`kolo-florida.md`](./kolo-florida.md)); the SSN/EAD-cards lead and the working-paper/software file remain untouched. **This is a repeat negative, not a new one — ages below are simply longer.**
- 2026-09-19 — **First ordinary incremental sweep, baseline 2026-09-12 (bounded 2026-09-12→09-19).**
  Double: both notes (447853, 495721) re-read again — `updatedAt` unchanged on both, no new content.
  `list_activity_log` bounded to the window returned **zero entries** — no filing, property or task
  movement since the 2026-08-20 close-out. Gmail (`Kozlovska OR Kozlovskyi OR Hlebova`, after
  2026/09/12): no hits beyond the automated weekly-sweep digest and one unrelated USPS
  Informed-Delivery false match (a different client's household, as already flagged in the
  2026-09-12 entry — re-confirmed, not repeated here). Ping (org-wide `search_meetings`, her name +
  "substantiation/mileage/digital asset/dependant"): no results specific to her — consistent with
  the confirmed-empty finding from the last sweep. **Chase pass (~5 calls):** re-checked every
  substantiation item below by name — income document, mileage, the digital-asset transaction, the
  youngest dependant's details, her driver's licence, the cost-of-keeping-up-a-home test for
  Jan–Aug 2025 — **none show a closing entry in Double, Gmail or Drive.** No document was opened
  (the SSN/EAD cards lead and the working-paper/software file itself remain untouched, per the
  redaction rule and this sweep's budget) — this is a repeat negative, not a new one, and ages below
  are simply longer.
...
> ⚠️ **The 2025 return was FILED 2026-08-20 (§4/§6) while most items below still read as open in this file's own record.** Neither the 2026-09-12, 2026-09-19 nor the 2026-09-26 sweep found, in Double, Gmail or Drive, a closing entry for the income-substantiation, mileage, digital-asset, or youngest-dependant items. Ages below are computed from each item's last-known date to today (**38 days from 2026-08-19** as of the 2026-09-26 sweep, unless noted); none of these were chased further this run beyond the searches described in the 2026-09-26 log entry above (~5 calls' worth: Double notes re-read, Gmail ×2, Ping; no Drive re-walk this run) — a deeper document-by-document chase (e.g. opening the SSN/EAD cards, or the software file itself, to see what was actually typed) was **not attempted**, per the redaction rule and this sweep's budget.

- 🟡 **Her filing status — HEAD OF HOUSEHOLD, two tests of three.** Unmarried at 31 December 2025 ✅; **all three minor children resident with her all year** ✅ _(Lilian, 2026-08-19 — confirmed, and her ex-husband lived alone)_. 🔴 **The cost-of-keeping-up-a-home test is OPEN for January–August, and "he lived alone" does not close it** — that answers the qualifying-person test; the cost test asks whether *she* paid more than half the cost of *her own* home, and **he is a named co-tenant on her lease.** Someone who lives elsewhere can still pay rent, so this is a question to settle, not a settled question _(caught in independent review, 2026-08-19)_. ✅ **The married-filing-separately branch, which would have barred the premium tax credit outright, IS closed** — she is simply unmarried. ⓘ **Worth nothing in money on the 2025 figures, and close to the point where it would be** — re-test it rather than carrying the conclusion forward.
- ✅ **The Form 8962 allocation is SETTLED: 80% hers / 20% her ex-husband's** _(Lilian, 2026-08-19 evening, replacing the 50/50 she set earlier the same day)_. **The adult daughter filed her own return and reported nothing from the 1095-A**, so the two of them reconcile the whole policy between them — no gap, no overlap. 🔑 **Under Allocation Situation 1 the split is BY AGREEMENT — any percentages the two of them accept.** An even split is only the fallback where there is no agreement, so 80/20 is not a weaker position, it is a different agreed one, and it sits closer to the tax families now that all three children are hers. ✅ **It no longer depends on who claims which child, because nobody is releasing anyone.** ⓘ In money the allocation percentage is very nearly neutral for the household and always was; choose it for defensibility. ⓘ The form itself is in hand and filed in Double.
- ✅ **The dependants split — CLOSED 2026-08-19.** All three minor children lived with her all year; he lived alone. **She claims all three; he claims nobody.** ⛔ **No Form 8332 is needed or wanted** — there is nothing to release. _(The 2026-08-18 recommendation of one signed release is superseded and should not be put to the parents.)_
- 🟠 **Where she lived January–August 2025, and what it cost.** Only her own tenancy from September is documented, and head of household is tested over the **whole year**. 🔴 **Do NOT close this on "he lived alone"** — that answers the qualifying-person test, not the cost test. The cost test asks whether **she** paid more than half the cost of **her own** home, and **he is a named co-tenant on her lease**, so the paperwork points the other way _(caught in independent review, 2026-08-19)_.
...
- 🔴 ~~Head of household for both parents.~~ **CORRECTED 2026-08-19: only SHE is a head of household.** All three children lived with her; he lived alone and has no qualifying person, so he files as a single filer. **The 2026-08-18 "both parents qualify" analysis is superseded** — it is kept in the working papers because the reasoning is the reusable part, and because the case now shows something better: **a head-of-household position can be correct on one day's facts and unavailable on the next, without a dollar of income moving.** _(On the superseded facts:_ each parent had their own qualifying child, which is what the *"the same child cannot serve both parents"* rule requires; both were unmarried at year end. ⚠️ **The cost test is the open half** — it is annual, and the months before the separation are unaccounted for on both sides. ⓘ **The reasoning is kept in the working papers because it is the reusable part**, in particular that two people cannot each pay more than half the cost of the *same* home, and that "considered unmarried" for head of household is **not** the same test as the separated-spouse relief the earned income credit uses.
