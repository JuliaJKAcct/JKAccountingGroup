...
- **2026-08-18 (Lilian)** — **Searched for the 2025 Form 1095-A at her request, and established it is not on file.** Searched: Julia's Gmail (the term `1095`; both household email addresses as `from:`/`to:`; everything naming either surname since 2026-01-01) and Google Drive (files titled `1095`, plus a folder-by-folder walk of both household client folders and every subfolder). Drive proved to be an exact mirror of Double. **What those searches produced was the 2024 Form 1095-A and nothing for 2025.** ⚠️ **The file she had attached to the organizer's 1095-A question turned out to be an insurance member ID card** (Oscar Insurance Company of Florida, a Marketplace carrier, in her ex-husband's name) — which the review of 2026-08-17 had flagged as unconfirmed, and is now settled. **The 1095-A has to be requested; the carrier is known, so it downloads from Healthcare.gov or the carrier's member portal.**
...
- 🔴 **The 2025 Form 1095-A is missing, and it blocks e-filing.** Not in Double, not in Drive, not in Julia's Gmail — the 2026-08-18 log entry names exactly what was searched. **Ask the client to download it** from Healthcare.gov or the carrier's member portal; the carrier is named on the member card already on file.
