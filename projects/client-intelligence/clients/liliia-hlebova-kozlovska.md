...
- **2026-08-18 (Lilian, later the same day)** — **The return became computable, and three of the session's own statements were corrected.**
  - ✅ **Filing status settled: head of household** — she was **unmarried at 31 December 2025** and the youngest daughter lived with her all year. **Her ex-husband is separately head of household** on his own two children, and **he paid his home from his savings**, which is what Pub 501 Worksheet 1 asks (*what you paid*, not where the money was earned).
...
- ✅ ~~Her filing status.~~ **HEAD OF HOUSEHOLD, settled 2026-08-18** — unmarried at 31 December 2025, the youngest daughter resident all year, her own home kept up. **The married-filing-separately branch, which would have barred the premium tax credit outright, is closed.**
- 🟠 **The Form 8962 allocation percentage, agreed across the three returns.** ⚠️ **Her adult daughter has already filed** — the firm needs **one number from her: the percentage her return claimed.** A split following who was enrolled, by tax family, was proposed on 2026-08-18 and totals 100%. ⓘ **The form itself is in hand and filed in Double**; this is the last input either return is waiting on.
...
- ✅ ~~Head of household for both parents.~~ **CONFIRMED for both, 2026-08-18.** Each parent has **their own** qualifying child — the youngest with her all year, the two middle daughters with their father all year — which is what the *"the same child cannot serve both parents"* rule requires; both were unmarried at year end; and each kept up their own home. ⓘ **The reasoning is kept in the working papers because it is the reusable part**, in particular that two people cannot each pay more than half the cost of the *same* home, and that "considered unmarried" for head of household is **not** the same test as the separated-spouse relief the earned income credit uses.
...
- [ ] The **allocation percentage** her adult daughter's already-filed return claimed — one number, and the three returns must total 100%
