...
- 🔴 **THE MARKETPLACE POLICY IS WHAT GATES THIS RETURN, and it cannot be settled on her side alone.** She had **Marketplace coverage** in both 2024 and 2025, reconciled on **Form 8962**, and the return is **rejected without it**. ✅ **The 2025 Form 1095-A arrived on 2026-08-18** — and it is **one policy shared by THREE separate returns**, hers, her ex-husband's and her adult daughter's. See §6. In 2024 the household was covered on **one policy for five people** and answered "no allocation". Filing separately, that route is gone: if she and her ex-husband shared a policy in 2025, **Part IV requires an allocation percentage they both agree on**, and **both returns must carry the same figure**. The dependants split changes the tax family size, which changes the calculation — so **the 8962 and the dependants decision are one decision, not two**.
...
- 🔴 **HER FILING STATUS, which sits upstream of every figure on her return.** Head of household needs her unmarried, or considered unmarried, at **31 December 2025** — and **the date the marriage ended is still not established**. If she is not, the standard deduction falls, taxable income stops being zero, **married filing separately cannot take the premium tax credit at all**, and the earned income credit needs a **separate** relief test from the head-of-household one.
- 🔴 **The Form 8962 allocation of the shared Marketplace policy**, settled with the other two returns. ⚠️ **Her adult daughter has already filed**, which may constrain the rest — find out what that return claimed. ⚠️ **And it is not one percentage across everyone**: the rules are pairwise and differ by situation. **Ask the client to download it** from Healthcare.gov or the carrier's member portal; the carrier is named on the member card already on file.
...
- ✅ **HEAD OF HOUSEHOLD IS AVAILABLE TO HER — and to her ex-husband, separately.** _(Residence settled by Lilian, 2026-08-18: **the youngest daughter lived with her all year; the two middle daughters lived with their father all year; the eldest is an adult and filed her own return.**)_ **Each parent therefore has their own qualifying child**, which is what the "same child cannot serve both" rule requires. **Two tests still have to hold for each of them**: unmarried (or considered unmarried) at year end — **the date the marriage ended is still not established** — and having paid more than half the cost of keeping up their own home. _(The analysis below is kept because it is the reasoning, not the answer.)_ ⓘ Previously: Three tests: unmarried at year end (the **divorce date is unknown**); **more than half the cost of keeping up a home for the year** (only **September–December** is documented, and **with no established income, who actually paid the rent is a live question** — Pub 501's worksheet splits *the amount you paid* from *the amount others paid*, so money she receives and spends counts as hers, while amounts another person pays **directly** do not); and a qualifying child in the home **more than half the year** (the organizer says all three lived with her **12 months**, which cannot sit alongside her ex-husband living with a daughter most of the year). 🔴 **And HOH is not a standard-deduction question here — filing status is the PREMIUM-TAX-CREDIT gate.** If the marriage had not ended by 31 December, **married filing separately cannot take the credit at all**. The full analysis is in his working paper (`projects/tax-returns/mykola-kozlovskyi/2025-form-1040.md`).
