...
- ✅ **The Form 8962 allocation is SETTLED: 50 / 50 between the two ex-spouses** _(Lilian, 2026-08-19)_. **The adult daughter filed her own return and reported nothing from the 1095-A**, so the two of them reconcile the whole policy between them — no gap, no overlap. 🔑 **50/50 is also the no-agreement default under Allocation Situation 1**, which makes it the most defensible split available and needs no justification beyond the instruction. ✅ **It also removes an ordering trap**: under the enrolled-by-tax-family split it replaces, a Form 8332 would have moved a child between tax families and changed the percentage. **An agreed 50/50 does not depend on who claims which child.** ⓘ The form itself is in hand and filed in Double.
