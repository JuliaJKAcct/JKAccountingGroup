...
- **2026-08-19 (Lilian, evening) — 🔴 A CHANGE OF PLAN THAT REWROTE BOTH RETURNS.** Lilian confirmed
  ...
  - ✅ **She is head of household on all three tests**, and with no competing household the
    cost-of-keeping-up-a-home question is no longer a position in doubt, only a documentation gap.
...
- ✅ **Her filing status — HEAD OF HOUSEHOLD, all three tests.** Unmarried at 31 December 2025 ✅; **all three minor children resident with her all year** ✅ _(Lilian, 2026-08-19 — confirmed, and her ex-husband lived alone)_; and with no competing household the cost test is not in doubt. ⚠️ **What is still thin is the EVIDENCE for January–August**, which is a documentation gap rather than a position. ✅ **The married-filing-separately branch, which would have barred the premium tax credit outright, IS closed** — she is simply unmarried. ⓘ **It is worth nothing in money on the 2025 figures and it is very close to the point where it would be** — re-test it rather than carrying the conclusion forward.
