...
- 🔴 **FL DOR sales-tax audit — NOW ACTIVE AGAIN, direct document exchange with the auditor on 2026-09-17.** See §4/§6 for the Chase ●0087 / Valley Bank ●4543 statement exchange and the missing-Jan–Apr-2023 gap. No stated deadline; watch for the next auditor request.
- USDT-related deposit flagged pending 2026-07-23 — STILL OPEN, but now understood differently — see the 2026-09-09/11 personal-wallet clarification in §5. Not separately re-chased this run (budget; the 2026-09-19 targeted crypto/1099/NJ search found nothing beyond what's already recorded); now ~58 days pending.
- ✅ **2025 business income-tax return — FILED 2026-09-16, signed copy delivered 2026-09-17.** See §4. Fully resolves the "ready for review" framing; the organizer-status contradiction remains a separate, still-unsettled question, re-verified but not resolved this run.
- **Open in Maria's guide, remaining:** dispute case, employee I-9, credit memo, skipped-contractor commissions — not chased this run (budget; no targeted search run for these specific items).
...
- **New Jersey Division of Taxation Payable on the Balance Sheet** (surfaced 2026-09-10) — STILL OPEN, not yet investigated; no update found this run (2026-09-19), now 9 days pending, no deadline stated.
- **A 1099 to the owner (Stan) for personal-wallet-to-business crypto transfers is under consideration** (2026-09-11, owner agreed in principle) — STILL not issued or confirmed; no update found this run, now ~8 days pending, no deadline stated (year-end 1099 filing deadlines would apply once decided).
