...
> **Status:** Active · **Owner:** Maria · **Last updated:** 2026-09-03
...
- 2026-09-03 — **Julia decided on the review's entries** (chat): the owner's personal IRS payment goes to distributions; HSA remittances go to the liability (Gusto side already correct); Apple hardware to Job Supplies; the Petty Cash expense and the Cash Short in/out plug both move into Cash in Drawer; payables/1099-related items disregarded; officer compensation for 2025 read as none (to confirm). Six journal entries delivered to her import-ready for QuickBooks Online; **nothing posted** — the session's QuickBooks connector is the firm's own file, not the client's. Figures in the working paper.
