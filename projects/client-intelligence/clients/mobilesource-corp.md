...
- **2025 tax organizer status — CONTRADICTION, unsettled (see below for new movement).** This file has recorded **"Sent to the client as of 2026-07-25"** (Double client properties, as read on that date). Re-checked live 2026-08-29: (a) the `Organizer Status` property now reads **"N/A (we have QBO access)"**, and (b) the organizer entity itself (`JK 2025 Business Tax Organizer -Mobilesource`, id 142672) shows status **`draft`**, `publishedAt: null` — i.e. it has never actually been published/sent to the client. The three readings (Sent / N/A-QBO-access / never-published draft) do not agree. Not resolved in this sweep (2026-08-29) — ask whoever next needs this fact, and update from the answer. **The organizer-status contradiction itself was not chased or resolved this run (2026-09-12), per instructions — see the 2026-09-12 log entry immediately below for a separate, resolved fact: the underlying tax PROJECT (distinct from the organizer) has since moved to `readyForReview`.**
- 🟢 **2025 tax return — READY FOR REVIEW, sent to the client 2026-09-10.** Double's `list_projects` shows the "2025 Taxes" project (`219901`) moved from `notStarted` to **`readyForReview`** on 2026-09-07 (by Irina Jandieri). On 2026-09-10 Lilian attached "MOBILESOURCECORP2025.pdf" to a client-portal question: *"Please find attached the 2025 tax return for review."* This is new movement on the return itself — it does not resolve the organizer-status contradiction above (a separate Double entity), which remains unsettled. _(Double `list_projects`, activity log — 2026-09-07/10)_
- ✅ **2025 tax return — FILED 2026-09-16, signed, and delivered.** `list_activity_log` bounded ≥2026-09-12 shows the "2025 Taxes" project moving `readyForReview` → **`Filed`** (2026-09-16 00:18, Lilian), and the signed "MOBILESOURCECORP2025.pdf" being moved into a "2025" custom folder on 2026-09-17 (attached to a `signedSignatureRequest`). Gmail confirms the delivery loop: the GM (Amalia) asked 2026-09-17 for "the files with the signatures… didn't see them in the portal," and Lilian replied the same day directing her to log back into the portal and find the signed return under the **"Tax Return Filed"** folder. This closes the "sent to the client for review" framing above — the return is now filed and signed-copy delivery is confirmed. It does **not** resolve the organizer-status contradiction (a separate Double entity, left alone per instructions). _(Double `list_activity_log`; Gmail, 2026-09-17)_
...
- 🔴 **Crypto arrangement clarified (2026-09-09/11): the company's USDT activity runs through the OWNER'S PERSONAL cold wallet, not a company-owned account.** Julia asked the owner (Stan) for all 2025 wallet transactions to report on his own individual 2025 return, and separately raised **issuing the owner a 1099 from Mobilesource** for money moved out of the wallet into the business (even though late) — the owner agreed this is reasonable. He confirmed it is a cold/offline wallet with no exchange used, so no downloadable statement exists. This significantly extends the existing USDT-deposit quirk: it is not just an unrecognized-deposit problem, it is a personal-wallet-funds-the-business arrangement with its own 1099 and personal-return reporting questions. _(Gmail "Crypto," 2026-09-09/11 — Russian-language thread)_
- **New Jersey Division of Taxation Payable now appears on the Balance Sheet** (surfaced 2026-09-10) — tied to the same sales-tax/QBO mapping problem already tracked (§4), but this is the first documented sign of **New Jersey** exposure specifically, distinct from the Florida-only framing used so far. Not yet investigated further. _(Gmail "Books 2026," 2026-09-10)_
...
- 2026-09-12 — **Incremental sweep (baseline 2026-08-29→2026-09-12).** Double: the August 2026 close completed 2026-09-10 (all standard tasks Done, plus "Clean accounts" and an undeposited-funds check); **the "2025 Taxes" project moved `notStarted` → `readyForReview` on 2026-09-07**, and on 2026-09-10 Lilian attached the prepared PDF to a client-portal question for review — added to §4 as new, resolved movement (does **not** touch the still-unsettled organizer-status contradiction, a separate Double entity — left alone per instructions). Gmail: a search of `(Sensustech OR "Stanislav Fedorov" OR Mobilesource) after:2026/08/29`, a targeted `Mobilesource (DOR OR audit OR "Department of Revenue") after:2026/08/29`, and the "Books 2026"/"Crypto" threads (2026-09-02→11) surfaced: **no new correspondence on the FL DOR sales-tax audit** (still silent since 2026-08-20); a major clarification of the **crypto/USDT arrangement** — it runs through the owner's personal wallet, and the firm is now weighing a 1099 to the owner plus reporting on his personal return (added to §5, full detail there); a **New Jersey sales-tax payable** newly visible on the Balance Sheet (added to §5); and routine balance-sheet cleanup progress (Amazon Credit adjusted 2026-09-10; cash-in-drawer/petty-cash still "to discuss with Julia"; the old 2024 computer still unconfirmed; a Zelle overpayment resolved by reallocating to a vendor balance). A personal/1040 matter for the owner (rental-property income, in the "2025 Tax return - rental info" thread with Stan) surfaced in the same mailbox sweep — **out of scope for this company file**, not written in here; see [`sensustech.md`](./sensustech.md) §6 for the same-owner cross-reference. Ping: no legible new content for Mobilesource or the owner. Drive: an "FY2025 books review.xlsx" and a "FY2025 journal entries import.csv" (created 2026-09-03) confirm active 2025 return-preparation work. Chase pass on all outstanding items — results below.
- 2026-09-19 — **Incremental sweep (baseline 2026-09-12→2026-09-19).** Double: `list_notes` returned 0 notes; `list_activity_log` bounded ≥2026-09-12 shows the return moving to **Filed** (see §4) and a monthly-sales-tax task and a Gusto biweekly-payroll task both marked Done (2026-09-15). 🔴 **FL DOR sales-tax audit — MAJOR NEW MOVEMENT, first direct document exchange with the auditor found in this file.** A search of `(Mobilesource OR Stan) (1099 OR USDT OR crypto OR "New Jersey") after:2026/09/12` and a broader `(Sensustech OR Mobilesource) after:2026/09/12` surfaced a **2026-09-17 email thread directly between the GM (Amalia — email withheld) and the FL DOR auditor (Thomas Briggs)**: Amalia sent **Chase Bank ●0087 and Valley Bank ●4543 statements**; the auditor replied that he was missing **January–April 2023** statements for Chase ●0087; Amalia clarified there were **no transactions in that account for that period** and separately sent the 2023 Valley Bank ●4543 statements. This is the first evidence the audit has reached **historical (2023) bank-statement production**, beyond the 2026-08-20 written Q&A about buyback-program processing — the "still escalated, no further movement" framing from the last sweep no longer holds; the audit is now active and moving. No dollar figures or full account numbers retained. Routine FL DOR "Return Filed" and "Payment Received" notices (2026-09-15) confirm the ordinary monthly sales-tax filing continued on schedule, separate from the audit. No further movement found this window on the crypto/USDT-1099 decision or the New Jersey payable beyond what was already recorded 2026-09-12. Ping: an org-wide semantic search for Sensustech/Mobilesource/Lumetro returned no legible, on-topic results. Drive: not separately re-searched this run (the FL DOR/return-filing Gmail chase covered the live items; budget). Chase pass on all outstanding items — results below.

- 2026-09-26 — **Incremental sweep (baseline 2026-09-19→2026-09-26).** Double: `list_notes` returned 0 notes; `list_activity_log` bounded ≥2026-09-19 returned **0 entries** — no close activity this window. Client properties re-confirmed unchanged except a **new "Signature" property reading "Signed"** (added to outstanding items). Gmail: a targeted `(Mobilesource OR Stan) (1099 OR USDT OR crypto OR "New Jersey" OR DOR OR audit) after:2026/09/19` search found **nothing beyond the firm's own sweep email** — no further movement on the FL DOR audit since last week's Chase/Valley Bank statement exchange, no update on the New Jersey payable, and no update on the owner-crypto-1099 decision. Ping: an org-wide semantic search for Sensustech/Mobilesource/Lumetro/Fedorov returned no legible, on-topic results. Drive: not separately re-searched this run (a combined Sensustech/Mobilesource/Lumetro title search bounded ≥2026-09-19 found zero modified files; budget). Chase pass on all outstanding items — results below.

### Outstanding items (CI-only — never in the SOP)
- 🔴 **FL DOR sales-tax audit — NO FURTHER MOVEMENT this week, following last week's active document exchange.** CHASED again 2026-09-26 (`(Mobilesource OR Stan) (1099 OR USDT OR crypto OR "New Jersey" OR DOR OR audit) after:2026/09/19`): nothing beyond the firm's own weekly CI-sweep email — no further auditor request since the 2026-09-17 Chase ●0087 / Valley Bank ●4543 exchange and the still-unresolved missing-Jan–Apr-2023 statement gap (see §4/§6). No stated deadline; watch for the auditor's next move.
- USDT-related deposit flagged pending 2026-07-23 — STILL OPEN, understood via the 2026-09-09/11 personal-wallet clarification in §5. CHASED again 2026-09-26: no new evidence; now ~65 days pending.
- ✅ **2025 business income-tax return — FILED 2026-09-16, signed copy delivered 2026-09-17.** No further action needed; the organizer-status contradiction remains a separate, still-unsettled question.
- **Open in Maria's guide, remaining:** dispute case, employee I-9, credit memo, skipped-contractor commissions — not chased this run either (budget).
- **New Jersey Division of Taxation Payable on the Balance Sheet** (surfaced 2026-09-10) — STILL OPEN, not yet investigated; no update found this run (2026-09-26), now ~16 days pending, no deadline stated.
- **A 1099 to the owner (Stan) for personal-wallet-to-business crypto transfers is under consideration** (2026-09-11, owner agreed in principle) — STILL not issued or confirmed; no update found this run, now ~15 days pending, no deadline stated (year-end 1099 filing deadlines would apply once decided).
- 🆕 **A "Signature" client property now reads "Signed"** (read live 2026-09-26) — consistent with the already-filed 2025 return; not independently investigated further.
