...
> **Status:** Active _(⚠️ but see the 🔴 flag in §5 — the Double record was archived and QuickBooks disconnected 2026-09-09/10, and remains archived as of 2026-09-19; this needs a human decision on whether "Active" still applies)_ · **Owner:** Liudmyla · **Last updated:** 2026-09-19
>
...
- 🔴 **STILL ARCHIVED as of 2026-09-19, still no explanation found, and this is now the SECOND consecutive weekly sweep to flag it for a human decision.** `get_client` (2026-09-19) confirms the record's `archivedAt` remains **2026-09-10T19:41:19Z**, `platform: none`, connection status `archived` — unchanged from the 2026-09-10 event; nobody has re-connected or un-archived it in the nine days since. **This client needs Lilian or Julia to decide: move it to `weekend-ci-sweep.md`'s exclusion table (a deliberate wind-down), or investigate and reverse it (a mistake).** A CI sweep cannot make that call and cannot edit that file itself — flagging again, prominently, rather than letting it go quiet a third week running.
...
- 🔴 **Confirm the QuickBooks subscription-renewal failure (2026-03-17) was actually resolved** — STILL OPEN, **≈186 days** pending since 2026-03-17, and **still overtaken by events**: the QuickBooks connection remains disconnected and the client remains archived as of 2026-09-19 (§5). A targeted search (2026-09-19) again found only the original "Could not renew…help please…" forward, no reply or resolution email, and nothing explaining the disconnection/archival either. **This is no longer a passive wait-and-recheck item — it needs Lilian/Julia to say what happened and whether the engagement is ending.**
- 🔴 **THE ARCHIVAL DECISION ITSELF — unresolved for 9 days.** Nobody has decided whether Greenair belongs in `weekend-ci-sweep.md`'s exclusion table (deliberate wind-down) or should be reconnected (a mistake). A CI sweep cannot make or act on this decision. **Flagging for a third time — see §5's top bullet.**
