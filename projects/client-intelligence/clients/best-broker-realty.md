...
- ⏰ **The 2026-09-30 renewal is 23 days out, still unowned — and assume it covers BOTH levels until proven otherwise.** The renewal notice arrived 2026-08-19 and, as of the 2026-08-29 sweep, was **not on any calendar**; re-checked in Gmail 2026-09-07, still nothing. 🛑 **Do not narrow this to the city on the strength of the county filename** (`…valid until 09.2027…`): the firm's [BTR SOP](../../sops/hollywood-broward-business-tax-receipt.md) states flatly that the tax year is **Oct 1 – Sep 30** and that **receipts expire Sept 30**, and **no one has opened that PDF.** ✅ **One cheap action settles it** — open the county certificate and read its expiry; if it really runs to 2027 the SOP needs correcting, and if it does not, a county renewal is also due in 23 days. ❓ **And a separate open question for Lilian:** her 2026-09-07 confirmation that both receipts are in hand settles the *applications* — **it says nothing about whether the RENEWAL has been filed or scheduled.** Ask before closing this.
