...
- ⏰ **The 2026-09-30 renewal is ~18 days out — the firm forwarded the notice to the client 2026-09-10, but nothing shows a client response or a calendar entry, and assume it covers BOTH levels until proven otherwise.** The renewal notice first arrived 2026-08-19, arrived again (the same formal notice) 2026-09-10, and Julia forwarded that copy to the client the same day — the first confirmed action on this item. Re-checked in Gmail and Google Calendar 2026-09-12: still no client reply, still no calendar entry. 🛑 **Do not narrow this to the city on the strength of the county filename** (`…valid until 09.2027…`): the firm's [BTR SOP](../../sops/hollywood-broward-business-tax-receipt.md) states flatly that the tax year is **Oct 1 – Sep 30** and that **receipts expire Sept 30**, and **no one has opened that PDF.** ✅ **One cheap action settles it** — open the county certificate and read its expiry; if it really runs to 2027 the SOP needs correcting, and if it does not, a county renewal is also due in 23 days. ❓ **And a separate open question for Lilian:** her 2026-09-07 confirmation that both receipts are in hand settles the *applications* — **it says nothing about whether the RENEWAL has been filed or scheduled.** Ask before closing this.
