...
- ✅ **RE-READING THE 2023 AND 2024 FILED RETURNS ANSWERED SIX BLOCKING QUESTIONS AT ONCE — 2026-09-14, and the lesson is general: the prior year is the answer key for PRESENTATION, and its absence is an answer too.** ① **An asset the client dated 2023 is on neither prior schedule**, so it belongs in 2025 — which moves the year's additions materially. ② **Schedule L cash in the prior year was the OPERATING ACCOUNT ALONE**, so the other bank accounts were never on the balance sheet. ③ **The prior year did NOT report zero distributions** — it reported the full amount on the K-1, capped Schedule M-2 at the AAA, and drove paid-in capital negative by the difference; **and it reported NO contributions**, so the firm's netting policy has nothing to net. ④ **The equipment debt was reported as ONE aggregate figure with no statement**, so what 2025 needs is a total, not a document per contract. ⑤ **Two long-standing mysteries are named on the prior return's own statements:** the unexplained other-current-asset is a **`Loan to Mema Colors LLC`**, and the other-current-liability line is the **Amex card balance** — which also gives 2025 its opening card figure. ⑥ 🔴 **Neither 2023 nor 2024 disposed of a single asset and no Form 4797 was ever filed**, so **2025 is the first disposal year and there is no house method to copy** — which is exactly why Julia had to rule on disposal documents.
- 🟡 **THE CLIENT USES FOUR NAMING SYSTEMS FOR HIS TRUCKS AND THE RETURNS USE A FIFTH — the mapping is now down to ONE unresolved pair.** Two of his three sold Freightliners cannot be told apart on any document the firm holds, **and one of that pair is the truck that was destroyed**, so which is which changes the casualty's basis. ⛔ **Neither filed return carries a unit number anywhere.** 🔑 **One question to the client closes it**, and it should be asked against the purchase date and price, not the description. ⚠️ **And a trailer he sold in 2025 appears on no prior return at all** — never capitalised, so there is no basis to recover against the proceeds.
