...
| Bank | Statements for the return | _(pending — client uploads them himself)_ | **Fifth Third Bank**, account type `5/3 BUS ELITE CKG` (Business Elite Checking, a demand-deposit account), banking centre **Bloomingdale, IL**. Verified 2026-09-13 by opening the January 2025 statement through the redactor. Statements arrive through the organizer, not a bank connection |
| American Express | — | n/a | **At least one Amex account was live in January 2025** — the bank statement shows two Amex ACH payments carrying two different Amex references. **No 2025 Amex statement has ever been provided** |
...
- 🔴 **The 2025 records are INCOMPLETE, and the bank statement itself proves it.** Reading January 2025 (2026-09-13, through the redactor) turned up three things the uploads do not cover: **two Amex ACH payments on one day carrying two different Amex references**, so at least one and probably two card accounts were live and **no 2025 card statement exists anywhere**; **thirteen `ZAKOM 7807 CASH DISB … OFFSET TRANSACTION` entries in that month alone**, against a statement that answers **"Business Loan or Line of Credit? Yes"** — so a second Fifth Third account or credit facility is moving money and the firm holds none of its statements; and **repeated Cash App debit-card payments to named individuals**, which is the same 1099 exposure the client himself raised. ⚠️ **None of this is a conclusion about the amounts** — it is the evidence that the twelve uploaded files are not the whole picture.
...
- **Two luxury vehicles appear in the 2025 uploads** — an Audi Q6 **lease** and Porsche Macan financing — alongside truck and trailer financing. The client also answered **"yes"** to having purchased an alternative-fuel vehicle. Leased vs purchased, and business vs personal use, both change the treatment and neither is established.
- **The company operated in one state only** per the organizer ("no" to more than one state), which is worth a second look for interstate trucking.
...
- [ ] 🔴 **The 2025 Amex statements — now a CONFIRMED gap, not a question.** January 2025 shows two Amex ACH payments with two different Amex references, so the card(s) were live. Ask for the full 2025 statements of each, **and establish whether the cards are the company's or the owner's personally** — the payments carry his name, which makes company-paid personal cards a distribution question
- [ ] 🔴 **What `ZAKOM 7807 CASH DISB … OFFSET TRANSACTION` is** — thirteen entries in January alone, on a statement that confirms a business loan or line of credit exists. Either a second company account or a credit facility; the firm holds statements for neither
