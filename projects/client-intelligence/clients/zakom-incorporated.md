...
| Credit cards — **more than one** | 🔴 **At least THREE, and the Amex may be PERSONAL** | n/a | 🔴 **The company HAS an Amex and always has.** The client calls it *"Zakom Amex"* in his own words and files it separately from *"Zakom Checking acc"*; the firm holds `Amex Zakom YearEndSummary_2023.pdf`, `Amex 2024 Zakom.pdf` and `Dec Amex balance stmnt.pdf`. **The firm's own annual request letter asks for the December bank AND credit-card statement to confirm balances** _(Julia to the client, Feb 2023)_. ⛔ **Nothing for 2025 has been provided, and the exposure is far larger than a missing document: the 2025 bank statements show 39 Amex payments across the year** *(working paper §3E ②)*. ⛔ **CORRECTION 2026-09-13: the differing references are PER-PAYMENT confirmation numbers, not card identifiers** — all 39 differ — **so the bank says nothing about how many Amex accounts exist.** 🔴 **AND A PARALLEL SESSION ESTABLISHED MORE THE SAME DAY:** the Amex year-end summaries are **"Prepared for OLEG ZAKALA", never name Zakom, and carry different card numbers in 2023 and 2024**; there is a **separate Fifth Third CREDIT CARD** the account has paid monthly since June 2024; and a **Macy's store card** is paid from the business account too |
