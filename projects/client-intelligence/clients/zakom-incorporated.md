...
- 🛑 **THE DEADLINE IS THE FIRST THING TO CHECK ON THIS CLIENT, AND DOUBLE'S DATE IS WRONG.** Double's 2025 tax project shows **2026-04-15**, which is the individual date; a calendar-year **1120-S was due 2026-03-16**, extended **2026-09-15**. ⚠️ **The `2025 7004 EXT.pdf` in Double is a SCAN WITH NO TEXT LAYER and cannot be read**, so neither its tax year nor its acceptance is established — the same defect the Vasyutyk group has. **Settle the extension before any preparation work, every year.**
