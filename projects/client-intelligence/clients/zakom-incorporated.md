...
| Other Fifth Third accounts | 🔴 **FOUR MORE EXIST** | n/a | **CK …1409 · SV …3196 · SV …2975 · CK …5830** — roughly 96,800 moved between them and the operating account in 2025, **and the firm holds statements for none.** Whose they are is unknown *(working paper §3E ③)* |
...
- [ ] 🔴 **The 2025 Amex statements.** ⚠️ **Established:** nothing card-named is in Double, the balance sheet carries a year-end card balance, and January shows two Amex payments under two references. **Inferred:** that none of the eleven unopened `stmnt` files is a card statement. January 2025 shows two Amex ACH payments with two different Amex references, so the card(s) were live. Ask for the full 2025 statements of each, **and establish whether the cards are the company's or the owner's personally** — the payments carry his name, which makes company-paid personal cards a distribution question
