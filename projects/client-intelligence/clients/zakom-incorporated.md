...
- ⛔ **AND THE LETTERS RAISE ONE QUESTION THAT DECIDES A REAL DEDUCTION:** the three letters' total interest is within 4% of the client's own separate `Interest` line, which makes it likely his interest line already IS those letters — in which case splitting the equipment line and deducting its interest too would **deduct the same interest twice**. 🔑 **One question to the client settles it, and it must not be settled by arithmetic** *(working paper §3H ②)*.
...
- 🔑 **THE COMPANY USES TWO ADDRESSES, AND BOTH ARE REAL — which bears directly on the two-states question.** Its lenders write to it at **Plantation, Florida (Broward County)** on two 2025 letters and at a **Chicago, Illinois** address on a third; the Florida one is also the shareholder's own address on the 2025 organizer and the property carrying the mortgage on his 2023 asset sheet. ⛔ **The street address is deliberately not written here or anywhere in the repo.** ⚠️ **This settles that the home the office sits in IS in Broward County; it does NOT settle whether the payments the company made to the Broward tax collector were that home's property tax or commercial vehicle registrations.**
