...
| Bank | Statements for the return | _(pending — client uploads them himself)_ | The 2025 monthly statements arrived through the organizer, not through a bank connection |
...
- [ ] **Which account each of the twelve 2025 "stmnt" files belongs to** — bank or credit card, and how many accounts. Settle it by comparing `Jan 25 Zakom.pdf` against `Jan 25 stmnt.pdf`
- [ ] **The 2025 Amex statements** — an Amex set exists for 2023 and 2024 and nothing card-named was uploaded for 2025. Ask whether the card was still open
- [ ] **2025 line-of-credit and SBA loan statements** — both on file for 2024, neither for 2025
