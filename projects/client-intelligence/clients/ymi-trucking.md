...
- 2026-09-19 — **Weekend sweep (incremental, baseline 2026-09-12→2026-09-19).** Double: note 491842's `updatedAt` unchanged (Thu Aug 13 2026 17:25:41); `list_client_properties` unchanged (Tax Return Type `1120-S`, Bookkeeping `N/A`); `list_activity_log` bounded `fromTimestamp=2026-09-12` returned zero entries. `list_contacts` re-confirms Marko Zivanovic's portal-contact record still links **seven** Double client records (unchanged from the count already on file). Gmail (YMI Trucking + Prime Road Carriers, since 09-12): routine Gusto AutoPilot payroll notices continue (Sep 5–11 pay period, confirmed and re-confirmed 09-14/09-15/09-16); a **2026-09-17 Bank of America "Business Lending" statement-notification email** for **Prime Road Carriers Inc** (a different account — "Business Advantage Travel Rewards" ending 5591 — from the one already on file), and a **2026-09-12 BofA billing-statement email for Jupiter Digital Solutions LLC** — both **re-confirm the two untracked entity names are real, continuing correspondence**, not a one-off; **no new ownership or classification evidence found on either**, and neither is a new entity name (both were already flagged 2026-09-12). No correspondence found bearing on the Texas/Indiana address question or the unexplained 7004 filer. Google Drive (title "YMI" or "Prime Road", modified since 09-12): found the same seven driver/truck-level bookkeeping spreadsheets continuing to be updated (through 09-17/09-18, confirming ongoing active operations) **plus one new file — `YMI mail 9-18-2026.pdf`, created 2026-09-18 by a Prime Road Carriers staff member (name/email withheld)** (title only, not opened — appears to be a mail-scanning/forwarding document, unconnected to the separate Vitalii Ivanov USPS matter on a different client). Ping: org-wide semantic search for "YMI Trucking Texas Indiana Form 7004 Prime Road Carriers" returned no legible, client-specific results — same non-result pattern as every prior run. **Chase pass** — see updated ages below; neither open item moved.
- 2026-09-26 — **Batch sweep (incremental, baseline 2026-09-19→2026-09-26).** Double: note 491842 re-read in full — `updatedAt` still 2026-08-13, not re-touched; `list_activity_log` bounded `fromTimestamp=2026-09-19` returned zero entries. Gmail (YMI Trucking + Prime Road Carriers + Jupiter Digital Solutions + Goncharov Group, since 09-19): found **no client correspondence at all** — not even the routine Gusto payroll notices that appeared in every prior sweep, and no fresh mention of either untracked entity name (Jupiter Digital Solutions LLC, Goncharov Group LLC) this window; the only hit was the firm's own weekly-sweep meta-email. **Read as a quiet week, not a lapse** — no evidence either entity name has disappeared, simply nothing new to corroborate or contradict it. No correspondence bearing on the Texas/Indiana address question or the unexplained 7004 filer. Google Drive (title "YMI" or "Prime Road", modified since 09-19): the same seven-plus driver/truck-level bookkeeping spreadsheets continue to be updated (through 09-24/09-25), confirming ongoing active operations; **one new, unopened file — `Prime Road Carriers Inc NTL-5629738-05.pdf`** (created 2026-09-21 by the portal contact) alongside a fresh monthly OCAC schedule report (also 2026-09-21) — title only, not opened; "NTL" is consistent with a notice of some kind but its subject is unconfirmed and it is not asserted to relate to either open IRS question. Ping: org-wide semantic search for "YMI Trucking Texas Indiana Form 7004 Prime Road Carriers address" returned no legible, client-specific results. **Chase pass** — neither open item (address, 7004 filer) moved; ages below.
...
- 🔴 **Establish the company's correct legal and mailing address, and what the IRS should hold.** Ask the client directly rather than inferring from a bank statement. If the IRS record needs changing, a **Form 8822-B** is the usual route. _(Open since 2026-03-16 — **~194 days as of 2026-09-26**. No deadline attached. Re-chased this sweep via Gmail/Drive/Ping — no movement found; this needs a direct client question, not a document search.)_
- 🔴 **Find out who filed the 2025 Form 7004 on 2026-03-14.** Not the firm, not the previous accountant. Ask the client whether they or anyone else filed it. _(Open since 2026-03-16 — **~194 days as of 2026-09-26**. Re-chased this sweep — no movement found.)_
