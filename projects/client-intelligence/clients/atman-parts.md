...
- **Entity type:** **An LLC — that much is settled.** 🔴 **Which return it files is NOT, and nobody at the firm has confirmed it yet.**
  ...
  - **`1120-S`** — said in session by Lilian on 2026-08-17 (*"por ahora estamos haciendo 1120-S"*), **but she withdrew it as uncertain the same day: "no estoy segura… tengo que confirmarlo con Julia."**

  ⚠️ **So this is NOT "two sources disagree" — it is one maintained field and one unverified recollection.** Do not treat the `1120-S` reading as evidence against Double; treat it as a **prompt to verify**, which is what Lilian asked for. **Julia is the one who knows. It is on [`FOLLOW-UPS.md`](../../../FOLLOW-UPS.md) row 41 until she answers, and this line gets rewritten from her answer.**
