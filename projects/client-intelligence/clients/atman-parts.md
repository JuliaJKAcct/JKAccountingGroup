...
- ✅ **Recurring sales-tax task exists and is being worked — updated 2026-09-12.** The Double task "Sales Tax" (renamed from "Monthly Sales tax" 2026-09-02) had its recurrence changed **from the 10th to the 5th of each month** (2026-09-02, Lilian), and was marked **Done** the same day — consistent with an on-time filing for the then-current period. A filing PDF numbered **"8. August 26.pdf"** was saved to the client's Drive "filed sales-tax returns" folder on **2026-09-02**, continuing the sequential numbering from July's ("7. July 26.pdf", 2026-08-17) — i.e. the August 2026 period appears filed/confirmed on schedule. _(Double activity log; Google Drive file metadata — filenames and dates only, not opened — 2026-09-12 sweep.)_
...
- 2026-08-22 — **Weekend sweep (incremental, baseline 2026-08-15→2026-08-22).** A recurring Double "Sales Tax" task was created 2026-08-17 (monthly, next due 2026-09-10) — resolves the "no recurring reminder" outstanding item, now marked done above. An Intuit invoice payment (#2261) was recorded 2026-08-17 (no dollar figure recorded here). A new Drive subfolder "Docs sent by client" was created 2026-08-20 in the "Atman Products" folder holding a Form 2848 (POA) for the owner, two Form 1095-A (tax year 2025 — these read as personal/1040 documents, not entity-level), a Texas Tax Registration Application Summary, one screenshot, and a file named **"TAXES PASSRDS.txt"** — filenames only were read, contents were not opened, but a file with "PASSRDS" in its name sitting loose in a client-docs folder is worth Lilian/Julia flagging to the client to move somewhere safer. Chase pass: "Sch C or 1120-S — ask Julia" and "who files sales tax" both still open, 5 days pending since 2026-08-17, no deadline; the eBay↔QuickBooks figures question stays parked (waiting on Julia's connection, not research); the Texas franchise-report filing status is still unconfirmed. Sunbiz name check and the Ping coverage gap for the bookkeeping contact were not chased this run (budget).
- 2026-08-29 — **Weekend sweep (incremental, baseline 2026-08-22→2026-08-29).** Double: no notes (none exist for this client), no property changes, no activity-log entries in the window. Gmail (business name + "atman.autoparts", `after:2026/08/22`): nothing beyond the firm's own automated weekly-sweep email — no client correspondence at all this week. Ping (`search_meetings`, scoped to "Atman Parts"): no results dated on/after 2026-08-22 — all hits pre-date the baseline. **Chase pass — every open item named and searched, nothing new arrived on any of them:**
  - 🔴 **"TAXES PASSRDS.txt" — a search of Gmail and Double notes, bounded ≥2026-08-22, on 2026-08-29, did not find any discussion of it with Lilian/Julia.** Still unresolved, **9 days pending since found (2026-08-20)**. No deadline.
  - 🔴 **Sch C vs 1120-S (ask Julia) — still unanswered, 12 days pending since raised (2026-08-17).** No deadline, but every day it sits open is a day payroll/reasonable-comp exposure (if it's really an S-corp) goes unaddressed.
  - 🔴 **Who files the sales tax — still unanswered, 12 days pending since raised (2026-08-17).** No deadline.
  - **Texas franchise-report filing status — still unconfirmed, 12 days pending since raised (2026-08-17).** No deadline found on the account; the annual report itself is due 15 May, so the next live deadline is 2027-05-15.
  - Sunbiz name check and the Ping coverage gap for the bookkeeping contact — **pending since unknown — no start date in the file**; not chased this run (budget; same as last run).
- 2026-09-12 — **Incremental sweep (baseline 2026-08-29→2026-09-12).** Double: no notes exist for this client; **the "Sales Tax" recurring task's cadence was changed to the 5th and marked Done 2026-09-02** (§4). No other activity-log entries in the window. Gmail (business name + "atman.autoparts" + "franchise" + "PASSRDS", `after:2026/08/29`, and a further `after:2026/08/01` pass specifically for franchise/Sch-C/PASSRDS): nothing beyond the firm's own automated weekly-sweep emails — **no client correspondence found at all across the whole two-week window.** Google Drive: found a new filed sales-tax return, **"8. August 26.pdf"**, created 2026-09-02 in the same folder as the prior months' filings (§4) — filename and date only, not opened. Ping (`search_meetings`, scoped "Atman Parts"): no results dated on/after 2026-08-29 — all hits are pre-baseline or unrelated-client noise. **Chase pass — every open item named and searched, nothing new arrived on any of them:**
  - 🔴 **"TAXES PASSRDS.txt" — a search of Gmail and Double notes, bounded ≥2026-08-29, on 2026-09-12, did not find any discussion of it.** **23 days pending since found (2026-08-20).** No deadline.
  - 🔴 **Sch C vs 1120-S (ask Julia) — still unanswered, 26 days pending since raised (2026-08-17).** No deadline, but every day it sits open is a day payroll/reasonable-comp exposure (if it's really an S-corp) goes unaddressed.
  - 🔴 **Who files the sales tax — still unanswered, 26 days pending since raised (2026-08-17).** No deadline.
  - **Texas franchise-report filing status — still unconfirmed, 26 days pending since raised (2026-08-17).** No deadline found on the account; next live deadline 2027-05-15.
  - Sunbiz name check and the Ping coverage gap for the bookkeeping contact — **pending since unknown — no start date in the file**; not chased this run (budget; same as the last two runs).
- 2026-09-19 — **Incremental sweep (baseline 2026-09-12→2026-09-19).** Double: `list_notes` returns none (unchanged); no property changes; `list_activity_log` bounded ≥2026-09-12 returns no entries. Gmail (business name + "atman.autoparts" + "franchise" + "PASSRDS", `after:2026/09/12`): a search of Gmail, bounded ≥2026-09-12, on 2026-09-19, did not find any client correspondence at all — only the firm's own automated weekly-sweep email. Google Drive (`title contains 'Atman'`, `modifiedTime > 2026-09-12`, `excludeContentSnippets: true`): no results — **no September sales-tax filing PDF has appeared yet** in the "Atman Products" filed-returns folder, though the recurring task now runs on the 5th; not itself evidence a period was missed, only that no new file was found. Ping (`search_meetings`, scoped clientId 763909): no legible, on-topic hits dated on/after 2026-09-12 — all results are pre-baseline noise or unrelated-client transcripts. **Chase pass — every open item named and searched, nothing new arrived on any of them:**
  - 🔴 **"TAXES PASSRDS.txt" — a search of Gmail and Double notes, bounded ≥2026-09-12, on 2026-09-19, did not find any discussion of it.** **30 days pending since found (2026-08-20).** No deadline.
  - 🔴 **Sch C vs 1120-S (ask Julia) — still unanswered, 33 days pending since raised (2026-08-17).** No deadline.
...
- ✅ **Recurring sales-tax reminder in Double — DONE.** A recurring Double task "Sales Tax" was created 2026-08-17 (tagged "Monthly Sales Tax", recurs on the 10th, next due 2026-09-10) — (Double activity log, 2026-08-22). The SOP still needs updating to reflect this (see SOP proposal below).
