...
- 🟠 **THIS HOUSEHOLD UPLOADS SCANS, AND OUR REDACTOR CANNOT READ THEM — budget a person's eyes
  for every document they send.** Three so far: the **2025 Form 1095-A** *(pages 5–8 yielded
  nothing)*, the **car finance contract** *(11 pages, no text layer at all)*, and the phone
  images `IMG_6340` / `IMG_7718` / `IMG_7719`. 🔑 **The pattern matters for planning**: the
