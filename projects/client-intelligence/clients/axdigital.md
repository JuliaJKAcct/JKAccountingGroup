...
- 🔴 **The Ukrainian employee's work-authorization/payroll question raised 2026-08-04** (call scheduled 2026-08-10) — STILL OPEN, **≈46 days** pending; the 2026-09-19 targeted search again found no outcome or follow-up.
- **New, non-tracked:** a 2026-09-15 QuickBooks-deposit/merchant-verification question, resolved by Julia the same day as "wait a few days" — monitor only, not carried forward as an outstanding item unless it recurs.
