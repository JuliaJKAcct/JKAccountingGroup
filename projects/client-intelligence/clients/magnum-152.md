...
- 🔴 **Open mapping error — Bravo "Gunshow tender" mis-mapped to the sales-tax account** (see §5 for detail) — STILL UNRESOLVED. CHASED again 2026-09-19: no reply from Igor/Luis found; now 30 days since Julia's original flag (2026-08-20), 23 days since her 2026-08-27 reminder.
- **Inventory-donation tax treatment** — STILL OPEN. CHASED again 2026-09-19: no update found; now ~58 days pending since 2026-07-23, no deadline known.
- **2025 Business Tax Organizer** reverted to draft 2026-07-31 — STILL OPEN as its own Double entity, now ~50 days; but see §4 — **the 2025 tax PROJECT was Filed 2026-09-16**, jumping over `readyForReview` entirely and without the July close ever formally closing (see the 2026-09-19 log entry). Whether the organizer-draft status is now moot, or whether it should have blocked filing, is not settled by this sweep — flag for Lilian/Julia rather than assuming either reading.
- A missing prior-period (**Apr 2024**) expense report for the sibling **Auto Pawn** entity — STILL OPEN, now ~83 days pending since the 2026-06-28 ask; CHASED again 2026-09-19 (same query as on [`sunoma-inc.md`](./sunoma-inc.md)); nothing new found there either.
- **July 2026 close — STILL not marked Done, and now with ZERO recorded task activity this window** (contrast with Sunoma, whose full July checklist completed 2026-09-17). Maria told Igor 2026-09-18 that Magnum's August 2026 report is not yet ready either (expected 2026-09-21). Pending since 2026-09-04 (last observed close-task activity), no deadline stated — worth confirming directly with Maria given the return has already filed.
