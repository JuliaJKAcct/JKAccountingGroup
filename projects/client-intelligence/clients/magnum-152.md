...
- **Process notes (→ future SOP):** the month-end sequence Maria documented —
  ...
  8. **Two named-individual bank-feed tasks confirmed on the close checklist** — "Chase N. Tucker" and "Chase I. Melomed" (each a distinct Chase account tied to a named individual, not the entity) — closed out 2026-09-04; a pre-existing part of the reconciliation set, not previously catalogued in this file. _(Double activity log, 2026-09-04)_
  9. **Monthly checklist** of standing reclasses (non-sensitive rules): Comcast (by account number), FPL (check the site against TD statements), **split Bravo across the active stores**, distribute ReadyRefresh / Waste Management / Gearfire between MS1 & MS2, rent per store, auto expenses / meals / interest / dues & subscriptions → **ADMIN class**, Amex Amazon / Dollar General / Publix → reclass to the store that incurred them, large disbursement repairs/signage → **Leasehold Improvement**, payroll-benefit health insurance → split by class.
- **Categorization quirks / quirks:** _(see §5)_

### Income tax
- **Applies?** Yes — **Form 1120-S** _(Double)_; **1099 preparation** included.
- **2025 return:** the Double tax project itself still reads `notStarted` (re-checked live 2026-09-12, no change since 2026-08-29), and the "JK 2025 Business Tax Organizer - Magnum 152" is still reverted to **draft**. **But a "Magnum152_2025_TaxLiability_Report_v4.xlsx" was created in Drive 2026-08-24/25** — the "v4" naming means at least three prior iterations exist — so estimate work on the 2025 return is actively under way even though Double's own status fields haven't moved. Worth knowing before assuming "not started" means no work has happened. _(Double `list_projects`, re-confirmed 2026-09-12; Drive, 2026-08-25)_
- 🟢 **2025 return — FILED 2026-09-16, jumping straight past `notStarted`.** `list_activity_log` bounded ≥2026-09-12 shows the "2025 Taxes" project moving `notStarted` → **`Waiting on Client Approval`** (2026-09-16 01:45, Lilian) → **`Filed`** (2026-09-16 02:17, Lilian), 32 minutes apart, with **no `readyForReview` stage recorded in between** (unlike Sunoma and Mobilesource, both of which passed through it the same week). 🔴 **This return was filed WITHOUT the July monthly close ever being formally marked Done** — a targeted `entity: EndClose` query bounded from 2026-08-01 found zero EndClose events for this client at all (not even June's), and this window's own activity log shows no close-checklist task activity, only the two project-status changes. Worth flagging per the firm's own reproduce-from-the-books method: a return filed ahead of its own formal close is a decision to confirm, not assume. _(Double `list_activity_log`, 2026-09-16)_
- 🔴 **NEW — a full asset-disposition package for the MS4 (store 4) sale was uploaded to Drive 2026-09-15, days before the return filed.** Files created/renamed that day include an **IRS Form 8594 (Asset Acquisition Statement)** ("Magnum 152 INC f8594.pdf"), a **Purchase & Sale Agreement** ("magnum psa.pdf"), a **Bill of Sale** ("magnum bos.pdf"), an **Assignment** ("magnum assign.pdf"), an **escrow document** ("magnum esccrow.pdf"), a journal-entry backup for the sale ("Magnum152_US4_Sale_JournalEntry_Backup.xlsx"), and two "MAGNUM 152, INC_Transaction Report" workbooks. One file is oddly titled "20142015MAGNUM 152, INC_Balance Sheet.xlsx" (a doubled/glitched year label — flagged, not otherwise investigated). This is the first documentary confirmation that the already-known MS4 sale (§1: "MS3 sold 2024, MS4 sold 2025") is being formally reported with Form 8594 as part of finishing the 2025 return — not previously evidenced beyond the bare fact of the sale. _(Google Drive, 2026-09-15)_
- **Reporting limit confirmed:** the Balance Sheet **cannot** be produced by individual store/class in QuickBooks — only the P&L can be split that way (the owner asked for both per-store, 2026-09-03/04; only a P&L-by-class for "Magnum Stores" could be delivered). Same limitation applies at Sunoma — see [`sunoma-inc.md`](./sunoma-inc.md). _(Gmail "Paperwork request," 2026-09-03/04)_
- 🟢 **July 2026 close — a burst of task activity landed 2026-09-23, ending the "zero activity" state flagged last week.** `list_activity_log` bounded ≥2026-09-19 shows 21 entries, all dated 2026-09-23: Monthly Journal Entries, Bravo reports, Admin expenses reclass, Check records to reclass, Performance Report vs QBO, the bank-feed transactions check, Amex CC expense reclass (Adm/MS1), Disbursement expenses, Add Deposits and Checks images, and Vendor Reconciliation were all worked and most marked Done. `list_end_closes` shows the **July 2026 EndClose (id 3388952) still reads "In Progress"** (not yet Done) despite this activity, and the **August 2026 EndClose (id 3491597) is also "In Progress."** _(Double, 2026-09-26)_
- 🆕 **Bravo access is running on a workaround, not a fix** — the same fact documented at [`sunoma-inc.md`](./sunoma-inc.md) §5 applies here too (same owner-group correspondence, same Bravo login): on 2026-09-21 Maria told Igor the team has been using **"Bill's" login** because the license created for the firm months ago has never worked. _(Gmail "Paperwork request," 2026-09-21)_
- **A "Signature" client property now reads "Signed"** (read live 2026-09-26, not previously catalogued) — consistent with the 2025 return's e-signature ahead of its 2026-09-16 filing. _(Double client properties, 2026-09-26)_
...
- 2026-09-19 — **Incremental sweep (baseline 2026-09-12→2026-09-19).** Double: `list_notes` returned 0 notes. `list_activity_log` bounded ≥2026-09-12 shows **only the two 2025-Taxes project-status changes** (`notStarted` → `Waiting on Client Approval` → `Filed`, both 2026-09-16 — see §4) — **no close-checklist task activity at all this window**, in contrast to Sunoma's sibling file where the entire remaining July checklist was completed 2026-09-17. This is a sharp difference worth watching: Magnum's return moved to Filed while its own July close checklist saw zero recorded movement. Drive: the MS4 sale-disposition package described in §4 was found via a title search bounded ≥2026-09-12 (files dated 2026-09-15, all created by Julia). Gmail: a search of `(Sunoma OR "Igor Melomed" OR "Lucky Pawn" OR "Auto Pawn" OR Magnum OR "US Pawn") after:2026/09/12` found Igor's 2026-09-17 request for **three full years (2024–2026) of P&L and Balance Sheet for BOTH Sunoma and Magnum**, again asking for a per-store breakdown; Maria replied 2026-09-18 that **Magnum's August 2026 report is not yet ready, expected 2026-09-21** — a new, specific admission that Magnum's own August close is running behind (consistent with the zero close-task activity found above). A targeted `(Gunshow OR "gun show" OR Bravo) Magnum after:2026/09/12` search found **no reply to Julia's Gunshow-tender reminder** — still unresolved, now 30 days since her original flag (2026-08-20) and 23 days since her 2026-08-27 reminder. A targeted `(Magnum OR "US Pawn" OR "Silencer Shop") ("MS1" OR login OR Uncat OR "Auto Pawn") after:2026/09/12` search found nothing new on the Silencer Shop login, the Uncat items, or the Auto Pawn April-2024 report. Ping: an org-wide semantic search for Sunoma/Magnum/Igor Melomed returned no legible, on-topic results. Chase pass on all outstanding items — results below.

- 2026-09-26 — **Incremental sweep (baseline 2026-09-19→2026-09-26).** Double: `list_notes` returned 0 notes. `list_activity_log` bounded ≥2026-09-19 shows **21 entries, all dated 2026-09-23** — a burst of July close-checklist task activity after last week's finding of zero movement (see §5 for the full task list); July's EndClose remains "In Progress" (not Done) despite the activity, and August's EndClose is also "In Progress." A **"Signature" property now reads "Signed"** (new, added to §4/§5). Gmail: the same combined search as Sunoma's `(Sunoma OR "Igor Melomed" OR "Lucky Pawn" OR "Auto Pawn" OR Magnum OR "US Pawn") after:2026/09/19` surfaced the continuing "Paperwork request" thread: Maria's 2026-09-21 note to Igor about the Bravo login workaround (added to §5), and her 2026-09-24 delivery of "the 2026 Magnum Reports" plus a request for Igor to resend several vendor passwords (Comcast among them). A targeted `(Gunshow OR "gun show" OR Bravo) Magnum after:2026/09/19` search found no reply on the Gunshow-tender mapping issue — still unresolved, now 37 days since Julia's original flag. Ping: an org-wide semantic search for Sunoma/Magnum/Igor Melomed returned no legible, on-topic results (same pattern as every prior run). Drive: not separately re-searched this run (budget; the combined Gmail chase covered the live items). Chase pass on all outstanding items — results below.

### Outstanding items (CI-only — never in the SOP)
- 🔴 **Open mapping error — Bravo "Gunshow tender" mis-mapped to the sales-tax account** (see §5 for detail) — STILL UNRESOLVED. CHASED again 2026-09-26 (`(Gunshow OR "gun show" OR Bravo) Magnum after:2026/09/19`): no reply from Igor/Luis found; now 37 days since Julia's original flag (2026-08-20), 30 days since her 2026-08-27 reminder.
- **Inventory-donation tax treatment** — STILL OPEN. CHASED again 2026-09-26: no update found; now ~65 days pending since 2026-07-23, no deadline known.
- **2025 Business Tax Organizer** reverted to draft 2026-07-31 — STILL OPEN as its own Double entity, now ~57 days; the 2025 tax PROJECT was Filed 2026-09-16, jumping over `readyForReview` entirely and without the July close ever formally closing. Whether the organizer-draft status is now moot, or whether it should have blocked filing, is not settled by this sweep either — flag for Lilian/Julia rather than assuming either reading.
- A missing prior-period (**Apr 2024**) expense report for the sibling **Auto Pawn** entity — STILL OPEN, now ~90 days pending since the 2026-06-28 ask; CHASED again 2026-09-26 (same query as on [`sunoma-inc.md`](./sunoma-inc.md)); nothing new found there either.
- 🟡 **July 2026 close — task activity RESUMED 2026-09-23 after a full week with none, but the EndClose is still not marked Done.** See the new §5 fact above: 21 task actions landed 2026-09-23, yet `list_end_closes` shows July's EndClose (id 3388952) still "In Progress." Maria delivered "the 2026 Magnum Reports" to Igor 2026-09-24 (three days after her 2026-09-18 promise of "ready Monday," i.e. 2026-09-21) — some slippage against her own stated date, though the reports did land. Worth confirming directly with Maria whether July's EndClose will be formally closed, or is being treated as superseded now that the return has already filed.
- 🆕 **Igor's 2026-09-17 request for three full years (2024–2026) of P&L/Balance Sheet for both Magnum and Sunoma, by store** — Maria's reply addressed readiness only; whether the full three-year, both-entity package was ultimately delivered is not confirmed by this sweep (the 2026-09-24 delivery is described only as "the 2026 Magnum Reports," not clearly the multi-year package). Flag for confirmation.
