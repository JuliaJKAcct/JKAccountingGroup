...
- **Current status:** 🟢 **UNBLOCKED 2026-08-18 — the document exists and it is stronger than what the city asked for.** Lilian produced a lease that names Pro Title Agency LLC as a **tenant of the property owner directly** (see the block below). ⚠️ **She said on 2026-08-18 that she was about to reply to the city with it attached — the send itself is NOT confirmed from any source**, so the first open item is to verify it went. _(Double notes, 2026-07-15; Gmail, 2026-07-29/30)_
...
- 2026-08-18 (later, same session) — **UNBLOCKED (Lilian).** She had already obtained the missing document and saved it to Drive. Read at her request: it is a **Florida Realtors residential lease signed 2026-02-26**, Synergy Mood LLC as Landlord, **Best Broker Realty LLC *and* Pro Title Agency LLC jointly as Tenant** — so Pro Title has been a direct tenant of the property owner all along, and the owner's authorisation letter is unnecessary. **Lilian said she was about to reply to the city with it attached — that send is unconfirmed here** (stated in session; no sent message was searched for). Three things recorded from it: the **leasing chain in both files was wrong** (co-tenancy, not pure sub-tenancy) and is corrected; the document **predates the 2026-07-29 email in which the firm argued no such lease could exist**, so the reply must point at the Tenant line rather than rely on the attachment being re-read; and the **use/zoning question is likely to be the next objection**, since the lease is a residential form on a single-family home. No dollar figures, contact details or signatures recorded here — two-data-homes.

### Outstanding items (CI-only — never in the SOP)
_(Double notes — live status lives in Double.)_
- ⏳ **App #40698 — CONFIRM THE REPLY WENT, then await the city.** Lilian said on **2026-08-18** she was replying with the signed Synergy Mood LLC lease attached, which names Pro Title as a tenant. _(Supersedes "awaiting a letter from the owner" — no longer needed; the lease is what the city asked for.)_ ⚠️ **The send is unconfirmed:** it was stated in session and no sent message has been looked for. **So the first action is to check Julia's sent mail for it — not to start waiting.** An unsent email everyone believes was sent is precisely the invisible stall this file's review was about. Once confirmed: **watch for the city's reply and chase it** — this application already went quiet for 19 days once.
  - ⚠️ **If they push back, it will be about USE, not occupancy** — a residential lease on a single-family home. Answer with the Best Broker precedent at the same address — its own city application was approved on this same footing (number in that client's Double note), and see the zoning gate in the [BTR SOP](../../sops/hollywood-broward-business-tax-receipt.md) §1.
  - ⚠️ **Still unsettled and now more urgent: is 1047 Buchanan the right address to license at all?** The **Coral Springs** move (below) was in progress in Jul 2026. If it completes, a Hollywood receipt needs an address transfer straight after being issued. **One question to the client would settle it** — worth asking now rather than after the city approves.
