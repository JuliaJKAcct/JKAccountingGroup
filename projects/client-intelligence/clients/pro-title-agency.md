...
- ~~App #40698 — awaiting the City of Hollywood~~ — **RESOLVED 2026-08-29: the LBTR was ISSUED.** See §4 above for the two independent confirmations (the city's 2026-08-25 email attachment named as a Local Business Tax Receipt, and the "valid until 09.30.2026" PDF saved to Drive the same day). The **one-shot chase reminder set for 2026-08-28 fired but never actually checked anything** — it reported it had no Gmail access and no push access to the repo, so it neither confirmed the send nor found the city's reply; its own local branch/commit (`pro-title-chase-2026-08-28`, `9b79f6c`) was never pushed and does not exist on `origin`. **The routine itself is broken and unmonitored going forward** — this closure came from this weekend sweep re-reading the thread directly, not from the chase mechanism working as designed. Flag to Julia/Lilian: the scheduled one-shot chase needs Gmail + repo-push access if it is to be relied on again for a similar matter.
  ...
  - ℹ️ **Unrelated lead, out of scope for this file — flag for Best Broker Realty's CI file:** a 2026-08-19 email from `businesstax@hollywoodfl.org` to Julia is an **annual renewal notice for BEST BROKER REALTY LLC's own BTR** at this same address (account `B9083146-2027`, renewal period 10/01/2026–09/30/2027, due by 9/30/2026 with tiered late penalties). Found incidentally while chasing Pro Title's matter; not folded into this file or Best Broker Realty's — someone working that client should pick it up.
