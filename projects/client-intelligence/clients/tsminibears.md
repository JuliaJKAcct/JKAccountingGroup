...
> FIRST.** Where this stands after the second DOR call:
...
>   weighing against it.
>
> The blocks above are kept for the record; they are no longer the plan.
...
#### ✅ THE PLAN OF RECORD — Julia's decision, 2026-08-06: two tracks at once
...
- **The retroactive closure is off — do not request it.** Julia wants the RT account kept open in case the company files as an S-corp and has to run payroll _(via Lilian, 2026-08-06)_. The **effective-date change replaces it**: it clears the same quarters and keeps the account.
