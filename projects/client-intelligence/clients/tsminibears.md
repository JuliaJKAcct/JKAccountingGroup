...
| Florida DOR (reemployment tax) | RT-6 quarterly reemployment tax returns | _(pending — Drive link)_ | **The account's Florida Business Partner (BP) number is in the Double case note**, not here — a full account number, per the two-data-homes rule at the top of this file. General agency phone **(850) 488-6800**. ✅ **The case has a named agent: Felesha Spence** — **her direct email and phone live in the Double case note**, per this section's own rule that contact details are not kept here _(given 2026-08-13; she is the one who must process the POA)_. POA sent 2026-08-04 **never arrived** (wrong address), **re-sent 2026-08-06 to `AcctMaint@floridarevenue.com`**, and **sent directly to Felesha Spence 2026-08-13** — see §4 |
...
> supersedes everything else here.** 🎯 **The agent who holds the case AGREED TO LODGE the
> effective-date request with Tallahassee on 2026-08-24 — the first time anyone at the agency has
> agreed to put the ask in.** ⚠️ **That she actually filed it is UNCONFIRMED** — she said she *would*,
> there is nothing in writing and no reference number, and this matter's own record is three verbal
> agency answers that did not hold. **Confirming the submission is question ① of the monitoring
> below.** The other live blocks are background: "✅ THE HONEST EFFECTIVE-DATE REQUEST" (the argument,
> still the fallback if it is refused), "✅ THE THIRD CALL" (2026-08-06), "🔴 THE POA THAT NEVER
> ARRIVED" and "✅ THE FOURTH CALL" (2026-08-13 — the named agent). **Everything before those is
> superseded and kept only for the record.** Where this stands:
...
> - **A third agent SAID the change can be made** _(2026-08-06)_ — no requirements raised, no IRS
>   letter mentioned; his only condition was **wait for the POA to process**, and he put the change
>   itself at **3–4 weeks**. ⚠️ **One verbal answer, contradicting the second — and he was never
>   asked about the IRS letter, so its silence resolves nothing.** He also had **no POA on file**,
>   so it cannot have been an answer about this account specifically.
> - 🔴 **THE POA NEVER ARRIVED. The clock restarted 2026-08-06.** The email address the agency gave
...
> - ✅ **THE FOURTH CALL, 2026-08-13 — THE POA HAS NOT PROCESSED, AND WE FINALLY HAVE A NAMED AGENT.**
>   Lilian called to ask whether it had processed. **It has not** — seven days after the re-send, not
...
> - ⭐ **THE FIFTH CALL, 2026-08-24 — THE ASK IS FINALLY BEING LODGED.** Lilian called **Felesha
>   Spence's own number**. The **POA is still not processed** — but Felesha **had the emailed DR-835
>   in her own inbox**, discussed the case anyway, and **said she would submit a request to
>   Tallahassee to change the effective date**. Lilian's write-up records **no questions about why**
>   and **no mention of the IRS letter**. See "⭐ THE FIFTH CALL".
...
>
> Everything between here and the live blocks named above is kept for the record only.
...
below (2026-08-04). On **2026-08-06** a second representative added a condition the first never
mentioned: **the agency presumes a company filing as a corporation pays a salary**, and on that
basis gates **both** the closure and the effective-date change on an IRS letter showing a filing
form with no salary requirement. **That is a presumption, not a refusal** — the current plan rebuts
it with facts. See **"✅ THE HONEST EFFECTIVE-DATE REQUEST"** below.
...
- **Filing the $0 returns is the more expensive route.** The DOR was explicit: if the account is
  left open and the missing quarters are just filed at zero, **penalties and fees for late filing
  still apply**. Closing is the free one — **but that cost is exactly what Julia now wants
  quantified before choosing**, because cheapest is not the only criterion here (see below).
- **Blocked on the POA.** _(⚠️ Corrected 2026-08-06: **that send never arrived** — the address the agency gave was wrong. Re-sent 2026-08-06; the dates below are void. See "The POA that never arrived".)_ Lilian **sent the power of attorney to the DOR on 2026-08-04**; it takes
...
#### ⚠️ Closing may be the wrong answer here — Julia's objection (2026-08-04)

The DOR's recommendation is the cheapest route, but **it is not obviously the right one for this
company, and the decision is now Julia's, not settled.**

- **Tsminibears is an S-corp.** Julia's concern is keeping the **S-corp status**, which in practice
  means being able to run **payroll** — and Florida payroll needs an RT account. _("Reasonable
  salary" is this file's gloss on her point, not her words.)_
- **Closing the account could block the next accountant from running payroll this year.** Reopening
  can be *requested* for two years with the same number, but it is **not automatic** and takes time.
  If the new accountants decide to run payroll in the current year to protect the S-corp position,
  a closed account is in their way _(Julia, via Lilian, 2026-08-04)_.
- **So Julia wants the price of the other route before deciding:** what would it cost to simply
  **file the $0 returns for all the open periods** and pay the resulting penalties and fees? She
  will weigh that against closing once she has the number. **Getting that estimate is the open
  task** — see §6.
...
- **The agency reached the same conclusion from its own side, 2026-08-06** — it **presumes** a
  company filing as a corporation pays a salary, and gates both fixes on an IRS letter showing
  otherwise. ⚠️ **That is a presumption the firm intends to rebut with facts, not a refusal** — see
  **"✅ THE HONEST EFFECTIVE-DATE REQUEST"**. Julia's objection killed the **closure**, not the date change.

#### ⚠️ The DOR's SECOND answer (2026-08-06) — it contradicts the first, and it likely settles the choice

Lilian called the Florida DOR again. This call **answers the cost question Julia was waiting on**
and **disagrees with the 2026-08-04 one** on whether the account can be closed / back-dated. Both
are single verbal statements — neither is in writing, and **nothing has been requested from or
agreed with the agency.**

> **How to read the disagreement — it is competence, not necessarily policy.** _(Lilian,
> 2026-08-06.)_ How good an answer you get depends on how well prepared the representative who
> picks up is. The **second one explained it much better and clearly knew more**. The first one
> said the account could be closed retroactively and **never raised entity type at all** — she was
> not contradicted on it, the subject simply never came up. So treat the second answer as the
...
- **Interest and certain fees are charged on those amounts** as well. _(Note this cuts against the
  ...
  writing.)_
- **The estimate: approximately $842.50.** The representative worked it out on the call. ⚠️ **He had
  NO POA on file** — the 2026-08-04 send never arrived — **so he was not looking at this account.**
  Treat the figure as an order of magnitude. **It is an estimate, not a quote** — the real figure depends on the **exact day** the returns are actually
  ...
  see §6.**
- **Where the REAL number comes from: the DOR website, one return at a time.** The representative
  said the true amount is only known **when you go to submit each form on the site** — each return
  shows its own cost there _(Lilian, 2026-08-06)_. So the firm does **not** have to get a total out
  of the agency by phone: **open the filing screens, read the per-return amounts, and add them up.**
  That also settles the scope question by itself, since the site lists every return that is
...
#### ⚠️ SUPERSEDED — Julia's two-track decision, 2026-08-06 (kept for the record)

> **Do not act on this block.** Its **Track A** (Gusto) survives, reduced — see the two blocks below.
> Its **Track B** framing does **not**: it says the effective-date request is abandoned in favour of a
> waiver, and the firm reversed that the same day. **The current plan is "✅ THE HONEST
> EFFECTIVE-DATE REQUEST"**, where the date change is the primary ask and the waiver the alternative.

Lilian briefed Julia on the whole situation and **Julia chose to run two things in parallel**, rather
than pick one of the three options above _(Julia via Lilian, 2026-08-06)_.

**Track A — go back at Gusto.** Challenge the explanation in Jeffrey's 2026-06-09 email (that Gusto
is not responsible until the first check date) and **see whether the firm can win the argument on
that side**. The premise Julia is relying on is real: **the firm paid for that service.**

**Track B — keep working the Florida DOR, and tell them plainly what happened.** The message:

- the company **has been an S-corp since 2025**;
- it **never ran payroll — the company had no money, no salary was ever set and nothing was ever
  paid**;
- there **was a payroll agent, Gusto**, which was supposed to be handling exactly this;
- so **the firm had no idea the reports were not being filed** until the client started receiving
  the notices.

**The objective Julia named:** tell the DOR that we had no idea, and **take some of the
responsibility off the firm — which is not a lie, because we paid for that service.**

⚠️ **Two things the record has to be honest about, so nobody is surprised later:**

1. **Track B abandons Option 3.** The effective-date change required showing the DOR the company
   files in a form that does **not** require a salary. Track B tells the agency the opposite — that
   it **is** an S-corp. Both cannot be sent. **Track B's real vehicle is therefore a reasonable-cause
   penalty waiver, not the effective-date request** — same facts, right instrument. **Do not send
   the IRS letter while Track B is running.** _(Firm's reading of Julia's instruction, not something
   she said — raise it with her.)_
2. **Gusto's published policy matches what Jeffrey said** — see §5. Track A is therefore not a breach
...
#### ✅ THE HONEST EFFECTIVE-DATE REQUEST — the ask, and the call checklist (Lilian, 2026-08-06)

> **Revised later the same day:** this is **what to ask for and how to argue it**. It is **no longer
> "call, then write"** — after the third call the request is made **on the phone**, and everything
> below about a written request applies only **if someone insists on one**.
...
- 🗣️ **WHAT TO EXPLAIN, IN WORDS — JULIA'S FOUR POINTS, AND THEY ALL SURVIVE.** _(Restated here
  ...
  Track B drew from them — dropping the date change for a waiver — not the explanation itself**, which
  "the honest framing" already relies on.)_
  1. The company **has been an S-corp since 2025**.
  2. It **never ran payroll** — there was no money, **no salary was ever set and nothing was ever
     paid**.
  3. There **was a payroll agent, Gusto**, engaged and paid to be handling exactly these filings.
  4. So **the firm had no idea the reports were not being filed** until the client began receiving the
     notices.
  - **Julia's stated objective:** tell the DOR **we had no idea**, and **take some of the
    responsibility off the firm — "which is not a lie, because we paid for that service."**
...
- **Ask for BOTH, in one letter, in this order.** ① **Primary — move the effective date.** If the
  account takes effect later, those quarters stop existing, there is nothing to file, **and the
...
- ✅ **Moving the date clears the penalties — Lilian's position, and it is the working assumption**
  _(2026-08-06)_: *"al mover la fecha, por supuesto que se anulan las penalidades y los impuestos"* (moving the date of course cancels the penalties and the taxes).
  ...
  - **Practical consequence: nothing to do differently now.** Proceed on the assumption. **When the
    ...
    closes it for good.
- ⚠️ **The firm is making this request without the document one representative named as a
  precondition — know that, and do not raise it.** _(Revised 2026-08-06.)_ The **second**
  representative said an IRS letter showing a filing form with no salary requirement was required.
  The firm is not sending one, for two reasons: **the third representative asked for no
  documentation at all**, and a CP575 reading "disregarded" beside a filed 1120-S would misrepresent
  the company. **Do not volunteer the point** (Lilian's decision, below) — **but expect it to be the
  most likely reason for a refusal**, so if the person raises it, answer straight and take exactly
  what they ask for.
...
> 🛑 **SUPERSEDED IN PART, 2026-08-24 — read "⭐ THE FIFTH CALL" before using the checklist below.**
> **The call this checklist describes HAPPENED on 2026-08-24, and the POA was NOT the gate:** it was
> still unprocessed, and the agency discussed the account and agreed to lodge the request anyway.
> **What survives here is the ARGUMENT and the three drafting rules** — they are the fallback if
> Tallahassee refuses. **The sequence below does not survive**, and neither does "the POA must
> process first".

**⏳ THE CALL COMES FIRST — and the letter is now only a fallback** _(revised 2026-08-06 after the
third call: it is no longer "call, then write". **Ask for the change ON the call**; a written request
is what you fall back to if whoever answers insists on one.)_ ⚠️ **The third call of 2026-08-06 was
NOT this call** — it asked only whether the date could be changed in principle, with no POA on file.
**Five things, in this order** _(written before the fifth call; items 2 and 3 are the ones it
overtook)_:

1. **The representative's name and ID — take it first.** Never captured on any of the first three
   calls, and it is what lets a favourable answer be pointed back to.
2. ~~**Has the POA processed?**~~ ⚠️ **Overtaken 2026-08-24** — it had not, and the officer worked the
   case from her own inbox regardless. Still worth asking, but **not as a gate**.
3. **Ask for the change to be made on the call.** _(From how the third representative spoke, Lilian
   understood it can be — her read of his manner, not something he stated.)_ ⚠️ **Do NOT volunteer the
   IRS letter** — Lilian's explicit decision, below. If the person insists on documentation, take
   exactly what they ask for and no more.
...
⚠️ **Ask on the phone — but do not treat a phone answer as the outcome.** This matter has now produced
**three different answers from three representatives**; a fourth call can produce a fourth. **So: ask
for the change on the call, and then get whatever is agreed back in writing.** The verbal yes is the
start of the record, not the end of it.

#### ✅ THE THIRD CALL (2026-08-06) — an agent said the change CAN be made

Lilian called again the same day. **The most favourable answer yet, and the simplest:**

- She told him the firm wants to **change the effective date on the RT account**. **He said it can
  be done.** No requirements, no explanations demanded, and **the IRS letter was never mentioned.**
- **The one condition: wait until the POA has processed.**
- **How long the change itself takes: 3–4 weeks**, once requested.

**Lilian's read, and it is the operating rule for this matter now** _(2026-08-06)_: **"every agent is
...
innecesariamente."_ (The man who took my call asked me nothing about it. If he gives me the access to
change this, why would I have to mention that letter? It would only complicate my situation
unnecessarily.) She did not raise the letter and does not intend to. **This is not dishonest —
...
1. **This is the third verbal answer and it contradicts the second** — the **second** representative gated
   the change on an IRS letter; this one did not raise it at all. **He was not asked about it**, so
   silence is not the same as "not required." The letter question is **unresolved, not resolved.**
2. **An answer obtained by calling until you get a helpful one is still only verbal**, and the person
   who actually processes the request can apply the rule the second agent described. **The
   protection is unchanged: get the acceptance in writing.** _(Firm's note, not Lilian's words.)_
3. ⚠️ **He had no POA on file either** — the 2026-08-04 send never arrived (next block). So "it can be
   done" was necessarily a **general** answer, not one given while looking at Tsminibears' account.
   **The request still has to be made and accepted once the POA clears.**

#### 🔴 THE POA THAT NEVER ARRIVED — the clock restarted 2026-08-06

**The power of attorney sent on 2026-08-04 was never delivered.** The **email address the agency gave
on that call was wrong** — per Lilian, *"no era ni parecido"* (it wasn't even close) to the correct one. The message bounced,
and **the non-delivery notice sat unread in Gmail's "Updates" tab on Julia's mailbox**. Lilian found
it there, worked out the correct address for powers of attorney, and **re-sent the same day
(2026-08-06)**.

- **Everything downstream had been waiting on a document that never arrived.** Two days of the plan
  rested on a POA the agency never received.
- ⚠️ **The re-send has NOT been confirmed delivered either** — no bounce has been seen, but nothing positively confirms arrival, and this file's own §5 rule says *"treat sent as unproven until something confirms delivery."* **Every date below hangs on that.**
  - ✅ **Re-checked 2026-08-13 — still no bounce, and this time it was looked for properly.** A sweep of
    Julia's whole mailbox for non-delivery reports since 2026-08-05 (mailer-daemon, postmaster,
    "undeliverable" / "delivery status" / "not delivered" / failure, across all tabs) returns
    **nothing**. That is the opposite of the 08-04 send, which bounced the same day. **Treat the
    re-send as very likely delivered** — but it is still not positive confirmation: **the DOR has
    never replied**, even though the covering email asked it to _("Kindly let us know when it's
    processed")_. The only proof will be the representative on the next call saying the POA is on file.
  - 📄 **What was actually sent:** the **Florida DR-835** power of attorney, in the message
    "TSMINIBEARS LLC - POA" from `lilian@` to `AcctMaint@floridarevenue.com`, **2026-08-06 15:17 UTC**,
    Julia bcc'd. The attachment is dated **2026-05-27** — i.e. the POA was **signed while Tsminibears
    was still a client**, three weeks before the Double record was archived. _(Gmail, 2026-08-13.)_
- 🔴 **BOTH DATE BANDS BELOW ARE DEAD — falsified by the fourth call, kept only to show the mistake.**
  On **2026-08-13** the POA had **still not processed**, seven days in. **Do not plan from either
  band, and do not compute a replacement** — the lesson in §5 is that the agency's 3–4 days is a
  floor, not a promise. **Ask the named agent instead.**
  - ~~**The 3–4 day processing clock restarts from 2026-08-06.** 08-06 is a Thursday, so **Mon
    2026-08-10 at the earliest on calendar days; Tue 2026-08-11 – Wed 2026-08-12 if the agency means
    business days.**~~ _(Derived from the agency's stated duration, not a date it gave. **Wrong** —
    08-13 came and went.)_
  - ~~**Realistic end-to-end timing:** POA clears ~08-10/08-12, then the effective-date change takes a
    further **3–4 weeks** → arithmetically **Mon 2026-08-31 to Wed 2026-09-09**, and realistically
    **into mid-September**.~~ _(**Void** — its premise, a POA cleared by 08-12, did not happen. The
    3–4 weeks only start once the named agent processes it, so any real resolution is later than this
    band, by an amount nobody can yet state.)_
...
#### ✅ THE FOURTH CALL (2026-08-13) — the POA has NOT processed, and the case has a named agent

Lilian called the Florida DOR to ask whether the power of attorney had been processed. **Two answers,
and the second one is the one that moves this matter.**

- 🔴 **It has NOT processed.** Seven days after the 2026-08-06 re-send — the agency had quoted **3–4
  days**. ⚠️ **So treat that figure as a floor, not a promise**, and stop deriving callback dates from
  it; this matter has now built two timelines on it and both were wrong. **The realistic resolution
  slips again**: the 3–4 weeks for the change itself only starts once Felesha Spence processes the POA.
- ✅ **THE AGENCY NAMED THE AGENT WHO HAS THE CASE — the first identified person in four calls.**
  **Felesha Spence** — **her direct email and phone are in the Double case note**, not here _(§2: a named
  person's contact details live in Double; the department mailboxes and the public switchboard below are
  routing, which is a different thing)_. Every prior call went to
  whoever picked up, was never identified, and produced a different answer; **there is now one person
  to deal with, reachable directly.**
- ⚠️ **IT DOES NOT SETTLE WHETHER THE POA ARRIVED — resist that inference, this file made it once and
  withdrew it.** Being given an agent *who has this case* looks like proof of receipt and is not: the
  **case is the RT delinquency the DOR itself opened** with the Q2/Q3 2025 notices, so it exists with
  or without a POA, and an officer can be assigned to a delinquent account with nothing on file. **And
  the call's own answer — "not processed" — reads exactly the same as "never arrived."** The standard
  is unchanged: **the only proof is a representative saying the POA is ON FILE.** Ask it in those words.
- ✅ **THE SEQUENCE, STATED PLAINLY BY THE AGENCY:** **once Felesha Spence processes the POA, call back
  and request the effective-date change.** That is the first time the route has been confirmed by
  someone other than the third representative's manner, and it matches the plan already in place.
- 📤 **Lilian sent the DR-835 directly to Felesha Spence the same day** — 2026-08-13 16:44 UTC, subject
  **"BP# … TSMinibears LLC"** _(the subject leads with the account's Florida BP number — it is in the Double case note, not here)_, Julia bcc'd, same attachment as the 08-06 send
  (`DR-835 - POA - 05.27.2026 - TSMINIBEARS.pdf`), asking to be told when it is processed. **No reply
  yet.**
- 🆕 **The account's Florida BP (Business Partner) number is now known** and is recorded **in the Double
  case note** — a full account number stays out of this file under the two-data-homes rule at the top.
  **Quote it on every future call and email** — Lilian leads her own subject lines with it, which is
  where the firm learned it. _(⚠️ **Whether the DOR actually indexes the account by it is the firm's
  inference, not something the agency said.** Nothing turns on it: quoting the number is right either
  way.)_

⚠️ **What has NOT changed:** the change itself is still **not requested and not agreed**, nobody has
been asked about the IRS letter, and **the rule to get the acceptance in writing stands.** ✅ **What
...
#### ⭐ THE FIFTH CALL (2026-08-24) — the ask is being lodged, and the decision leaves the office we can reach
...
1. 🔴 **The POA is STILL not processed** — eighteen days after the 08-06 re-send, eleven after the
   08-13 email. ⭐ **But it stopped being the gate:** Felesha **had it in her own email** and worked
   the case from there. ⭐ **That is the strongest evidence yet that the 08-13 send reached her** —
   ⚠️ **evidence, not proof, and this file has made exactly this inference once and withdrawn it.**
   Lilian's write-up says *"she found it on her email"*; **"it" is not pinned to a document**, she was
   not asked which send, and **"in her inbox" is still not "ON FILE"**. _(It says nothing at all about
   the 08-06 send to `AcctMaint@floridarevenue.com`.)_
2. ✅ **Lilian explained the situation and Felesha said she would submit a request to Tallahassee to
   ...
   office. After three weeks in which the plan was permanently one step away from being made, an
   agency officer has finally agreed to put it in. ⚠️ **What the source says is that she SAID SHE
   WOULD.** Nobody has confirmed she did: **nothing in writing, no reference number**, and this
   matter's own record is **three verbal agency answers that did not hold** (§5 — *a verbal yes is
   the start of the record, not the end*). **Treat the submission as agreed, not as done, until it
   is confirmed** — question ① below.
3. ⭐ **Lilian's write-up records that she asked NOTHING about why the firm wanted the date changed**
   — *"she didn't ask anything about why we wanted to change the date or so"* — and **records no
   mention of the IRS letter**, from the one person who has actually handled the request. ⚠️ **Read
   that for what it is: nobody has ever been ASKED whether the letter is required**, on any of the
   five calls. **The silence still resolves nothing** (§4), Tallahassee has not spoken, and the letter
   remains the likeliest shape of a refusal. ⚠️ **Do not tally the silences into reassurance** — that
   is the mistake this matter's own record warns against.
4. ⏳ **No timeline, and she declined to invent one** — *"it can be 1 month, 2 months… depends on
   Tallahassee"*, in **Lilian's rendering of what she was told**, not a verbatim quote. ⚠️ **The 3–4
   weeks from the third call is dead** — one anonymous representative's
...
6. 📬 **How a decision reaches us: a letter, if it is favourable** — and **Felesha said she will also
   call Lilian**. ⚠️ **Lilian asked how she would be told, and the answer covered only the favourable
...
**📡 THE MONITORING PLAN — this is the stage a matter gets dropped at, and it is SCHEDULED, not
remembered.** ⚠️ **Neither this file nor `FOLLOW-UPS.md` is read by anything on its own, and this
client is deliberately excluded from the weekend Client-Intelligence sweep** (archived in Double), so
a cadence written here and nowhere else is exactly the mechanism that missed the 2026-08-19 date. **A
one-shot Claude Routine fires the first check-in** — its trigger ID is in §6.
...
- **Five questions every time, and ① is the new one:** ① **was the request actually submitted, and
...
- **Watch BOTH mailboxes** for anything from `floridarevenue.com` quoting the account's **BP number**
  ...
  outbound copy and would never receive the answer. **Searching Julia's mailbox alone proves nothing.**
...
- **⚠️ ONE Florida DOR representative gated BOTH fixes on the entity's federal filing form, and asked for a letter from the IRS to prove it.** ⚠️ **Treat this as one representative's requirement, not agency policy: a THIRD representative the same day accepted the effective-date request and never mentioned a letter at all.** Per that second representative _(2026-08-06)_: if the company files **as a corporation**, it takes it that a **salary must be paid**, and on that basis **gates both the closure and the effective-date change** on **a letter from the IRS stating how the company files its taxes**, showing a form with **no salary requirement** (a **Schedule C** / disregarded-type entity). **The letter is required for the closure as well as for the date change — only filing the late zeros needs no letter.** ⚠️ **Read that as a PRESUMPTION, not a refusal.** An entity that genuinely files as a corporation but has **never paid wages** can rebut it with evidence rather than deny it — that is the route Tsminibears is taking (§4). So **establish the entity type before promising anyone a closure or a date change — and raise it yourself on the call, because a representative may never bring it up** (the one on 2026-08-04 didn't).
...
- **The late-filing charge, as the agency states it: $25 for each month a report is late**, plus **interest and certain fees on those amounts**. _(Florida DOR, 2026-08-06 — this **confirms** what had only been an unverified reading of the RT-6N instructions. Note the agency described interest/fees on the penalty amounts, which cuts against the intuition that "zero wages → no tax → no interest".)_ Any total the agency quotes is an **estimate**: the $25 keeps accruing, so the real figure depends on the **day the returns are actually submitted**. On Tsminibears, ≈**$842.50** — ⚠️ **quoted by a representative with no POA on file, i.e. not from the account itself.**
  - **Don't chase the exact total by phone — it is on the filing screens.** Per the DOR, **each delinquent return shows its own cost when you go to submit it on the website**. That gives the real per-return amounts *and* the true list of outstanding periods in one place. _(Florida DOR via Lilian, 2026-08-06.)_
...
- **The DOR takes an effective-date request by email, with an IRS letter attached — per ONE representative.** ⚠️ **A third representative the same day raised no documentation at all; do not carry this to another client as a settled requirement.** The request explains the situation, states there are **no employees**, that the company **does file taxes**, that it is **not** an entity type requiring a mandatory salary, and **the date requested**. The address the agency gave is **`fdorspanish@floridarevenue.com`** (its Spanish-language channel). ⚠️ **That last element is what the agency asks for; it is NOT what to write for a client that genuinely does file as a corporation.** There, the honest route is to state the entity type and **rebut the salary presumption with evidence of zero wages** — see the Tsminibears §4 block. **Which IRS document satisfies it is NOT established** — the agency described what the letter must *say*, not which form it is. Confirm before sending.
- **Acting on a Florida DOR account needs a POA on file, and the agency says that takes 3–4 days.** It will not take the instruction until the power of attorney is processed. Send the POA first and build the wait into the plan — the substantive call is a **second** call, several days after the first. _(Basis: the 2026-08-04 call.)_ **And changing an effective date takes a further 3–4 weeks after that** — _one representative's figure, third call 2026-08-06, still verbal_ — so a matter like this runs a month, not a week.
  - 🔴 **THE 3–4 DAYS IS A FLOOR, NOT A PROMISE — DO NOT DERIVE A CALLBACK DATE FROM IT.** _(Tsminibears, 2026-08-13: **seven days** after the re-send the POA still had not processed.)_ This matter built **two** timelines on that figure and both were wrong — the first because the send had bounced, the second because the agency was simply slower than it said. **Don't compute a date; call and ask whether it has processed.** The call is free, it costs one phone call to replace a guess with a fact, and on this occasion it produced the single most useful thing in the whole matter (below).
  - ⭐ **ASK WHO HAS THE CASE — it is the highest-value question on any agency call, and nobody thinks to ask it.** _(Tsminibears, 2026-08-13.)_ Three calls had gone to whoever picked up, none of them identified, each giving a different answer. The fourth call asked a plain status question and came back with **the named agent handling the case, with her direct email and phone**. That converts an anonymous queue into one person you can reach, chase and quote. **Ask it on the first call, not the fourth**, and quote the account's own reference (in Florida, the **BP / Business Partner number**) in every message. ⚠️ **A named officer is a contact, not an authority** — she can be chased, but a verbal answer from her still needs to come back in writing like any other.
- **🔴 VERIFY AN EMAIL ADDRESS AN AGENT GIVES YOU OVER THE PHONE — AND THEN CHECK IT WAS DELIVERED.** _(Tsminibears, Aug 2026: the POA address given on the 2026-08-04 call was wrong — "no era ni parecido" — the send bounced, and two days of the plan rested on a document the agency never received.)_ Three habits:
...
- ⭐ **AN UNPROCESSED POWER OF ATTORNEY IS NOT ALWAYS THE GATE — ASK THE NAMED OFFICER TO ACT NOW.**
  ...
  processed"* as a precondition — and **not on one person's word: two separate agency contacts said
  it** (the third representative on 2026-08-06, and the fourth call on 2026-08-13, which stated the
  sequence plainly enough that this file recorded it as the agency's own position). When Lilian
  finally reached the **named officer** on her own line, the POA was **still** not processed — and it
  did not matter: the officer **had the emailed POA in her own inbox**, discussed the case, and
  **agreed to lodge the request**. **That two agency statements said "wait" and asking anyway still
  worked is the uncomfortable half of this lesson, and the half worth carrying.** **So: email the document straight to the named officer AND ask her to act on it now.
...
- _(2025-12-19)_ — QuickBooks subscription found disconnected; client asked to restore it and send October/November statements. _(Gmail)_
...
- _(2026-08-04, Lilian)_ — **Called the Florida DOR — the agency recommended a resolution path** (recommended, not agreed: nothing has been requested or accepted yet). Its recommendation: **close the RT account retroactively to May 2025**, which **avoids all penalties and fees**; the company can then **request** reopening **without a new number** for **2 years**. The agency also warned that **leaving the account open and filing the missing $0 returns would still incur late-filing penalties and fees** — so the zero-return route Gusto pointed to was never the cheap one. Lilian **sent the POA** to the DOR the same day; it needs **3–4 days** to process before she can call back and request the closure. _(⚠️ **That send never arrived** — wrong address, discovered and re-sent 2026-08-06.)_ Reported to Julia by WhatsApp and recorded here. _(Full detail in §4; the firm-wide lesson in §5.)_
...
- _(2026-08-06, Lilian)_ — **Called the Florida DOR a second time — and the agency contradicted its own 2026-08-04 answer.** It now presents **two options**. **(1) File the zero returns and pay** — **$25 for every month a report is late**, which is what produces the figures on the notice the client received, **plus interest and certain fees on those amounts**; the representative estimated the total at **≈$842.50**, expressly an **estimate** because it depends on the exact submission date. The account stays open. **(2) Move the effective date** (Julia had suggested **October 2026**) — **but the agency presumes a company filing as a corporation pays a salary**, and on that basis gates both the closure and the date change on an **IRS letter stating which form the entity files** _(Lilian supposes the SS-4 — flagged as her supposition; see §4)_, sent by **email to `fdorspanish@floridarevenue.com`**. **On the day this read as closing the route off for an S-corp.** _(⚠️ Superseded later the same day — a presumption is rebuttable with facts, and the firm's plan is now to make the request honestly, stating the entity type and evidencing zero wages. See §4, "✅ THE HONEST EFFECTIVE-DATE REQUEST".)_ _(Full detail in §4; the firm-wide lessons in §5. Representative's name and call reference **still not captured**. **Double case note 485230 rewritten in place the same day** — same note, per the [`double-mcp`](../../../.claude/skills/double-mcp/) skill §7.)_
...
- _(2026-08-06, Lilian — third pass, and it changes the shape of the choice)_ — **Two more corrections.** (1) **The agency never named the document.** She asked for **"a letter from the IRS stating how the company files its taxes"** and nothing more — *"ella no me dijo el nombre, yo fui la que estaba asumiendo con su aplicación"*. **CP575 is the firm's own identification**, so the record now states the requirement the agency's way and the CP575 only as our reading. (2) **Closing the account needs that same letter.** The representative said so explicitly — so the closure is **not** the letter-free route it looked like, and **Options 2 and 3 hit the same wall**. Only Option 1 (file the zeros and pay) needs no letter at all. **Recast §4 as three options** on this basis. Lilian asked for the summary for Julia in the same message — written and delivered to her this session, in **chat, not committed**. (3) Also from the same call: **the real cost is only known on the DOR website** — each return shows its own amount when you go to submit it — so the total doesn't have to be extracted from the agency by phone. **The summary for Julia was then simplified at her direction:** drop the $25-per-month mechanism (Julia doesn't need it), give the ≈$842 estimate plainly, and state the 1120-S point as the fact it is rather than as an explanation of things she already knows.
- _(2026-08-06, Lilian)_ — **Opened the Double case note for this matter** — "CASE · Florida Reemployment Tax (RT) account" (note **485230**; the title carries a status suffix that changes every time the case moves, so only the stable prefix is recorded here — [`double-mcp`](../../../.claude/skills/double-mcp/) skill §7 rule 5) on the archived client record — so the whole team can read the history start to finish without digging through the Gmail thread. It carries the status, both routes with their trade-offs, the pending DOR call, and the dated timeline. **This file stays the master; the note is the team-facing mirror and gets rewritten in place — never duplicated — whenever this matter moves** _(the convention is now in the [`double-mcp`](../../../.claude/skills/double-mcp/) skill §7)_. _(The first version of the note was written before PR #138 was pulled and understated the hold; corrected the same day, and the lesson is now a rule in the skill.)_
...
- _(2026-08-06, Lilian → firm)_ — **Checked whether Gusto's explanation is actually its policy, at Lilian's request.** It is. Gusto's Help Center says **"We do not file any returns, including $0 returns, until you report wages and taxes in a state"** and puts the earlier $0 returns on the employer; another article says Gusto's authorization begins with **the quarter of the first check date** and that it **cannot help** with a notice for an earlier period; the **Payroll Service Terms** require **at least one processed payroll** before Gusto files and keep the company **solely responsible** to the taxing authorities. **⚠️ At the time of this entry all of it was search-result summary — `support.gusto.com` and `gusto.com/legal/terms/payroll` both returned HTTP 403 to automated retrieval.** _(Superseded the same day: **Lilian opened the pages herself and confirmed the wording** — §5. Screenshotting them is still open.)_ _(Links in §7; the method in §5.)_
...
- _(2026-08-06, Lilian — 🔴 the POA was never delivered)_ — **The power of attorney sent on 2026-08-04 never reached the agency.** The **email address the representative gave on that call was wrong** — *"no era ni parecido"* (it wasn't even close) to the right one. The message bounced and the **non-delivery notice sat unread in Gmail's "Updates" tab** on Julia's mailbox; Lilian found it there, worked out the correct address for powers of attorney, and **re-sent the same day**. **So the 3–4 day clock restarts from 2026-08-06** — Mon 2026-08-10 at the earliest, Tue 08-11 to Wed 08-12 if the agency counts business days — **and with the 3–4 weeks the third agent quoted for the change itself, this realistically resolves in early-to-mid September 2026.** ⚠️ **The correct POA address was not recorded at the time of this entry** _(✅ supplied the same day — `AcctMaint@floridarevenue.com`; see the next entry)_. _(The firm-wide lesson is in §5: verify an address an agent gives you by phone, then confirm the send was delivered.)_

- _(2026-08-06, Lilian — closing the two questions from the third call)_ — **The POA address, and two decisions.** (1) ✅ **The correct address is `AcctMaint@floridarevenue.com`** — Florida DOR account maintenance, and **a different address from `fdorspanish@floridarevenue.com`**, which the second representative gave for the effective-date request. (2) ⭐ **The letter may not be needed at all:** the third representative asked nothing about documentation, and from the way he spoke Lilian understood **the change can be done on the call itself** once the POA is on file. **So the plan is now: call and try to get it done there; the letter is the fallback if someone insists.** (3) 🎯 **She deliberately did not raise the IRS letter and will not** — *"si él me da el acceso a cambiar esto, ¿para qué tendría yo que mencionar esa carta?"* (if he gives me the access to change this, why would I have to mention that letter?) Not a misstatement, just not volunteering a requirement one representative mentioned; **her call, and nobody else should raise it either.** **The Double case note 485230 was rewritten in place in the same pass.** (4) **On the penalties: her position is that moving the date cancels them**, which is sound — if the account starts later, those quarters stop existing. _(Recorded with one precision: the "avoids all penalties" statement of 2026-08-04 was about **closing** the account; nobody has been asked it about a date change, so this is the firm's inference. Nothing changes in practice — proceed on it, and confirm the notice balance shows cleared once the change goes through.)_

- _(2026-08-13, Lilian — gap-check, no new action taken)_ — **Lilian asked for a recap of the matter and
  which date the effective date was meant to move to. Answer: October 2026** (Q4 2026 — Julia's
  figure; the honest framing behind it is *"from the quarter wages actually begin"*, which does not
  depend on that specific month). **The recap was given in chat; nothing was requested from or agreed
  with the agency in this session.** Three things came out of closing the gap since 08-06:
  **(1) ⏰ THE POA WINDOW HAS ELAPSED AND THE FOURTH CALL IS OVERDUE** — 3–4 days from the 08-06
  re-send landed Mon 08-10 to Wed 08-12; **it is now Thu 08-13 and no call is on record.**
  **(2) ✅ No bounce on the re-send** — a full sweep of Julia's mailbox for non-delivery reports since
  08-05 returns nothing, the opposite of the 08-04 send. **Still not positive confirmation: the DOR has
  never replied** despite the covering email asking it to. **(3) 📄 The POA is the Florida DR-835,
  dated 2026-05-27** — signed **while Tsminibears was still a client**, three weeks before the Double
  record was archived, which bears on the open authority question. Ping holds **no meeting** on this
  matter since 08-06 (the DOR calls are phone calls it does not capture). _(Sources: Gmail + Ping,
  2026-08-13. Detail in §4.)_

- _(2026-08-13, Lilian — FOURTH DOR CALL, and it is the one that unblocks the matter)_ — **She called to
  ask whether the POA had processed. It has NOT** — seven days after the 08-06 re-send, against the
  agency's quoted 3–4 days. **But the agency named the agent who has the case: Felesha Spence**
  _(her direct email and phone are in the Double case note)_ — the **first identified person in four calls**,
  after three anonymous representatives gave three different answers. **The representative also stated
  the sequence plainly: once Felesha processes the POA, call back and request the effective-date
  change.** Lilian **sent the DR-835 directly to Felesha the same day** (2026-08-13 16:44 UTC, subject
  **"BP# … TSMinibears LLC"** _(the subject leads with the account's Florida BP number — it is in the Double case note, not here)_, Julia bcc'd, same attachment, asking to be told when it is
  processed — no reply yet), which is also how the account's **Florida BP number** entered the record;
  it is held in the Double case note, not here, being a full account number. ✅ **Two open items close:**
  the **re-send reached the agency** (inferred — it could not assign an agent to a document it never
  received; receipt was not expressly confirmed), and **we finally have a named contact.** ⚠️ **Nothing
  else moved:** the change is still not requested and not agreed, the IRS letter has still not been
...
- _(2026-08-24, Lilian — gap-check, no action taken)_ — **Eleven days on, nothing has moved.** Lilian
  ...
  **one message and no reply**, both Double notes (`485230` Part 1 / `491836` Part 2) still carry
  ...
  searches behind that negative: **Julia's** Gmail — the only mailbox this connector reads — on the
  client and agency names since 2026-08-12,
...
- _(2026-08-24, Lilian — ⭐ FIFTH DOR CALL, and it is the one that finally lodges the ask)_ — **She
  called Felesha Spence on her own line and an agency officer has, for the first time, AGREED TO LODGE
  the effective-date request with Tallahassee** — ⚠️ **agreed, not confirmed done: she said she
  *would* submit it, and there is nothing in writing and no reference number.** The **POA is still not processed** — eighteen days after the re-send — **but it
  stopped being the gate: Felesha found the emailed DR-835 in her own inbox** and worked the case from
  there, which is the **strongest evidence yet that the 08-13 send reached her** — ⚠️ **evidence, not
  proof: "in her inbox" is not "ON FILE", and this file withdrew this same inference once before**
  _(and nothing follows about the 08-06 send to `AcctMaint@floridarevenue.com`)_. Lilian explained the situation; Felesha said she would **submit a
  ...
  ✅ **Double case note `485230` (Part 1, the live note) rewritten in place the same day** — body
  measured at **7,364 characters** (7,452 with the title) against the ~7,500 request-size wall, nothing
  pushed out to Part 2 (`491836`), no third note opened. **It carries the same corrections this entry
  does** — *agreed, not confirmed done*; *evidence, not proof*; the five check-in questions; and the
  mailbox trap.
- _(2026-08-24, Lilian — 📡 THE WATCH IS SCHEDULED, not remembered)_ — **A one-shot Claude Routine now
  fires the first check-in: `trig_01418WCAJnNHsweVawBZErYS`, "TSMinibears FDOR — chase Felesha Spence",
  due 2026-09-15 13:00 UTC**, with push + email notification to the owner. It carries the five
  questions, the both-mailboxes trap and the do-not-write-the-BP-number rule, and its step 6 is to
  **re-arm the next one (~3 weeks, then monthly) and record the new ID here** — or to stop, if the
  matter has resolved. **Why it exists:** this client is **archived in Double and therefore excluded
  from the weekend Client-Intelligence sweep**, and neither this file nor
  [`FOLLOW-UPS.md`](../../../FOLLOW-UPS.md) is read by anything on its own — so the cadence written on
  2026-08-13 had nothing to fire it, and it was missed. ⚠️ **KNOWN LIMIT — the Routine stores NO MCP
...
- ⚠️ **PARTLY ANSWERED 2026-08-06 — the price of the "file the $0 returns" route was put at ≈$842.50** _(FL DOR estimate; see §4)_. This was the number Julia asked for on 2026-08-04 — **but the representative had no POA on file, so it was not quoted from the account.** The authoritative figures are the per-return amounts on the DOR filing screens.
- ✅ **The summary for Julia was written, delivered and acted on, 2026-08-06.** She chose two parallel tracks; the DOR track then became **the honest effective-date request with a waiver alternative** — see §4, "✅ THE HONEST EFFECTIVE-DATE REQUEST". Grouped below as **Track B (DOR)**, **Track A (Gusto)** and **General**.
...
- **Keep Option 1 alive as the floor:** if neither ask lands, the outstanding zero returns still have to be filed and paid — **the per-return amounts are on the DOR filing screens.**
...
- ✅ **Done:** Lilian read Gusto's published pages first-hand and they say what the support reply said (§5). **Still to do: screenshot them, and get the 2025 version of the terms** — the version in force during the penalty periods is the one that matters.

**GENERAL — to settle whichever route is taken.**

- **Confirm the scope of the ≈$842.50 before treating it as the number — and the cheapest way is the DOR website, not another call.** It is unclear whether the representative priced **all** the open periods (Q2 2025 → the last closed quarter) or only the periods Lilian named, and it is an **estimate** that moves with the submission date. Per the agency, **each return shows its own cost on the filing screen**, so opening the site gives both the real per-return amounts and the true list of outstanding periods.
- **Confirm whether the $25 is per report or per month overall.** The agency said "$25 for each month it is late"; whether that accrues **per delinquent return** changes the total materially across five-plus quarters. Also ask **whether the accrual is capped**, and get the **interest and fee** components itemised.
- **Get the operative answer in writing.** **Three representatives have given three different pictures** — 2026-08-04 recommended a retroactive closure and never raised entity type; the second call on 2026-08-06 gated both fixes on an IRS letter; the third, the same day, accepted the date-change request and never mentioned a letter. **All three verbal, none identified, and none of them had a POA on file.** **Nothing should be paid or filed on the strength of a phone call.**
- **The retroactive closure is dead — do not request it.** Julia wants the RT account kept open in case the company files as an S-corp and has to run payroll _(via Lilian, 2026-08-06)_. The **effective-date change replaces it**: same quarters cleared, account kept.
- **Read the client's CP575, and establish whether a Form 2553 / CP261 exists and when.** ⚠️ **Not a gate on the call** — the current plan does not send the CP575 (§4). But the firm should know what its own documents say before the agency asks, and the 1120-S for 2025 means an S-election exists somewhere; find the paperwork.
- **Who pays the ≈$842.50 has not been decided or discussed.** The firm owns the resolution, the company is a former client, and nobody has raised the money question with either Julia or the client. **Settle it before anything is filed or paid.**
- **Obtain the new DOR notice from the client** and confirm which quarters it covers — if it names a quarter after Q3 2025, the RT account is still active and accruing, and whichever route is taken has to sweep those quarters too. The firm has still never seen it.
- **Tell the client BEFORE the firm acts on their state registration.** Tsminibears is a former client and the firm would be acting under POA; changing the effective date of their RT account is a real change to their state registrations. Get their acknowledgement first. _(Carried over from the closure-era plan — the obligation survives the change of route.)_
...
- [x] **A named contact at the DOR — ✅ FELESHA SPENCE**, the agent who has this case _(given on the
  fourth call, 2026-08-13)_. **Deal with her directly from here** — **her email and phone are in the
  Double case note**, since a named person's contact details do not live in this file (§2).
- [ ] **The representative's name / ID and a call reference for the FIRST THREE calls** (2026-08-04 and
  the two on 2026-08-06) — **none was captured**, and the three contradict each other. Unrecoverable in
  practice; kept so nobody mistakes those three answers for attributable ones. **Keep taking the name
  and ID on every future call** — Felesha may not be the one who picks up.
...
- [ ] **Once the change goes through: confirmation that the penalty balance on the notice shows CLEARED.** The firm is proceeding on the assumption that moving the date cancels the already-assessed Q2/Q3 2025 penalties (§4). **This is the one check that proves it** — it falls due weeks after the call, so it lives here rather than only on the call checklist.
- [ ] **Confirmation that the 2026-08-06 re-send actually arrived. STILL OPEN — and the fourth call did
  NOT close it.** What the call gave: no bounce exists, and the agency could name **an agent who has
  this case**. ⚠️ **That is weaker than it first looked, and this file briefly recorded it as settled.**
  The "case" is the **RT delinquency the DOR itself opened** when it issued the Q2/Q3 2025 notices — it
  exists whether or not a POA was ever received, and an agency routinely assigns an officer to a
  delinquent account with nothing on file. **The answer the call actually gave — "it has not been
  processed" — is indistinguishable from "it never arrived."** So the standard this file set on
...
- [ ] **Whether a written effective-date request must go to `fdorspanish@floridarevenue.com` in Spanish, or whether an English channel exists.** ⚠️ **Bears on this now: `AcctMaint@floridarevenue.com` was discovered 2026-08-06 and is not a Spanish-language address** — so the agency plainly has more than one route in. Only matters if someone insists on a written request.
- [ ] **Whether the signed POA actually covers changing the effective date on the RT account** — who signed it and when. _(Re-pointed 2026-08-06: the closure is dead; the POA is now the critical path for the date change.)_ The relationship ended in June 2026, so authority should be confirmed, not assumed — **and the client has still not been told.**
  - ✅ **Partly answered 2026-08-13 — the form and its date.** It is the Florida **DR-835**, and the
    document is dated **2026-05-27**, i.e. **signed while Tsminibears was still a client** and three
  ...
  - ⚠️ **STILL OPEN after 2026-08-24, and now with a live request riding on it.** A request was
...
- **Double case note — the team-facing history of the RT matter. ⚠️ IT IS NOW IN TWO PARTS**, split
  2026-08-13 when the fourth call pushed the body past Double's ~8,000-character wall _(Lilian
  authorised the split; the discipline is in the [`double-mcp`](../../../.claude/skills/double-mcp/)
  skill §7, "When it genuinely doesn't fit")_. Both are "CASE · Florida Reemployment Tax (RT)
  account" on the client record above:
  - **Part 1 — note `485230`. THE LIVE NOTE.** Status, the named agent, the next action, what to say
    on the call, and the recent timeline. **Every new entry goes here.**
  - **Part 2 — note `491836`. ARCHIVE ONLY.** The background and the 2026-05-28 → 2026-08-06 history
    pushed out of Part 1. **Never add to it.**
  - **They mirror this file and are updated in the same pass whenever this matter moves.** **Never open
    a third note** — when Double raises the limit, collapse the two back into one.
- **Gmail — the POA sent to the named agent:** thread **"BP# … TSMinibears LLC"** _(the subject leads with the account's Florida BP number — it is in the Double case note, not here)_,
  `lilian@` → **the named agent at the Florida DOR**, 2026-08-13, Julia bcc'd, attaching
  `DR-835 - POA - 05.27.2026 - TSMINIBEARS.pdf`. _(The earlier send is the thread "TSMINIBEARS LLC -
  POA" to `AcctMaint@floridarevenue.com`, 2026-08-06.)_
...
- **Gusto's published policy — ✅ read first-hand by Lilian 2026-08-06; still to be screenshotted** _(all returned HTTP 403 to automated retrieval, so a person had to open them; §5)_:
  ...
  - [What to do if you get a tax notice from an agency](https://support.gusto.com/article/106621962100000/What-to-do-if-you-get-a-tax-notice-from-an-agency-for-admins)
