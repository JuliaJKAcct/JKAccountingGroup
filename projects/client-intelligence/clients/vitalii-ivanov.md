...
> 🔴 **STILL LIVE 2026-09-19 — the USPS mail-forwarding order covering this couple AND THREE US
> companies was due to EXPIRE 2026-09-18 (YESTERDAY).** USPS Informed Delivery digests addressed to
> Tetiana kept arriving daily **through and including 2026-09-18 itself** — so the order had not
> lapsed early. **No digest for 2026-09-19 was found in this sweep**, and **no renewal action, no
> lapse notice, and no client conversation about it was found anywhere.** Read this as **unconfirmed
> either way**, not as a lapse — a same-day digest may simply not yet be indexed. **This needs a
> person to check directly, today.** See §5 and §6.
...
- 🔴 **Settle the foreign-entity reporting position for each of the four companies**, for 2025 and prior years — **5471, 8865 or 8858 depending on classification**, and 50% may put some of them outside 5471 entirely. _(Open since at least 2026-08-14 — ~36 days as of 2026-09-19. Re-chased this sweep — an unbounded Drive title search for 5471/8865/8858/"Extreme Pride"/"Best Way Foods" and an unbounded Gmail search found NO further work specific to these four companies since the 2026-08-20/21 FBAR/8938 workpapers — the 2025 return was filed 2026-09-01 with this question's resolution still unconfirmed. This remains the single most important open question on the file: find out from the preparer whether it was settled before filing or is still owed.)_
- 🔴 **The mail-forwarding order for this couple and three companies was due to EXPIRE 2026-09-18 — that date has now passed.** _(Open since 2026-08-14, ~36 days as of 2026-09-19.)_ Re-chased this sweep: USPS Informed Delivery digests addressed to Tetiana confirmed arriving on **every day from 09-13 through 09-18 inclusive** — forwarding did not lapse early. **No digest for 09-19 was found, and no renewal action, lapse notice, or client conversation was found anywhere.** **This is now urgent and unresolved rather than merely approaching** — someone needs to check directly with USPS or the client today whether the order was renewed, and decide whether a permanent address change is now the right move.
