...
- ⚠️ **Correct the Double record** — `platform`, `Bookkeeping` and `Payroll` all understate what is actually happening here. _(Open since 2026-08-14 — ~36 days as of 2026-09-19. Re-chased this sweep — properties unchanged, still uncorrected.)_
...
- **Confirm the 2025-08-25 FL DOR "Communication" (encrypted) was a routine audit follow-up**, not a new matter — found but not opened 2026-08-29, still unopened; ~390 days old at the underlying date (2025-08-25) and ~21 days since first flagged (2026-08-29). Re-chased again this sweep with a targeted Gmail search — **still not found**, and no further correspondence on it exists in any source searched. **This should be escalated for someone to open the original encrypted item directly rather than searched for again** — two full historical passes and two incremental chases have all failed to surface it a second time.
- 🆕 **Decide whether the Oct–Nov 2024 encrypted FL DOR "Power of Attorney" correspondence** (found on [`grigoriy-margarita-melomed.md`](./grigoriy-margarita-melomed.md), re-chased there 2026-09-19 with no movement) **is an earlier phase of this client's 2025 sales-tax audit** (§4) or a separate matter, and whether it belongs in this file. _(Flagged 2026-09-12, re-flagged 2026-09-19 — not decided or written here, per that file's own scope.)_
