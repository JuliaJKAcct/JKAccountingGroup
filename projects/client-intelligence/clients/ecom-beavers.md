...
- **Post-consult deliverables** Julia committed to (2026-07-09) — STILL OPEN, ~65 days pending since 2026-07-09, no deadline. An unbounded chase-pass search for entity/treaty/ITIN/minutes/checklist terms again found no evidence any of these went out.
- **Payment-reliability watch** — not re-chased this run (budget; low priority, no deadline).
- Confirm **home state** and revisit the **sales-tax nexus** question — STILL OPEN, no deadline. A search bounded `after:2026/08/29`, on 2026-09-12, found nothing beyond routine Shopify billing notices. (See the Delaware correspondence lead already on file, which bears on formation state but not operating state.)
- 🆕 **Confirm the relationship between this client and EB2 LLC** — STILL OPEN; an unbounded search for "EB2 LLC"/"Ecom Beavers OÜ"/Kocherzhuk found no new correspondence directly on point since the 2026-08-13/14 Drive discovery already on file, beyond the unconfirmed Wise-invite data point above.
