...
- 🔴 **A FORM 5472 DUTY IS ON THIS CLIENT'S FILE, AND ITS PREMISE CONTRADICTS WHAT §1 SAYS THE ENTITY IS. UNSETTLED — SETTLE IT BEFORE THE NEXT RETURN.** The firm holds a position paper (Julia, **2025-03-26**) describing a **foreign-owned single-member LLC with no U.S. physical presence, dropshipping from China**, treated as a **disregarded entity** whose income is **not effectively connected** — on which the filing is **Form 5472 with a PRO-FORMA 1120**, due 15 April (15 October on extension), and **failure to file costs $25,000 a year**. ⚠️ **But §1 of this file records the client as an LLC taxed as a C-CORPORATION filing a real Form 1120**, and as selling on **Amazon with warehouse/inventory operations** — which is the classic fact that defeats "no U.S. physical presence". **Both are recorded; which governs is not established.** ⚠️ **Also unexplained: the paper predates the engagement by fourteen months** (§1 dates onboarding to ~May 2026, first consult 2026-07-09), so it may have been written for a different structure or a different stage. **Either way a 5472 duty is live for a foreign-owned LLC — confirm it is being filed.** _(TaxDome notes, migrated — filed under Ecom Beavers LLC; paper dated 2025-03-26.)_
...
- 🔵 **Additional, independent corroboration of the "disregarded entity" reading (found 2026-08-22).** A 2025-03-26 Gmail thread has Julia telling the firm's outside consulting CPA: *"We moved forward with filing tax return as single member LLC"* — Julia's own contemporaneous statement, same date as the position paper already on file, reinforcing the disregarded-SMLLC/Form-5472 reading at that point. Does not resolve the §1/§5 contradiction with the C-corp/Form-1120 record — a second dated source on the "disregarded" side. _(Gmail, 2025-03-26)_
- A 2026-02-03 email exchange between Julia and the **Delaware Division of Corporations** (subject line: a Delaware **service-request number** for ECOM BEAVERS LLC — the number itself stays in Gmail, not here) shows the firm corresponding directly with Delaware about this entity — separate from the EB2 LLC Delaware filing already on file. A Delaware *filing* correspondence is not proof of the *operating* state, so this is a lead on formation state, not a settlement of "home state." _(Gmail, 2026-02-03; found 2026-08-22)_
...
- 🆕 **A related new entity has surfaced: EB2 LLC (Delaware, State File Number 10677487, formed 2026-06-26), wholly owned by "Ecom Beavers OÜ", a private limited company organized in Estonia.** A capital-contribution letter (Google Drive, drafted 2026-08-13) has **Oleh Kocherzhuk** — identified from the 2026-07-09 consult note as the "second participant" (Ping consult, contact `liciu17@gmail.com`) — signing as a Management Board Member of Ecom Beavers OÜ, acting on behalf of the sole member of EB2 LLC. A dedicated Drive folder for EB2 LLC (created 2026-08-07) also holds an **IRS Form 147C** (EIN-confirmation letter), so EB2 LLC already has an assigned EIN. ⚠️ **Whether EB2 LLC is/will become a JK engagement, and exactly how it relates structurally to this Double client (Ecom Beavers LLC, cid 706686) — same ownership group via the shared "Ecom Beavers" name across three now-known entities (the Estonian OÜ, this Delaware LLC engaged with us, and the new EB2 LLC) — is NOT established. Confirm before assuming EB2 LLC belongs to this file or needs its own.** _(Google Drive, 2026-08-13/14)_
...
- 2026-09-12 — **Weekend sweep (incremental, baseline 2026-08-29→2026-09-12 — the 2026-09-05 run never completed, see `sweep-state.md`).** Double: `list_client_properties` unchanged; `list_notes` still 1, unchanged since 2026-07-09 (`updatedAt` re-confirmed); `list_activity_log` (from 2026-08-29) returned zero entries. Gmail bounded `after:2026/08/29` for "Ecom Beavers" found only routine Somma Shopify billing notices (2026-08-31, 2026-09-10 — figures not retained); a second search for "EB2 LLC"/Kocherzhuk surfaced the same two Shopify notices plus one **low-confidence, unconfirmed hit** — a Wise ("You've been invited to a business account") email to Julia dated 2026-09-03, matched by the search but not clearly about this client or EB2 LLC from its own content; flagged as a possible new-banking-relationship lead, not confirmed. Ping `search_meetings` (several phrasings on entity structure/treaty/ITIN/EB2/Delaware) returned no legible new content — same semantically-loose, off-topic pattern as every prior run. Google Drive: a title search for "Ecom Beavers" bounded to `modifiedTime > 2026-08-29` returned zero files — no new or modified documents in the window (the existing 4–5 folders were not independently re-listed this run). `FOLLOW-UPS.md`/`BACKLOG.md` grepped for "Ecom Beavers"/"EB2 LLC"/"Kocherzhuk" — no hits. **Chase pass** (unbounded) on all four outstanding items below — no arrivals found on any of them; ages updated.
- 2026-09-26 — **Manual incremental sweep, baseline 2026-09-19→2026-09-26.** Double: `list_client_properties` unchanged; `list_notes` still 1 (461774), `updatedAt` unchanged since 2026-07-09; `list_activity_log` (from 2026-09-19) returned **zero entries**. Gmail bounded `after:2026/09/19` for "Ecom Beavers"/"EB2 LLC"/Kocherzhuk found only routine Shopify billing (a BoneX domain-registration charge, 2026-09-24) and, on the Kocherzhuk angle, **two Wise emails dated 2026-09-21** — "You've been invited to a business account" and, 35 seconds later, "Iuliia Kononova accepted their invite," both to Julia's own inbox. 🔑 **This weakens the earlier low-confidence Wise lead (2026-09-03) rather than strengthening it**: the accepting name is Julia's own (a Cyrillic-to-Latin spelling of "Julia Kononova"), consistent with Julia setting up her own/the firm's Wise account rather than anything tied to Ecom Beavers or EB2 LLC. Not proof either way, but the balance of evidence now leans toward "unrelated." Google Drive: a title search for "Ecom Beavers" bounded to `modifiedTime > 2026-09-19` returned **zero files**. Ping and `FOLLOW-UPS.md`/`BACKLOG.md` not independently re-queried this pass (same non-result pattern on every prior sweep; budget). **Chase pass (unbounded) on all four outstanding items** — no arrivals on any of them; ages below.
- 2026-09-19 — **Weekend sweep (incremental, baseline 2026-09-12→2026-09-19).** Double: `list_client_properties` unchanged; `list_notes` still 1 (461774), `updatedAt` unchanged since 2026-07-09; `list_activity_log` (from 2026-08-29, re-checked) returned zero entries in this window. Gmail bounded `after:2026/09/12` for "Ecom Beavers"/"EB2 LLC"/Kocherzhuk found **nothing at all beyond the internal weekly-sweep digest** — not even a routine Shopify/Mercury billing notice matched this window (a quieter window than any prior sweep). Ping `search_meetings` (entity structure/treaty/ITIN/EB2/Delaware phrasings) returned no legible content specific to this client — same off-topic pattern as every prior run. Google Drive: a title search for "Ecom Beavers" bounded to `modifiedTime > 2026-09-12` returned **zero files**. `FOLLOW-UPS.md`/`BACKLOG.md` grepped — no hits. **Chase pass (unbounded) on all four outstanding items** — no arrivals on any of them; ages below.

### Outstanding items (CI-only — never in the SOP)
- **Post-consult deliverables** Julia committed to (2026-07-09) — STILL OPEN, ~79 days pending since 2026-07-09, no deadline. An unbounded chase-pass search for entity/treaty/ITIN/minutes/checklist terms again found no evidence any of these went out.
- **Payment-reliability watch** — not re-chased this run (budget; low priority, no deadline).
- Confirm **home state** and revisit the **sales-tax nexus** question — STILL OPEN, no deadline. A search bounded `after:2026/09/19`, on 2026-09-26, found nothing at all client-specific. (See the Delaware correspondence lead already on file, which bears on formation state but not operating state.)
- **Confirm the relationship between this client and EB2 LLC** — STILL OPEN; an unbounded search for "EB2 LLC"/"Ecom Beavers OÜ"/Kocherzhuk found no new correspondence directly on point since the 2026-08-13/14 Drive discovery already on file. ⚠️ **The 2026-09-03 Wise-invite lead now looks LESS likely to be related** — a 2026-09-21 Wise thread shows the same kind of invite being accepted under Julia's own name, suggesting the earlier lead may simply have been the firm's own banking setup, not an Ecom Beavers/EB2 LLC signal. Not dropped, but downgraded.
