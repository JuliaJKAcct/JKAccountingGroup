...
- 🔴 **Reconcile the engagement with the work.** The firm does monthly books for two operations while Double says `Bookkeeping = N/A`. Whatever the truth, the column, the scope and the billing should agree. _(Open since 2026-08-14 — ~36 days as of 2026-09-19. Re-chased this sweep — the mismatch deepened again: a new "Paperwork request" thread (09-17→09-18) and continued Sunoma monthly-ledger exchanges, and the property is still unchanged.)_
- 🟡 **Settle what the 2025 1040 carries** — moving, not closed. _(Open since 2026-08-14 — ~36 days as of 2026-09-19.)_ 🆕 **2026-09-19:** Julia is now actively working this return — she asked Igor directly for **"Schedule C for Lena's business"** (2026-09-14), the same day he forwarded her a "Klondike Fine Jewelry 2025" item from Yelena's own email. A candidate answer (Klondike Fine Jewelry, possibly Yelena's Schedule C business) has surfaced but is **not confirmed** — see §5. Confirm what Klondike is, whether it is the Schedule C Julia asked for, and whether the 4868 was accepted.
