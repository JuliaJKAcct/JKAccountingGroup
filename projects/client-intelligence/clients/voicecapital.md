...
- 2026-08-13 — **File created** from Lilian's own call notes, kept on her phone before the firm used Claude. _(Lilian's iCloud notes, migrated — folder "Voicecapital Inc"; note dated 2026-03-16.)_ The operational detail — what the agent said — is in the **Double case note** (§7), which stays the durable home. ⓘ *The §6 log below also records the two MyFax transmission numbers, surfaced by the 2026-09-12 sweep: a toll-free fax number is not client data, and the two are what distinguish the 2026-03-16 fax from the 2026-04-28 one.* _(Worked by Lilian.)_
...
- 2026-09-26 — **Batch sweep (incremental, baseline 2026-09-19→2026-09-26) — nothing new found.** Double: note 491840 re-read in full — `updatedAt` unchanged (2026-08-13); `list_activity_log` bounded `fromTimestamp=2026-09-19` returned zero entries. Gmail: a plain "Voicecapital" search since 09-19 found only correspondence about an unrelated client (Valentin Volzhanskiy's 2025 return questions) and the firm's own weekly-sweep meta-email — a false-positive keyword collision, not client content. A combined "Voicecapital"/"Voxago" + "overdue"/"invoice"/"payment"/"2848"/"power of attorney"/"S-election"/"8822" search since 09-19 found nothing beyond that same noise. Ping: org-wide semantic search for "Voicecapital S-election IRS 2553 C-corp address overdue invoice" returned no legible, client-specific results — same non-result pattern as every prior run. Google Drive: not re-searched this run (budget prioritized to Vitalii Ivanov's USPS deadline and the other six clients in this batch; no Gmail/Double movement to suggest a document search would surface anything). **Chase pass** — see updated ages below; nothing moved on any item.
...
- 🔴 **Find out whether the IRS accepted the S-election after the 2026-03-16 fax.** STILL OPEN, pending since 2026-03-16 (**~194 days as of 2026-09-26**). No deadline recorded. Re-chased this sweep — still no confirmation either way; the "2025 Taxes" project shows Filed regardless (see §5, unreconciled). **This must be resolved by calling the IRS directly** — no further document search will surface it. Gates the 2023 return being processed, the 2025 return's classification, and whether the company owes anything as a C-corp.
- **Correct the company's address with the IRS** (a Form 8822-B is the usual route) — STILL OPEN, pending since 2026-03-16 (**~194 days as of 2026-09-26**), not confirmed done; no new evidence found this sweep.
...
- **Confirm the purpose of the 2026-04-28 Form 2848 fax** — STILL OPEN, pending since 2026-04-28 (**~151 days as of 2026-09-26**); re-chased this sweep — found nothing beyond the already-known MyFax transmission receipt, which confirms the fax was sent but not its content or purpose.
- **The firm's own invoice to this client is now ~128 days overdue** as of 2026-09-26 (originally due 2026-05-21) — re-chased this sweep, no payment/collections correspondence found; a billing-relationship fact worth flagging to whoever manages collections.
