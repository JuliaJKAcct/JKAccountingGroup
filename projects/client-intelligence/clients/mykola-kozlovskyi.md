...
| Healthcare.gov / Marketplace | Health coverage → Form 1095-A → Form 8962 | _(n/a — client's own account)_ | The 2024 policy covered the whole household on **one** policy; the 2025 position is settled — the form is in hand and filed in Double, and the allocation is agreed at 50/50 (§6) |
...
- ✅ **THE MARKETPLACE POLICY IS AGREED WITH HIS EX-WIFE — 50 / 50** _(Lilian, 2026-08-19)_. The 2024 joint return reconciled **Marketplace coverage on Form 8962**, and a return with advance payments is **rejected without it**. Filing separately, **Part IV requires an allocation percentage and every return sharing the policy must carry the same figures** — here the policy is shared by three returns, but **the adult daughter reported nothing from the form**, so the two parents take 100% between them and only one allocation is needed. ⓘ **The rules are pairwise in principle**: with his ex-wife it is the *divorced-during-the-year* situation, so the split is **by agreement** — and **50/50 is that situation's own no-agreement default**, which is what makes it the most defensible number available. 🔑 **In money it is neutral**, because everyone's required contribution works out at zero — it is a **consistency** question. ✅ **The 2025 Form 1095-A is in hand and filed in Double**, covering **the whole household including all three minor children**.
...
- **2026-08-18 (Lilian, later the same day)** — **His return became computable, and one of the session's own statements was corrected.**
  - 🟡 **Head of household — two tests of three, and the third is now ruled rather than evidenced.** He was **unmarried at 31 December 2025** ✅, the two middle daughters lived with him all year ✅, and **he paid his housing costs from his savings** — which answers **who** paid, and is precisely what Pub 501 Worksheet 1 asks (*what you paid*; the source of the money is irrelevant). ✅ **On the PERIOD, Lilian ruled on 2026-08-19 that they lived apart and that he has a different address** — which also disposes of a lease on his ex-wife's apartment that **names him as a co-tenant**. ⚠️ **What is still thin is the EVIDENCE for the months before the separation**, on both sides. ⓘ **Worth $0 to him** — with a negative income, Single produces the identical return.
...
- **2026-08-19 (Lilian)** — **The Form 8962 allocation was settled at 50 / 50** with his ex-wife. **The adult daughter filed her own return and reported nothing from the 1095-A**, so the two parents reconcile the whole policy between them — no gap, no overlap, and only **one** allocation to enter rather than two pairwise ones. 🔑 **50/50 is also the no-agreement default under Allocation Situation 1**, so it needs no justification beyond the instruction itself. ✅ **It removes an ordering trap:** under the enrolled-by-tax-family split it replaces, a Form 8332 would have moved a child between tax families and changed the percentage. **An agreed 50/50 does not depend on who claims which child.** ⓘ In money it changes nothing on either return.

### Tax year 2025 — the review

- **What gates the return.** ✅ **(1)** The **company's 1120-S**, which produces his K-1 and his Form 7203 — **completed and on `main`** _(2026-08-18)_. ✅ **(2)** The **Form 8962 / Marketplace allocation** — **settled 2026-08-19 at 50 / 50** with his ex-wife.
...
- **Analysed 2026-08-18:** the dependants split — residence settled, the claim recommended as ONE Form 8332, now the parents' decision. **Still open:** who paid for the household's home January–August (head-of-household test 2).
- **Questions put to the client:** **none yet.**

### Outstanding items (CI-only — never in the SOP)

- ✅ **THE FORM 8962 ALLOCATION IS SETTLED — 50 / 50 with his ex-wife** _(Lilian, 2026-08-19)_. The 2025 Form 1095-A is in hand and **filed in Double**: it is in his name and covers **six people** — both parents, all three minor daughters, and the adult eldest daughter. **She filed her own return and reported nothing from the form**, so the two parents reconcile the whole policy between them. 🔑 **50/50 is also the no-agreement default under Allocation Situation 1.** ✅ It also removes an ordering trap — an agreed 50/50 does not depend on who claims which child, where the enrolled-by-tax-family split it replaces would have. ⚠️ **One thing on the form still wants an answer:** the second-lowest-cost-plan figure **jumps in September**, the signature of a household or address change reported to the Marketplace — **confirm what was reported and when**, because the form's own cover letter says an unreported change can make that column wrong.
...
- ✅ ~~The company's 1120-S must land before his return is finalised.~~ **It is on `main`** — the K-1 and Form 7203 figures in his working paper tie to it. **Re-read that paper rather than quoting a figure from memory** if the company's numbers are ever revised.
