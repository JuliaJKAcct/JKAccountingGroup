...
| Healthcare.gov / Marketplace | Health coverage → Form 1095-A → Form 8962 | _(n/a — client's own account)_ | The 2024 policy covered the whole household on **one** policy; the 2025 position is settled — the form is in hand and filed in Double; only the allocation percentage is open (§6) |
...
- **What gates the return.** ✅ **(1)** The **company's 1120-S**, which produces his K-1 and his Form 7203 — **completed and on `main`** _(2026-08-18)_. 🟠 **(2)** The **Form 8962 / Marketplace allocation percentage**, which cannot be settled without his ex-wife and their adult daughter — **the only input still outstanding.**
...
- **Analysed 2026-08-18:** the dependants split — residence settled, the claim recommended as ONE Form 8332, now the parents' decision. **Still open:** the Marketplace allocation percentage, and who paid for the household's home January–August (head-of-household test 2).
