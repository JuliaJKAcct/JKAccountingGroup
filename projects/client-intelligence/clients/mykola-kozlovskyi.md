...
- 🟡 **CHASE PASS, 2026-09-19 (5 items, all unbounded Gmail/Ping/Drive searches; ages counted from the date each was first raised in this file):**
  - Whether he had a **W-2** from any source in 2025 — **not found.** Raised 2026-08-18 → **32 days pending.** Gmail search of his own address found only a 2024-year `W2 - Megabai` thread (2025-02-14, a different, former company) — not a 2025 document. No deadline.
  - What was reported to the **Marketplace in September 2025** — **not found.** Raised 2026-08-19 → **31 days pending.** No deadline; low stakes (§5 — the figure it would affect is not currently binding).
  - Confirmation of the **three counter deposits** on Kolo's books (23 May / 7 Jun / 20 Aug 2025) — **not found** in Gmail, Ping or Drive. Raised 2026-08-19 (as a company-side blocker) → **31 days pending**, and per the new finding above the return may have been filed without this closing. **No deadline stated, but it now bears on a return Double shows as already filed.**
  - **Who** the company's 2025 `Contract Labor` payee was — **partially answered**: the 1099 question is closed (no 1099 owed, Lilian 2026-08-18), but the identity is still unnamed. No new source found it. Raised 2026-08-18 → **32 days pending** on the identity alone.
  - **Material participation** on the K-1 loss, in writing — **not found.** Raised 2026-08-19 → **31 days pending**, unchanged; still "almost certainly met" but not documented.
...
- [ ] Whether he had a **W-2** from any source in 2025 _(chased 2026-09-19, unbounded Gmail — not found; 32 days pending)_
- [ ] What was reported to the Marketplace in September 2025, and when _(chased 2026-09-19 — not found; 31 days pending)_
- [x] ~~Whether a 1099 is owed on the company's 2025 `Contract Labor` payee~~ — **No** _(Lilian, 2026-08-18, per `FOLLOW-UPS.md` row 46)_
- [ ] **Who** the company's 2025 `Contract Labor` payee actually was — identity alone, still open _(chased 2026-09-19 — not found; 32 days pending)_
- [ ] Whether **material participation** on the S-corporation loss is established in writing _(chased 2026-09-19 — not found; 31 days pending)_
- [ ] 🛑 **NEW 2026-09-19 — whether the return that was actually FILED matches the working paper's last analysis**, given the filed-vs-blocked contradiction above (no age — this is a new finding, not a re-ask)
