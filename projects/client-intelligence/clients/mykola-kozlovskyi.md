...
- 🔴 **NO EARNED INCOME HAS BEEN IDENTIFIED FOR EITHER PARENT IN 2025 — which kills the EIC and the additional child tax credit for both.** The company paid **no W-2 wages** and there was **no Uber**; an S-corporation ordinary **loss** is not earned income and neither are distributions. Both credits **require** it, and the 2024 joint return collected a substantial amount of them. ⚠️ **Not the same as proving there is none** — a W-2 from another employer is unconfirmed for him, and [her income](./liliia-hlebova-kozlovska.md) is the firm's top open question. 🔑 **The lead to run down first:** the company's 2025 1099 walk shows a **`Contract Labor` payment over the 1099 threshold, in three Zelle transfers, to an individual on the shareholder side** — identify that payee. ⓘ **The net premium tax credit is NOT ruled out by any of this** — it is a refundable credit that turns on **filing status**, not earned income.
...
- 🔴 **THE FORM 8962 ALLOCATION — one Marketplace policy shared by THREE separate returns.** The 2025 Form 1095-A arrived on 2026-08-18 in his name and covers **five people**: both parents, the two middle daughters and **the adult eldest daughter, who has already filed her own return**. So the policy has to be split across three returns, the percentages must total **100%**, and **the daughter's filed return may already constrain the other two — find out what she claimed.** ⚠️ **Two surprises on the form:** the **youngest daughter is not on the policy at all** although she was a dependant on the 2024 return (confirm what coverage she did have — a child that age in this income band is usually on Medicaid or CHIP), and the second-lowest-cost-plan figure **jumps in September**, which is the signature of a household or address change reported to the Marketplace. ⓘ Superseded — the form is no longer missing: Searched on 2026-08-18: **Double** (every file in both of their libraries, folder by folder), **Google Drive** (files titled `1095`, plus a folder-by-folder walk of both client folders and every subfolder — Drive is an exact mirror of Double here), and **Julia's Gmail** (the term `1095`; both household addresses as `from:`/`to:`; everything naming either surname since 2026-01-01). **What those searches found was the 2024 form and nothing for 2025** — a statement about those searches, not proof the document does not exist anywhere. ✅ **The obvious candidate was opened and is NOT the form:** `scan_Feb-15-2026_11-50-10.pdf`, attached to the organizer's 1095-A question, is a **health-insurance member ID card**. 🔑 **What that card does give us is the carrier**, which is a Marketplace insurer — so the form downloads from Healthcare.gov or the carrier's own member portal, and the client can be told exactly where to get it instead of being asked for it blind.
- ✅ **THE RESIDENCE FACTS ARE SETTLED, AND BOTH PARENTS CAN BE HEAD OF HOUSEHOLD** _(Lilian, 2026-08-18)_: **the two middle daughters lived with him all year, the youngest lived with her mother all year, and the eldest is an adult who filed her own return.** Each parent therefore has their **own** qualifying child, which is exactly what the rule requires. 🔑 **What is still open is not who they live with but who CLAIMS them**: the payable credits need **earned income**, his ex-wife now has it and he does not, so the two children who live with him are **worth nothing on his return**. **A Form 8332 moves the child tax credit to her without moving head of household away from him.** ⓘ Previously open as one question: **HOH is not automatic for either of them; the three tests are worked through in his working paper** (`projects/tax-returns/mykola-kozlovskyi/2025-form-1040.md`) — the same child cannot give both parents HOH, two people cannot each pay more than half the cost of the same home, and **the divorce date decides whether either is even eligible**. 🔴 **And HOH here is not about the standard deduction: filing status is the PREMIUM-TAX-CREDIT gate.** If the marriage had not ended by 31 December, **married filing separately cannot take the credit at all**, and HOH under §7703(b) is the only route to it — which on the 2024 scale is the largest figure in play.
...
- 🟠 **His 2025 housing costs, and who paid them — nothing at all is on file.** Required for head of household, and the firm holds not one figure.
