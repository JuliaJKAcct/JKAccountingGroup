...
- **Process notes (→ future SOP):**
  - **2025 tax project:** [`2025 Taxes`, cid 709838 / project 218726](https://app.doublehq.com/tax-return?cid=709838&projectId=218726) — 🔴 **status `filed` as of 2026-09-19** _(Double `list_projects`/`list_activity_log`, read 2026-09-19)_: `filedAt` **2026-08-20T19:55:59Z**, and every project task (`Prepare tax return`, `Review tax return`, `Send draft return & e-file authorization`, `File tax return`, `Follow up on tax payments`, `Send final returns to client`) was marked Done the same evening (2026-08-20T19:58:56Z). A signed-signature-request PDF (`KozlovskyiMykola2025.pdf`) was filed to his 2025 folder at 16:54 that day. **Kolo Florida's own 2025 tax project (cid 706626 / project 220509) was marked `filed` the same evening too**, `filedAt` **2026-08-20T19:56:44Z**. ⚠️ **This SUPERSEDES "ahead of his ex-wife's, `inProgress` as at 2026-08-18" above** — both companion facts are kept for the trail.
  - 🛑 **UNRESOLVED CONTRADICTION, recorded rather than settled — read before relying on either return.** The working paper's own status header (`Last updated: 2026-08-20`) and [`FOLLOW-UPS.md` row 46](../../../FOLLOW-UPS.md) (also last touched 2026-08-20) both still read **"DO NOT TRANSMIT YET"**, citing blockers that neither source records as closed: (a) a K-1-input transposition — contributions entered as `65,652` where the ledger's net figure is `65,562`, which overstates his ending Form 7203 stock basis by ~90; (b) three counter deposits (dated 23 May, 7 Jun, 20 Aug 2025) booked as shareholder capital contributions on nothing but their own classification — if they were takings they are the company's revenue, which would shrink the K-1 loss, his Schedule E and his NOL carryforward into 2026; (c) Kolo's Schedule B question 14a answered "No" when a by-payee sweep found two payees over $600; (d) three blank pages from an unrelated business (Form T, Form 4797, Schedule D) left attached to the 1120-S. **No source read on 2026-09-19 (Gmail, Ping, Drive, Double notes/activity log) records any of these four being closed out**, yet Double shows both returns as filed. ⛔ **Do not assume the transmitted return matches the working paper's last analysis, and do not assume the working paper is more current than what was filed** — write both facts with their sources and ask Lilian which is true, per the CI skill's contradiction rule.
  - 🔑 **Historical note, kept for the trail:** his return had been said to be unable to finish before the company's, because the K-1 and Form 7203 both come off the 1120-S — see §5 and the working paper linked in §7. Both are now (per Double) filed regardless.
...
- 🛑 **BOTH HIS AND THE COMPANY'S 2025 RETURNS SHOW AS `filed` IN DOUBLE (2026-08-20 evening), WHILE THE WORKING PAPER AND FOLLOW-UPS STILL RECORD FOUR OPEN BLOCKERS FROM THE SAME DAY.** _(Found on the 2026-09-19 sweep — see §4 and §6.)_ Neither is resolved here: the K-1-input transposition (contributions `65,652` vs. the correct `65,562`, overstating his ending Form 7203 basis), the three unconfirmed counter deposits on Kolo's books (23 May / 7 Jun / 20 Aug 2025 — takings vs. contributions), Kolo's Schedule B 14a, and three misattached blank pages. **Nothing found on the 2026-09-19 sweep shows these were fixed before filing.** Treat neither the filed status nor the working paper's "do not transmit" as more authoritative until Lilian says which is true.
...
- **2026-09-19 — FIRST-EVER FULL HISTORICAL SWEEP (unbounded), and the biggest finding is a contradiction, not a fact.**
  Sources read to exhaustion: Double (`get_client`, `list_client_properties` for both his record and Kolo Florida's, `list_notes` — **zero notes on this client record**, `list_contacts`, `list_activity_log`, `list_projects`, `list_files`), Ping Assistant (`resolve_person`, `search_contacts`, org-wide `search_meetings` for his name and Kolo Florida — only generic noise came back, no meeting with content specific to him), Gmail (`in:inbox` and `in:sent` for his name, "Kolo Florida", and his own address, unbounded), Google Drive (`search_files` for "Kozlovskyi" and "Kolo Florida", `excludeContentSnippets: true`), and the repo (`FOLLOW-UPS.md`, `BACKLOG.md`, `projects/sops/` — no SOP match, and no candidate for one; this client is tax-prep only).
  - 🛑 **Double shows BOTH his 2025 tax project and Kolo Florida's marked `filed`, `filedAt` 2026-08-20 evening** — see §4. **The working paper and `FOLLOW-UPS.md` row 46, both also last touched 2026-08-20, still record the return as blocked.** No source read today shows the blockers being closed before filing. **Written up as a contradiction, not resolved** — see §4 and §5.
  - ✅ **`FOLLOW-UPS.md` row 46 partially answers an open item:** the Contract Labor 1099 question is **settled — no 1099 is owed** (Lilian, 2026-08-18); **who the payee actually was is still unnamed.** Reflected below.
  - 🟠 **Kolo Florida Inc has an active WEEKLY Gusto payroll running through at least 2026-09-17** (Gmail: recurring "Time to run payroll" / "Action required: Payroll is late" notices to Julia and `kolofloridainc@gmail.com`, dated through 2026-09-17). This is **2026** payroll activity, so it does not touch anything on his 2025 return — but it sits oddly next to "the company's payroll stopped" and the company's `Payroll: N/A` property, and against `kolo-florida.md`'s "winding down, no longer a client" status. **Flagged for that file's owner, not resolved here** — see the report's Kolo-Florida lead.
  - No new documents found for any of the chased items below (W-2 from another employer, the September 2025 Marketplace report, the digital-asset transaction, his own bank account, or confirmation of the three counter deposits). Each is reported below with its age and source of the search, not as "no movement."
  - A search of the repo, unbounded, on 2026-09-19, did not find a candidate SOP for this client (individual 1040 only) or any other mention of him outside `client-intelligence/` and `tax-returns/`.
...
- 🛑 **NEW, 2026-09-19 — THE FILED-VS-BLOCKED CONTRADICTION.** Double marks both his and Kolo Florida's 2025 returns `filed` (2026-08-20 evening); the working paper and `FOLLOW-UPS.md` row 46 (both also last touched 2026-08-20) still list four unresolved blockers from that same day. **No chase found either side updated since.** This is the single highest-priority item in this file — see §4 and §5. **For Lilian: which is current — was a corrected return filed, or does the filed return carry the known defects?**
  🔁 **RE-VERIFIED 2026-09-26 — STILL THE SAME STATE, NOT RESOLVED.** Double `list_client_properties` for both this client (709838) and Kolo Florida (706626) is unchanged since 2026-09-19: `Ext. Filed: true`, `Signature: Signed`, `Invoice: Paid` on his record; Kolo Florida's `Invoice` moved from Sent to Paid but its tax-project/filed status is otherwise unchanged. `list_notes` still 0 on both. `list_activity_log` bounded ≥2026-09-19 returns 0 entries on this client's record (Kolo Florida's only new entry is its "Sales Tax" task — the *sales-tax* filing, not the 1120-S — moving to Done 2026-09-21; see [`kolo-florida.md`](./kolo-florida.md)). No Gmail, Ping or Drive search this sweep found any document, note or correspondence closing the four 2026-08-20 blockers (the K-1 transposition, the three counter deposits, Schedule B 14a, or the three misattached blank pages). **This is a re-verification only, per this run's explicit instruction — not an attempt to resolve it.** The question for Lilian stands exactly as posed above.
- 🟡 **CHASE PASS, 2026-09-26 (5 items, all unbounded-scope Gmail/Ping/Drive searches; ages counted from the date each was first raised in this file):**
  - Whether he had a **W-2** from any source in 2025 — **not found (re-chased 2026-09-26).** Raised 2026-08-18 → **39 days pending.** No new Gmail hits since the 09-19 pass. No deadline.
  - What was reported to the **Marketplace in September 2025** — **not found (re-chased 2026-09-26).** Raised 2026-08-19 → **38 days pending.** No deadline; low stakes (§5 — the figure it would affect is not currently binding).
  - Confirmation of the **three counter deposits** on Kolo's books (23 May / 7 Jun / 20 Aug 2025) — **not found (re-chased 2026-09-26)** in Gmail, Ping or Drive. Raised 2026-08-19 (as a company-side blocker) → **38 days pending**, and per the standing finding the return may have been filed without this closing. **No deadline stated, but it now bears on a return Double shows as already filed.**
  - **Who** the company's 2025 `Contract Labor` payee was — **partially answered**: the 1099 question is closed (no 1099 owed, Lilian 2026-08-18), but the identity is still unnamed. No new source found it (re-chased 2026-09-26). Raised 2026-08-18 → **39 days pending** on the identity alone.
  - **Material participation** on the K-1 loss, in writing — **not found (re-chased 2026-09-26).** Raised 2026-08-19 → **38 days pending**, unchanged; still "almost certainly met" but not documented.
  - _(Budget did not reach: the 2025 digital-asset transaction on the joint organizer, and his own bank account for a refund/payment — carried forward unchased below at "no movement found," not "checked and clear.")_
