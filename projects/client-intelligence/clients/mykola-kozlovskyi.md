...
- 🔴 **HE HAS NO EARNED INCOME IN 2025 — and neither, on the current picture, does she.** The company paid **no W-2 wages** and there was **no Uber**; an S-corporation ordinary **loss** is not earned income and neither are distributions. **The earned income credit and the additional child tax credit both REQUIRE earned income**, so on what is known today **neither parent qualifies for a single refundable credit in 2025** — where the 2024 joint return collected a substantial amount of them. ⚠️ **The one fact that can change this is [her 2025 income](./liliia-hlebova-kozlovska.md)**, which is why that question outranks the dependants split rather than following it.
...
- 🔴 **The dependants split with his ex-wife, and head of household with it** — both decided off **one table: each child, and the nights in each parent's home in 2025**. Deferred by Lilian on 2026-08-17. **HOH is not automatic for either of them and the three tests are worked through in the [working paper](../../tax-returns/mykola-kozlovskyi/2025-form-1040.md#-head-of-household--the-analysis-before-anyone-assumes-it)** — the short form is that the same child cannot give both parents HOH, two people cannot each pay more than half the cost of the same home, and **the divorce date decides whether either is even eligible**.
...
- **His 2025 return working paper — where every figure lives:** [`projects/tax-returns/mykola-kozlovskyi/2025-form-1040.md`](../../tax-returns/mykola-kozlovskyi/2025-form-1040.md)
- **The company's working paper, behind his K-1 and Form 7203:** [`projects/tax-returns/kolo-florida-inc/2025-form-1120s.md`](../../tax-returns/kolo-florida-inc/2025-form-1120s.md) — **the only place the firm keeps return figures**, and deliberately not published
