...
- **QBO bank-feed reconnection** pending — resolve the Mercury + BoA connection so manual upload can stop. STILL OPEN — CHASED again 2026-09-19 (bounded ≥2026-09-12): no Beemold-specific bank-feed/reconnect correspondence found; now ~61 days pending since the 2026-07-20 profile build (the underlying sync break is older, since Feb 2025). _(Maria's doc guide, Gmail)_
...
- **WF statement access (Beemold-specific)** — STILL UNCONFIRMED. CHASED again 2026-09-19: no Beemold-specific correspondence found; now ~6 weeks unconfirmed (first flagged this way in the 2026-08-08 sweep). **A specific Beemold income line (dated 7/10) needs owner identification** — STILL OPEN, now ~36 days pending since 2026-08-14; the same search found no reply.
- Mercury checking ●3849 vs ●8192 confirmation — STILL OPEN, now ~51 days pending since the 2026-07-30 note. Not directly confirmed with Maria this run either; no new Drive statements or Gmail correspondence addressing it found bounded ≥2026-09-12.
- 🔴 **Cross-client lead, now seen TWICE — an Intuit QuickBooks payment-failure/renewal notice has twice named "Vasile Bivol" against Kolo Florida Inc's subscription** (2026-09-06/10, and again 2026-09-15) — a possible owner-group link between this client's owner and Kolo Florida Inc that no file currently records on either side. Still not investigated or actioned by this sweep (outside its scope — flagged for whoever holds `kolo-florida.md`).
