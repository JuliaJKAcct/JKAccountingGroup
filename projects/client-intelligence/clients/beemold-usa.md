...
- **QBO bank-feed reconnection** pending — resolve the Mercury + BoA connection so manual upload can stop. STILL OPEN — a targeted search bounded ≥2026-08-29, on 2026-09-12, for Beemold-specific bank-feed/reconnect correspondence found nothing; ~54 days pending as tracked in this file (since the 2026-07-20 profile build; the underlying sync break is older, since Feb 2025). _(Maria's doc guide, Gmail)_
...
- **WF statement access (Beemold-specific)** — STILL UNCONFIRMED. Margate's own Wells Fargo replacement-account issue is now resolved (renamed "WF Checking 0647," done 2026-08-20 — see [`margate-plumbing.md`](./margate-plumbing.md)), but a targeted search on 2026-09-12, bounded ≥2026-08-29, found no Beemold-specific confirmation that the joint access fix also closes Beemold's own Mercury/BoA feed question. Unconfirmed for over four weeks (first flagged this way in the 2026-08-08 sweep). **A specific Beemold income line (dated 7/10) needs owner identification** — STILL OPEN, now 29 days pending since 2026-08-14; the same targeted search found no reply.
- Mercury checking ●3849 vs ●8192 confirmation — STILL OPEN, now ~44 days pending since the 2026-07-30 note. Not directly confirmed with Maria this run, but see the 2026-09-12 log entry: separate monthly-statement files now exist in Drive for ●3849 and ●4245, which corroborates (without settling) that ●3849 is its own account rather than a typo for ●8192.
