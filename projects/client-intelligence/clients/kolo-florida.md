...
- 🔴 **THE SHOPIFY STORE HAS BEEN FROZEN — escalated from a warning to an actual freeze, 2026-09-23.** _(Gmail, `billing@shopify.com`, "Urgent: KOLO HOUSE is frozen," 2026-09-23: "Our final attempt to process your last bill payment for KOLO HOUSE has failed... your store has been frozen.")_ (amount withheld per the two-data-homes rule) The failure streak first seen 2026-08-23 ran through repeated retries and a "will be frozen" warning (2026-09-18) before the account was actually frozen five days later. **This settles nothing about the wind-down decision in §6 ("does Shopify close with the company or belong to the owner") — it takes the decision out of the firm's hands**, since Shopify has now acted unilaterally. 🔴 **AND THE QUICKBOOKS/INTUIT SUBSCRIPTION BILLING FAILURE CONTINUES, STILL UNRECONCILED WITH `platform: none`.** Further "subscription will be canceled" notices arrived **2026-09-19 and 2026-09-24** (Intuit, VISA ending 3807, billed to **Vasile Bivol**, a JK staff member, for "Kolo Florida Inc" (amount withheld)), each time bundled in the same notification email as a **different company, "2115 NE 54th CT LLC"** (Julia's own AMEX). Whether the two subscriptions are the same billing account or coincidentally bundled remains **not established** — flagged since 2026-09-12, still open. 🟠 **The weekly Gusto payroll-late notice pattern for KOLO FLORIDA INC also continues**, with further notices **2026-09-20, 09-22, 09-24** (pay period Sep 12–18) — the "payroll stopped" (2026-08-14) vs. "Gusto still billing weekly" contradiction is now unresolved across **at least 43 days** (2026-08-14 → 2026-09-24).
...
- 2026-08-29 — **Weekend sweep (incremental, baseline 2026-08-22→2026-08-29).** Double: no notes exist for this client (confirmed again — `list_notes` returns empty); no property changes since 2026-08-22 (Signature/Invoice/Financials Ready unchanged); no activity-log entries in the window. Gmail ("KOLO FLORIDA" / "Kolo House" / Kozlovskiy, bounded `after:2026/08/22`): confirmed the Gusto payroll contradiction is still live (see the Wind-down checklist, updated above) with two more notices since the last sweep (2026-08-23, 2026-08-25, 2026-08-27). 🔴 **NEW: the Shopify subscription for KOLO HOUSE has been failing to bill since 2026-08-23** — four consecutive "A bill payment failed for KOLO HOUSE" emails (2026-08-23, 08-25, 08-27, and a retry scheduled for 08-29), each for the same recurring monthly amount, addressed to Julia. **This bears directly on Wind-down item "the remaining systems in §3 — Shopify... decide for each whether it closes with the company or belongs to the owner"**: a failing subscription will eventually be suspended or cancelled by Shopify on its own, which is a different (and less controlled) outcome than a deliberate closure decision. The 2026-08-20 recurring-expense-check email again listed Kolo Florida as one of two clients that "could not be checked this period (accounting connection down)," confirming the QuickBooks disconnection is still in force. Ping (`search_meetings`, scoped "Kolo Florida"/payroll/Gusto/BAI/warehouse): nothing dated on/after 2026-08-22 — no meetings indexed for this client in the window. **Chase pass:**
  - 🔴 **Gusto payroll contradiction — STILL UNRESOLVED, now 15 days since the "stopped" statement (2026-08-14), and the notices have not stopped** (most recent: 2026-08-27). See the Wind-down checklist for the updated detail.
  - 🔴 **NEW — Shopify billing failures, 6 days pending since first failure (2026-08-23).** No deadline is stated by Shopify in these emails, but repeated failures typically lead to account suspension after a vendor-set grace period; nobody has confirmed what Shopify's own cutoff is for this account.
  - **BAI-branded lines (Kolo's own stock vs. someone else's) and whether the warehouse lease is still running — NOT chased this run (budget), same as last run.** Both remain open with no new evidence either way.
  - **FL sales-tax account closure (file July 2026, then close) — a search of Gmail, bounded ≥2026-08-15, on 2026-08-29, did not find any FDOR correspondence confirming either step.** Pending since unknown — no start date recorded beyond "Lilian will file it herself" (§4); the wind-down checklist item is unticked.
...
- 2026-09-12 — **Incremental sweep (baseline 2026-08-29→2026-09-12).** Double: no notes exist for this client (confirmed again). Activity log: the "Sales Tax" task (renamed from "Monthly Sales tax") was moved from **Not Started to In Progress on 2026-09-02** — consistent with Lilian personally filing the last (July 2026) return herself; a stale closing-checklist task ("Make sure all transactions in the bank feeds are coded") was **deleted 2026-09-01**, consistent with the wind-down. No property changes. Gmail ("KOLO FLORIDA" / "Kolo House" / Kozlovskiy / Gusto, bounded `after:2026/08/29`): 🔴 **the Gusto payroll-late notice pattern for KOLO FLORIDA INC continued** — a further "Action required: Payroll is late for KOLO FLORIDA INC" notice arrived **2026-09-10** (addressed to julia@ and kolofloridainc@gmail.com), so the "payroll stopped" vs. "Gusto still billing" contradiction is **still unresolved, now spanning at least 2026-08-14 → 2026-09-10 (27+ days)**. 🔴 **NEW — the Shopify "KOLO HOUSE" subscription billing failure is CONTINUING**: a further "A bill payment failed for KOLO HOUSE" notice arrived **2026-09-10**, with Shopify's own retry scheduled for **2026-09-14** — the failure pattern first seen 2026-08-23 has now run at least three more weeks without resolution. 🔴 **NEW — an Intuit QuickBooks "please update your payment details" notice for Kolo Florida Inc arrived 2026-09-10**, naming a JK staff member (Vasile Bivol) as the account holder whose card is failing — this shows the **QuickBooks subscription billing is still live** for this client even though Double's own connector reads `platform: none`; whether this is the same or a different subscription from the one behind the "disconnected" finding is **not established**, and is worth someone's attention before it lapses or auto-cancels on its own. No DOR/Lauderhill BTR correspondence found in the window — the wind-down checklist's sales-tax-closure and Certificate-of-Use items remain unconfirmed either way. Ping (`search_meetings`, scoped "Kolo Florida"/payroll/Gusto/BAI/warehouse): no legible, on-topic hits dated on/after 2026-08-29. **Chase pass:**
  - 🔴 **Gusto payroll contradiction — STILL UNRESOLVED, now spanning at least 27 days since the "stopped" statement (2026-08-14), with a further notice 2026-09-10.**
  - 🔴 **Shopify billing failures — STILL UNRESOLVED, now at least 18 days since the first failure (2026-08-23), with a further failure and a scheduled retry (2026-09-14) as of this sweep.**
...
- 2026-09-26 — **Incremental sweep (baseline 2026-09-19→2026-09-26).** Double: `list_client_properties` shows **`Invoice` moved from Sent to Paid** and **`Organizer Status` now reads "N/A (we have QBO access)"** (was previously not separately tracked as a property in this file — recorded for the trail, not clearly a change); `Financials Ready` still `In Progress`; `list_notes` still 0. `list_activity_log` bounded ≥2026-09-19 shows **exactly one entry: the "Sales Tax" task moved In Progress → Done, 2026-09-21** (Lilian) — the corroborating record for the FL DOR filing below. Gmail (`KOLO FLORIDA`/`Kolo House`/Gusto/Shopify/Intuit, `after:2026/09/19`): 🔴 **the July 2026 sales-tax RETURN is now confirmed filed and paid** — two FL DOR e-Notices, 2026-09-21 ("Return Filed" and "Payment Confirmation"), for KOLO FLORIDA INC. 🔴 **NEW — the Shopify "KOLO HOUSE" billing failure ESCALATED FROM WARNING TO ACTUAL FREEZE**: "Urgent: KOLO HOUSE is frozen" (2026-09-23) — the final retry failed and the store is now frozen, not merely threatened. 🔴 **QuickBooks/Intuit subscription failure CONTINUES** — further "subscription will be canceled" notices 2026-09-19 and 2026-09-24, still bundled with a different company ("2115 NE 54th CT LLC") in the same notification email, still not established whether the two billing accounts are the same. 🔴 **Gusto payroll-late notices CONTINUE** — 2026-09-20, 09-22, 09-24 (pay period Sep 12–18), pushing the "payroll stopped" vs. "Gusto still billing" contradiction to **at least 43 days**. No FDOR account-closure or Lauderhill BTR/Certificate-of-Use correspondence found. Google Drive (`excludeContentSnippets: true`, "Kolo Florida"/"Kozlovsk"/"honda"): no files modified since 2026-09-19 — nothing new. Ping (`resolve_person` on Mykola Kozlovskyi, org-wide `search_meetings` for "Kolo Florida Kozlovskyi Kozlovska tax return Marketplace 1095-A"): no legible, client-specific hits — corroborates the standing zero-meetings finding. 🛑 **The filed-vs-blocked contradiction (§4/§5, cross-referenced on [`mykola-kozlovskyi.md`](./mykola-kozlovskyi.md)) is UNCHANGED** — Double still shows both this company's 1120-S and Mykola's 1040 as filed/signed/paid, with no new note, activity-log entry or document found anywhere this sweep that closes the four blockers recorded 2026-08-20. **Re-verified only, not resolved, per this run's instruction.** **Chase pass:** the BAI-branded-lines question and the warehouse-lease question were **NOT chased this run** (no budget) — same as the last four runs.

### Wind-down — what has to be closed (CI-only)
- [x] **Florida sales-tax account — the July 2026 RETURN is filed and paid, confirmed 2026-09-21** (FL DOR e-Notices "Return Filed" + "Payment Confirmation"; Double's "Sales Tax" task moved to Done the same day). ⚠️ **The filing is done; CLOSING the FL DOR account itself is still not confirmed** — a search of Gmail bounded `after:2026/09/19`, on 2026-09-26, for account-closure correspondence found nothing beyond the filing/payment notices.
- [ ] 🔴 **CONTRADICTION — Gusto subscription cancellation, STILL unconfirmed and the notices keep coming, now at least 43 days since the "stopped" statement (2026-08-14), with further notices 2026-09-20, 09-22 and 09-24 (see the 2026-09-26 sweep log entry below).** §4 states payroll STOPPED (Lilian, 2026-08-14) and that the Gusto subscription is to be cancelled. Against that: Gusto continues to send weekly payroll notices for KOLO FLORIDA INC, addressed to julia@jkaccountinggroup.com and kolofloridainc@gmail.com. Worth reconciling with Lilian/the client directly before the Gusto cancellation proceeds, or before another sweep just re-reports the same open contradiction a fourth time.
- [ ] 🔴 **The Shopify store "KOLO HOUSE" has now been FROZEN (2026-09-23)** — a billing failure streak that ran since 2026-08-23 escalated past a warning into an actual freeze. This forecloses the "decide whether it closes with the company or belongs to the owner" question below for Shopify specifically — Shopify has acted on its own. Someone needs to decide whether to pay and reopen it, or let it lapse as part of the wind-down.
- [ ] The remaining systems in §3 — the Florida DOR e-Services access, GovFile, TaxDome
      (legacy) — decide for each whether it closes with the company or belongs to the owner. (Shopify is no longer a live choice — see above.)
