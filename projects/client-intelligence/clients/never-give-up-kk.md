...
- **Entity-structure recommendation** (LLC vs S-corp vs C-corp) — Julia to deliver. STILL OPEN, **60 days** pending since the 2026-07-14 meeting, no deadline recorded. _(Double note 2026-07-14; checked 2026-09-12)_
- 🟢 **Sales-tax nexus / registration analysis** — **likely resolved 2026-09-02** (Double property changed N/A → Quarterly, recurring task created), but not yet corroborated by any note or correspondence explaining the decision or jurisdiction. See §4. _(Double, checked 2026-09-12)_
- **BOI report** to be filed. STILL OPEN, no update, no deadline recorded — worth Lilian/Julia confirming the actual FinCEN due date given the entity's formation date. _(Double note 2026-07-14; checked 2026-09-12)_
