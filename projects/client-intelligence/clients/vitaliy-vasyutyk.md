...
- _(2026-09-13)_ — 🛑 **A CONTRADICTION TO PUT TO SOMEONE, recorded rather than resolved.** Lilian's Double comment of 2026-09-07 reads **"Zumfi 1 LLC — we need to close this company"** — and this session established the same company **bought a house six weeks into the 2025 tax year and still held it at closing**. A property-holding LLC being dissolved has to dispose of the property first, or it moves to another entity or to the owner personally, and **each of those is a different 2025 return**. ⛔ **Both facts are firmly sourced and neither is wrong; what is missing is what happened AFTER 2025-08-08.** Do not reconcile them by assumption — ask. _(Raised by this session; see Outstanding items.)_
...
- **Zumfi 1 LLC, added 2026-09-13 by Julia** — its 2025 1065 carries a **real-estate acquisition**: a Tennessee house, closed **2025-08-08**, **all cash**. The acquisition allocation was worked this session on the group's HUD tool and every closing figure reconciles to the settlement statement to the cent. ⛔ **It is NOT finished, and both gaps are inputs nobody in the firm has yet supplied:** the **assessor's land-vs-building split** (which decides the depreciable basis, and there is no return without it) and the **placed-in-service date** (which decides when depreciation starts). 🔑 **And note what this makes 2025 for this company: a purchase, not "no activity"** — the opposite of SYS 1 and Remodel Master above.
- 🔑 **The pattern across all three, worth carrying into the next one:** 2025 is the year this group **started buying** — Zumfi 1 in August (a house, Tennessee), Zumfi 2 in November (land). **Expect an acquisition allocation, a land/building split and a depreciation start on every new entity's first return**, and expect the closing package to arrive from Julia rather than from the portal.
...
- 🔴 **ZUMFI 1 LLC — THREE OPEN THINGS, AND THE FIRST ONE HAS TO BE ASKED BEFORE THE OTHER TWO ARE WORTH DOING.** ① 🛑 **"We need to close this company"** (Lilian → Julia, 2026-09-07) **sits against a house it BOUGHT on 2025-08-08 and still held at closing** (2026-09-13). Nothing has been filed toward a dissolution; compare Tropical Coast 1's for the route and the cost — **but first establish what happened to the property**, because a sale, a transfer to another entity in the group, or a distribution to Vitaliy personally are three different 2025 returns, and only one of them is "dissolve it". ② **The assessor's land-vs-building split for parcel `137B-E-003`** is the missing input on the acquisition allocation — [Hamilton County, TN assessor](https://assessor.hamiltontn.gov/) — and **without it there is no depreciable basis and no return.** ③ **The placed-in-service date** — when the house was ready and available to rent, which on a 1968 property this group may well have renovated first is **not** the closing date by default. **The 2025 1065 is already extended** (`7004 2025 Ext.pdf` in its Double file library).
...
- [ ] 🔴 **The Hamilton County assessor's LAND vs BUILDING values for parcel `137B-E-003`** — the one input the acquisition allocation cannot be finished without. _(A session on the firm's usual cloud environment **cannot fetch this**: `assessor.hamiltontn.gov` is blocked by the network egress policy, along with every other county site tried on 2026-09-13. It is a person's lookup, or a screenshot into the session.)_
- [ ] **Zumfi 1's PLACED-IN-SERVICE date** — the day the Chattanooga house was ready and available to rent. **Not the 2025-08-08 closing date by default:** this group renovates, the house dates from 1968, and a renovation between purchase and first tenant moves the date into a later year.
