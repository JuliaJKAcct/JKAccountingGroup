...
- The Form 2553 effective-date matter (§5/§6) — outcome still not recorded anywhere the firm can reach; STILL OPEN, no new correspondence found in the 2026-08-22→29, 2026-08-29→09-12, or 2026-09-12→09-19 windows (pending since the 2026-03-16 mailing, **≈187 days**).
- 🆕 WCIRCLE LLC (Double id 710607), the second business record linked to the client's Double contact — §5 — not chased this pass; flag for identification (possibly "Viserkalo" from the 2026-08-31 call) before it is assumed unrelated.
