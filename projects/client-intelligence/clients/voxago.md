...
- **Entity type:** LLC — ⚠️ **taxed as a disregarded entity / sole proprietorship**: the FDOR asked for a **Schedule C**, which only exists on an individual return _(inferred from the 2025-12-15 FDOR call; not separately confirmed)_
- **Home state:** **Florida**
...
- **Current status:** the **2025 annual report was still PENDING** as of **2026-02-10** _(Lilian's iCloud notes, migrated — "Annual Reports 2025")_. Whether it was filed is unrecorded — and Florida charges a **$400 late penalty** on a late annual report for a for-profit entity.

### Tangible personal property tax
- **Applies?** ⚠️ **UNSETTLED — and the FDOR raised it.** On 2025-12-15 the firm was asked to establish **whether there are tangibles being sold**. No answer is recorded. It decides whether a **DR-405 tangible personal property return** is owed to the county.
...
- **The 2025 Florida annual report was still outstanding on 2026-02-10** and no filing is recorded. A late annual report costs **$400** in Florida and the entity is administratively dissolved if it is never filed.
...
- **Nothing after those dates is recorded anywhere the firm can reach.** Per Lilian's instruction of 2026-08-12, this is left open rather than chased or inferred.
...
- **Was the 2025 Florida annual report filed?** Pending as of 2026-02-10; a $400 penalty and eventual administrative dissolution follow if not.
- **Settle whether the business sells tangibles**, which decides whether a county tangible personal property return (DR-405) is owed.
