...
| [`acquisition-diligence/`](./acquisition-diligence/) | **Financial due diligence for clients buying a business** — the industry benchmark references we measure a target against (cost structure, the KPI set, the revenue-reasonableness tests, county utility inputs, valuation multiples), each figure graded Firm / Directional / Not obtained. Consulting, **never** described with assurance words. Benchmarks are committed; a specific deal's figures never are. | Active |
