...
| [`marketing/foreign-owner-us-tax-savings-playbook/`](./marketing/foreign-owner-us-tax-savings-playbook/) | Companion flagship magnet for owners who already run a US business: a tax-savings guide (keep more profit) + opt-in landing page (email → guide → book a free review). On-brand self-contained HTML; draft, pending endpoint wiring + tax-figure sign-off. | Active |
...
> The first nine rows are the **marketing group** — they live under
