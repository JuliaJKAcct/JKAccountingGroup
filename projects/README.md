...
| [`tax-returns`](./tax-returns/) | 🟢 Active | **The working papers behind every return we prepare** — what went on each line, where each figure came from, and what was decided. Holds the **figures** (Client Intelligence deliberately does not). **Not published to the Hub.** |
