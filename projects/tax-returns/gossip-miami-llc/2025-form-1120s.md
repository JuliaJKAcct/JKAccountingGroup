...
| Question | Answer |
|---|---|
| What is the due date? 🔵 **It depends on the branch, and they are five weeks apart** | 🔵 **FULL-YEAR BRANCH (election survived) — an ordinary calendar-year 1120-S: due 15 March 2026, which fell on a SUNDAY, so 16 March 2026; extended six months to 🔴 15 SEPTEMBER 2026.** ⚠️ **CUT BRANCH (election terminated):** the 2025 instructions, quoted — *"file Form 1120-S for the S corporation's short year **by the due date (including extensions) of the C corporation's short year return**"* — and that C period ends 31 December 2025, so **15 April 2026, extended 15 October 2026** |
...
> ⚠️ **What it still is NOT: complete.** And it is **not complete**:
...
|---|---|---|---|
| **1** | Net income (loss) per books | **37,664** *(S period 44,547 · tail (6,883))* | ƒ full year: income 391,368.88 − book expenses 353,704.39 = 37,664.49 · ✅ **exactly the P&L's Net Income** |
...
| **8** | Income (loss) — Schedule K line 18 | **44,707** *(S period 51,450)* | ƒ `= line 4 − line 7` · ✅ **ties to Schedule K line 18 exactly, in both columns** |
...
| **6** | Combine lines 1 through 5 | **16,517** *(S period 23,400)* | ƒ `−26,783 + 44,707 − 1,406` |
| **7** | **Distributions** | 🔴 **16,517 — CAPPED, not 42,517** *(S period 23,400)* | 🛑 The AAA cannot be driven negative by distributions. **The excess — 25,999 on the full year, 19,117 on the cut — is not entered on Schedule M-2 at all** |
...
🔵 **THREE K-1s on a full year, TWO on the cut.** ⓘ **The table below is written for the two SELLERS.** On the full-year branch the buyer gets a third K-1 of the same shape — allocation percentage 17.2603%, shares **0 / 100**, `Final K-1` **not** ticked, and his own Statement A. On the 29-October cut the two selling members held 50
...
| **H** Shareholder's shares — beginning / end | 🔵 **FULL YEAR: 50 / 0** · ⚠️ **CUT: 50 / 50** | 🔑 **"End of tax year" means the end of THIS return's year.** On the cut that is 29 October and they still held them. **On a full calendar year they held nothing on 31 December**, and the buyer's own K-1 shows **0 / 100** |
