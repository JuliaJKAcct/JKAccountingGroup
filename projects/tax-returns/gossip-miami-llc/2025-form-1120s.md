...
🔵 **THREE K-1s on a full year, TWO on the cut.** On the 29-October cut the two selling members held 50
...
| **4** | Meals and entertainment — **full year 2,812.33** *(cut: 2,533.44)* | **50% deductible under §274(n)** — full year **1,406** deducted and **1,406** to K 16c *(cut: 1,267 / 1,267)* | **(a)** Treat as entertainment / personal → **0% deductible**: full-year line 22 → **43,301**, K 16c → 2,812 *(cut: 52,717 / 2,533)*. **(b)** Argue the coffee-bar consumables are *food made available to the general public* → **100%**: full-year line 22 → **46,113**, K 16c → 0 *(cut: 50,183 / 0)*. ⚠️ **And a fact that pushes toward (a):** the November–December charges on this card (DoorDash, cafés, a liquor store) are **after the sale**, on a card the client told us became personal — those are not company expenses at all. 🔵 **On the full-year branch they are INSIDE this return** — that is decision 11 — and they colour how the whole account should be read | Session default · **Julia to rule** |
...
2. 🔴 **Tips are income here, and the offsetting payout has never been located.** The 29,065 of tips is
   ...
   income to **15,642** and **M-2 line 6 to (12,548)** — so line 7 is capped at **0** instead of 16,517, and
