...
| [Lilian's Notebook](./projects/lilian-notebook/) | Lilian's personal notebook of the lessons the firm learned the hard way — how an agency really behaves, where a platform lets you down, what a filing actually costs — each written as the rule to follow next time, on one searchable page she has bookmarked. Hers to write; kept in the repo so a lesson outlives the task that taught it. | Active |
